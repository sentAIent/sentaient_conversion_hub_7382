...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                // Removed pos.y slant so the wave is perfectly perpendicular to the camera.
                // Adding 100.0 ensures the wave forms to the left of the camera.
                float waveX = pos.x + 100.0; 
...
//# sourceMappingURL=visualizer_v4-Cw7w-SyU.js.map
