        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                if (pos.z > curlStartHeight) {
                    ...
                    if (waveX < 0.0) {
                        // Hard fade-out on the back of the wave to prevent it from folding over
                        curlEnvelope = exp(-pow(waveX * 0.15, 2.0));
                    } else {
                        // Wide barrel on the front
                        curlEnvelope = exp(-pow(waveX * 0.04, 2.0));
                    } 
                    
                    // Wrap the curl to 216 degrees (1.2 PI) to fully tuck the lip into a closed barrel
                    float bendAngle = pow(normH, 1.2) * 3.14159 * 1.2 * normalizedCurl * curlEnvelope; 
...
//# sourceMappingURL=visualizer_v4-B_3247yB.js.map
