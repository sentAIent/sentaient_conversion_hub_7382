        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                if (pos.z > curlStartHeight) {
                    ...
                    // Wrap the curl forward to overhang (110 degrees / 0.6 PI), but DO NOT spiral inside-out
                    float bendAngle = pow(normH, 1.2) * 3.14159 * 0.6 * normalizedCurl * curlEnvelope; 
...
//# sourceMappingURL=visualizer_v4-CN4unB-g.js.map
