...
const classes = [
    { id: 8, name: 'Class VIII: Asymmetrical Flow', count: 10, defaultColors: ['#ff6347', '#4682b4'] },
    { id: 9, name: 'Class IX: Heavy Brutalism', count: 10, defaultColors: ['#8b0000', '#000000'] },
    { id: 10, name: 'Class X: Pixel Swarm', count: 10, defaultColors: ['#00ff00', '#ff00ff'] }
];
...
if (htmlStr.includes(targetStr)) {
    ...
    console.log("Successfully injected cymatics UI for Classes 8, 9, 10!");
} else {
