...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                // This makes it PEEL like a real surfing wave instead of forming an infinitely straight crater.
                float waveX = pos.x + (pos.y * 0.4); 
...
//# sourceMappingURL=visualizer_v4-CKZiPtg7.js.map
