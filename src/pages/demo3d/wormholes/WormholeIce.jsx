...
const WormholeIce = ({ position, rotation = [0, 0, 0], length = 4000, visible = true }) => {
  ...
  useFrame((state) => {
    if (materialRef.current) {
      ...
      materialRef.current.uniforms.uOpacity.value = visible ? 1.0 : 0.0;
    }
  });
