import{_ as s}from"./main_vFINAL-DAkaryY8.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-app.js";const o="mindwave_email_captured",f=12e4;let l=!1;function k(){localStorage.getItem(o)||setTimeout(async()=>{try{const{getAuth:e}=await s(async()=>{const{getAuth:t}=await import("https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js");return{getAuth:t}},[]);if(e().currentUser||l)return;y()}catch{}},f)}function y(){if(document.getElementById("emailCaptureModal"))return;l=!0;const e=document.createElement("div");e.id="emailCaptureModal",e.className="fixed inset-0 z-[9999] flex items-center justify-center p-4",e.style.cssText=`
    ...
    `,document.body.appendChild(e),e.querySelector("#emailCaptureClose").addEventListener("click",i),e.querySelector("#emailCaptureForm").addEventListener("submit",w),e.addEventListener("click",r=>{r.target===e&&i()}),document.addEventListener("keydown",function r(t){t.key==="Escape"&&(i(),document.removeEventListener("keydown",r))})}async function w(e){e.preventDefault();const r=document.getElementById("emailCaptureInput"),t=document.getElementById("emailCaptureSubmit"),a=r.value.trim();if(a){t.textContent="Saving...",t.disabled=!0;try{const{getFirestore:n,doc:p,setDoc:d,serverTimestamp:u}=await s(async()=>{const{getFirestore:m,doc:b,setDoc:g,serverTimestamp:x}=await import("https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js");return{getFirestore:m,doc:b,setDoc:g,serverTimestamp:x}},[]),c=n();await d(p(c,"email_subscribers",a.toLowerCase().replace(/[^a-z0-9]/g,"_")),{email:a.toLowerCase(),source:"email_capture_modal",createdAt:u(),userAgent:navigator.userAgent,url:window.location.href}),localStorage.setItem(o,a),t.textContent="✓ You're in!",t.style.background="#10b981",setTimeout(()=>{i(),window.showToast&&window.showToast("Welcome! Check your email for your free trial.","success")},1500)}catch{localStorage.setItem(o,"failed_"+a),t.textContent="Error - Try Again",t.style.background="#ef4444",t.disabled=!1,setTimeout(()=>{t.textContent="Get Free Access",t.style.background="linear-gradient(135deg, #8b5cf6, #6366f1)"},2e3)}}}function i(){const e=document.getElementById("emailCaptureModal");e&&(e.style.opacity="0",setTimeout(()=>e.remove(),300))}export{k as initEmailCapture};
//# sourceMappingURL=email-capture-BbeO2lg5.js.map
