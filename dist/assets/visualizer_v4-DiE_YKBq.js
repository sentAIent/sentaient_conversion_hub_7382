...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                // Asymmetric bell curve - severely tightened to make the wave profile razor skinny and steep
                float envelope = 0.0;
                if (waveX < 0.0) {
                    envelope = exp(-pow(waveX * 0.04, 2.0)); // Skinnier back slope
                } else {
                    envelope = exp(-pow(waveX * 0.12, 2.0)); // Razor steep front cliff
                }
