...
`,ot=u=>u===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class st{constructor(e){this.group=e,this.meshes=[],this.activeClassId=17,this.activeVariationId=9,this.materials={};const t=new Oe(new Uint8Array([0,0,0,0]),1,1,Ae);t.needsUpdate=!0,this.dummyTexture=t;const i=new K(2,2);for(let a=1;a<=25;a++){let o=ot(a);if(a<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
