...
`,ot=m=>m===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class st{constructor(e){this.group=e,this.meshes=[],this.activeClassId=17,this.activeVariationId=9,this.materials={};const t=new Oe(new Uint8Array([0,0,0,0]),1,1,Ae);t.needsUpdate=!0,this.dummyTexture=t;const i=new k,a=new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),s=new Float32Array([0,0,2,0,0,2]);i.setAttribute("position",new D(a,3)),i.setAttribute("uv",new D(s,2));for(let o=1;o<=25;o++){let n=ot(o);if(o<=16&&(n=n.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
