...
import AutopilotTOS from './pages/autopilot-tos';
import AutopilotPrivacyPolicy from './pages/autopilot-privacy-policy';
    ...
    <BrowserRouter>
      ...
      <ErrorBoundary>
        ...
        <RouterRoutes>
          ...
          <Route path="/autopilot/tos" element={<AutopilotTOS />} />
          <Route path="/autopilot/privacy-policy" element={<AutopilotPrivacyPolicy />} />
