...
• Track your progress (we'll do this for you!)`,action:null,completed:!1},{id:"lesson-6",day:6,title:"Beta for Focus",description:"10-minute concentration session",type:"practice",content:"Beta waves enhance concentration and alertness. Use this before work or study sessions.",action:{preset:"beta",duration:10},completed:!1},{id:"lesson-7",day:7,title:"Week 1 Complete!",description:"Review and reflection",type:"milestone",content:"Congratulations! You've completed your first week. Reflect on how you felt during each session. Which frequencies resonated most with you?",action:null,completed:!1,badge:"week-1"}]},{id:"building-habit",name:"Building Habits",emoji:"🌿",description:"Establish your daily practice",duration:"Week 3-4",lessons:[{id:"lesson-8",day:8,title:"Morning Integration",description:"Start your day with focus",type:"practice",content:"Use the Wake Up journey to transition from sleep to alertness naturally.",action:{journey:"wakeUp"},completed:!1},{id:"lesson-9",day:9,title:"Longer Sessions",description:"15-minute Alpha session",type:"practice",content:"Extending your sessions helps deepen the benefits. Today, try a longer 15-minute relaxation session.",action:{preset:"alpha",duration:15},completed:!1},{id:"lesson-10",day:10,title:"Evening Wind Down",description:"Prepare for restful sleep",type:"practice",content:"Use the Wind Down journey 30-60 minutes before bed to transition into sleep mode.",action:{journey:"windDown"},completed:!1},{id:"lesson-11",day:11,title:"Combining with Soundscapes",description:"Layer nature sounds with frequencies",type:"info",content:"Adding ambient sounds like rain, ocean, or forest can enhance your sessions. The binaural beat remains effective underneath the soundscape.",action:null,completed:!1},{id:"lesson-12",day:12,title:"Meditation Session",description:"Deep Theta meditation",type:"practice",content:"Use the Meditation journey for a guided frequency sweep into deep meditative states.",action:{journey:"meditation"},completed:!1},{id:"lesson-13",day:13,title:"Rest Day",description:"Reflection and integration",type:"info",content:"Taking breaks is important. Use today to reflect on your experiences so far. Notice any changes in your sleep, focus, or stress levels.",action:null,completed:!1},{id:"lesson-14",day:14,title:"Two Weeks Strong!",description:"Habit milestone achieved",type:"milestone",content:"You've meditated for two weeks! Research shows habits form after 14-21 days of consistency. You're on track!",action:null,completed:!1,badge:"two-weeks"}]},{id:"deepening",name:"Deepening Practice",emoji:"🌳",description:"Advanced techniques and personalization",duration:"Week 5-8",lessons:[{id:"lesson-15",day:15,title:"Sleep Stories Introduction",description:"Combine narratives with frequencies",type:"info",content:"Sleep stories add a narrative element to your Delta sessions, guiding your mind while the frequencies work on a deeper level.",action:null,completed:!1},{id:"lesson-16",day:16,title:"Deep Sleep Session",description:"Delta waves for restorative rest",type:"practice",content:"Use the Deep Sleep journey about 30 minutes before bed. Allow the frequencies to carry you into deep, restorative sleep.",action:{journey:"deepSleep"},completed:!1},{id:"lesson-17",day:17,title:"Creative Flow State",description:"Theta for creativity",type:"practice",content:"Artists, writers, and creators often use Theta to access flow states. Try this before any creative work.",action:{journey:"creativity"},completed:!1},{id:"lesson-18",day:18,title:"Mu Waves Exploration",description:"The empathy frequency",type:"info",content:"Mu waves (8-13 Hz, similar to Alpha) are associated with mirror neurons and empathy. Some research suggests they may enhance social connection.",action:{preset:"mu",duration:10},completed:!1},{id:"lesson-19",day:19,title:"Custom Mix Creation",description:"Design your own frequencies",type:"info",content:"Use the sliders to customize your base pitch and beat frequency. Experiment to find combinations that work best for your unique brain.",action:null,completed:!1},{id:"lesson-20",day:20,title:"Healing Frequencies",description:"Solfeggio tones explained",type:"info",content:"The Healing presets use ancient Solfeggio frequencies: 528 Hz (Transformation), 432 Hz (Harmony), 396 Hz (Liberation). Try them during relaxation.",action:null,completed:!1},{id:"lesson-21",day:21,title:"Journey Master!",description:"Program complete",type:"milestone",content:"You've completed the MindWave journey! You now have the knowledge and habits to maintain a lifelong meditation practice with binaural beats.",action:null,completed:!1,badge:"journey-master"}]}],B={"week-1":{name:"First Week",emoji:"🌟",description:"Completed 7 days of practice"},"two-weeks":{name:"Two Weeks Strong",emoji:"💪",description:"Built a consistent habit"},"journey-master":{name:"Journey Master",emoji:"🎓",description:"Completed the full program"},"streak-7":{name:"Week Streak",emoji:"🔥",description:"7 day practice streak"},"streak-30":{name:"Month Streak",emoji:"🏆",description:"30 day practice streak"}},D="mindwave_journey_progress";let s={currentStage:0,currentLesson:0,completedLessons:[],earnedBadges:[],startedAt:null,lastSessionAt:null},u=null;function F(){return u!==null}function z(){return u}function $(){u=null}window.isJourneyActive=F;window.getActiveJourneySession=z;async function oe(){N(),b(async()=>{const{registerAuthCallback:t}=await import("./controls_v3-BsAgpsxS.js").then(e=>e.ba);return{registerAuthCallback:t}},[]).then(({registerAuthCallback:t})=>{t(async e=>{if(e&&!e.isAnonymous){await W();const n=document.getElementById("journeyContainer");n&&C(n)}})})}async function W(){if(!(!S||!h.currentUser))try{const t=h.currentUser.uid,e=T(S,"users",t,"progress","journey"),n=await H(e);if(n.exists()){const o=n.data(),c=Array.from(new Set([...s.completedLessons,...o.completedLessons||[]])),i=Array.from(new Set([...s.earnedBadges,...o.earnedBadges||[]]));s={...s,...o,completedLessons:c,earnedBadges:i},P()}else await M()}catch{}}async function M(){if(!(!S||!h.currentUser||h.currentUser.isAnonymous))try{const t=h.currentUser.uid,e=T(S,"users",t,"progress","journey");await R(e,{...s,updatedAt:q()},{merge:!0})}catch{}}function N(){try{const t=localStorage.getItem(D);if(t){const e=JSON.parse(t);s={...s,...e}}}catch{}}function P(){try{localStorage.setItem(D,JSON.stringify(s))}catch{}}function U(t){if(!s.completedLessons.includes(t)){s.completedLessons.push(t),s.lastSessionAt=new Date().toISOString();const e=y().find(n=>n.id===t);return e!=null&&e.badge&&!s.earnedBadges.includes(e.badge)&&(s.earnedBadges.push(e.badge),K(e.badge)),P(),M(),!0}return!1}function y(){return _.flatMap(t=>t.lessons)}function Y(){const t=y().length,e=s.completedLessons.length;return{completed:e,total:t,percentage:Math.round(e/t*100),badges:s.earnedBadges}}function O(){return y().find(e=>!s.completedLessons.includes(e.id))||null}function V(t){const e=y(),n=e.findIndex(c=>c.id===t);if(n===0)return!0;const o=e[n-1];return o?s.completedLessons.includes(o.id):!1}function G(t){return s.completedLessons.includes(t)}function K(t){const e=B[t];if(!e)return;const n=document.createElement("div");n.className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm",n.innerHTML=`
    ...
    `,n.addEventListener("click",()=>n.remove()),document.body.appendChild(n),setTimeout(()=>n.remove(),4e3)}function C(t){if(!t)return;const e=Y(),n=O();t.innerHTML=`
        <!-- Progress Header -->
        <div class="mb-6">
        ...
        ${_.map((o,c)=>{const i=o.lessons.every(a=>s.completedLessons.includes(a.id)),w=o.lessons.filter(a=>s.completedLessons.includes(a.id)).length;return`
            <div class="${c>0?"pt-8 mt-10":""} ${c>0?"border-t border-white/10":""} mb-6 pb-4">
                ...
                <div class="grid gap-2" style="grid-template-columns: repeat(7, minmax(0, 1fr))">
                    ${o.lessons.map(a=>{var r;const j=s.completedLessons.includes(a.id),E=a.type==="milestone",g=V(a.id),k=u&&u.lessonId===a.id,v=n&&n.id===a.id;let d="",p="",l=!0;return j?(d="bg-[var(--success)]/30 text-[var(--success)] border-[var(--success)]/50",l=!0):g?k?(d="bg-[var(--primary)]/30 text-[var(--primary)] border-[var(--primary)] ring-2 ring-[var(--primary)]/40 animate-pulse",l=!0):v?(d="bg-[var(--primary)]/20 text-white border-[var(--primary)]/60 shadow-[0_0_15px_rgba(96,169,255,0.3)] scale-105 z-10",l=!0):E?(d="bg-amber-500/20 text-amber-300 border-amber-500/40",l=g):(d="bg-white/10 text-white border-white/20 hover:bg-white/20 hover:border-[var(--primary)]/50",l=!0):(d="bg-gray-700/30 text-gray-500/70 border-gray-600/30 cursor-not-allowed opacity-50",p="🔒",l=!1),p||(p=E?a.badge?(r=B[a.badge])==null?void 0:r.emoji:"⭐":a.day),`
    ...
    `,n.addEventListener("click",o=>{o.target===n&&n.remove()}),document.body.appendChild(n)}let I=null;window.startLessonAction=async t=>{var o,c;const e=y().find(i=>i.id===t);if(!(e!=null&&e.action))return;if(u&&u.lessonId!==t){const i=y().find(x=>x.id===u.lessonId);if(!confirm(`You have an active journey session: "${(i==null?void 0:i.title)||"Unknown"}".

Do you want to stop it and start this lesson instead?`))return;$()}(o=document.getElementById("lessonModal"))==null||o.remove(),(c=document.getElementById("journeyModal"))==null||c.classList.add("hidden");const n=e.action.duration||5;if(u={lessonId:t,startedAt:new Date().toISOString(),preset:e.action.preset||e.action.journey,duration:n},e.action.preset)if(window.applyMixState)try{window.trackFeatureUse&&window.trackFeatureUse("journey_lesson_start",{lesson_id:t,preset:e.action.preset}),window.applyMixState(e.action.preset)}catch(i){alert(`Error starting preset: ${i.message}`);return}else{alert("Error: Preset function not available. Please refresh the page.");return}else if(e.action.journey)if(typeof window.startSweepPreset=="function")try{window.startSweepPreset(e.action.journey)}catch(i){alert(`Error starting journey: ${i.message}`);return}else{alert("Error: Journey function not available. Please refresh the page.");return}I=t;try{const[i,{startAudio:w,fadeIn:x,fadeOut:a,stopAudio:j},{toggleVisual:E},{syncAllButtons:g}]=await Promise.all([b(()=>import("./controls_v3-BsAgpsxS.js").then(r=>r.bd),[]),b(()=>import("./controls_v3-BsAgpsxS.js").then(r=>r.bc),[]),b(()=>import("./controls_v3-BsAgpsxS.js").then(r=>r.b9),[]),b(()=>import("./controls_v3-BsAgpsxS.js").then(r=>r.bj),[])]);await w(),x(1.5),resumeVisuals(),g();const k=document.getElementById("sessionDuration");k&&(k.value=String(n)),i.startSession(n,{onTick:r=>{const m=document.getElementById("timerDisplay"),f=document.getElementById("timerProgress");if(m&&(m.textContent=r.formatted,m.style.opacity="1"),f){const L=339.292-r.progress/100*339.292;f.style.strokeDashoffset=L}},onComplete:async()=>{if(I===t){const r=U(t);I=null,$(),X(e),a(3,()=>{j();const L=document.getElementById("playIcon"),J=document.getElementById("pauseIcon");L&&L.classList.remove("hidden"),J&&J.classList.add("hidden")});const m=document.getElementById("timerRing"),f=document.getElementById("timerDisplay");m&&(m.style.opacity="0",m.classList.remove("timer-active")),f&&(f.style.opacity="0",f.classList.remove("timer-active"));const A=document.getElementById("journeyContainer");A&&C(A)}}});const v=document.getElementById("timerRing"),d=document.getElementById("timerDisplay");v&&(v.style.opacity="1",v.classList.add("timer-active")),d&&(d.style.opacity="1",d.classList.add("timer-active"));const p=document.getElementById("playIcon"),l=document.getElementById("pauseIcon");p&&p.classList.add("hidden"),l&&l.classList.remove("hidden")}catch{$(),alert("Failed to start lesson session. Please try again.")}};function X(t){const e=document.createElement("div");e.className="fixed top-20 left-1/2 -translate-x-1/2 px-6 py-3 rounded-xl bg-green-500/90 text-white font-bold text-sm shadow-lg backdrop-blur-sm",e.style.zIndex="9999",e.innerHTML=`✓ Lesson Complete: ${t.title}`,document.body.appendChild(e),setTimeout(()=>e.remove(),3e3)}window.markLessonComplete=t=>{var n;U(t),(n=document.getElementById("lessonModal"))==null||n.remove();const e=document.getElementById("journeyContainer");e&&C(e)};export{B as BADGES,_ as JOURNEY_STAGES,$ as clearActiveJourneySession,U as completeLesson,z as getActiveJourneySession,y as getAllLessons,O as getNextLesson,Y as getProgress,oe as initJourney,F as isJourneyActive,V as isLessonAvailable,G as isLessonCompleted,C as renderJourneyUI};
//# sourceMappingURL=journey-BcxepnI3.js.map
