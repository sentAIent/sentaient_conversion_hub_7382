...
`,it=m=>m===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class ot{constructor(e){this.group=e,this.meshes=[],this.activeClassId=17,this.activeVariationId=9,this.materials={};const t=new Oe(new Uint8Array([0,0,0,0]),1,1,Ae);t.needsUpdate=!0,this.dummyTexture=t;const i=new k,a=new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),s=new Float32Array([0,0,2,0,0,2]);i.setAttribute("position",new D(a,3)),i.setAttribute("uv",new D(s,2));for(let o=1;o<=25;o++){let n=it(o);if(o<=16&&(n=n.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        ...
        void main() {`,n=n.replace("void main() {",l)}o<=21&&(n.includes("vec2 p = (vUv - 0.5) * 2.0;")?n=n.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            `,depthWrite:!1,depthTest:!1,transparent:!0}),this.mesh.material=this.material,this.scene=new Ie,this.scene.add(this.mesh)}resize(e,t){this.renderTarget.setSize(e,t),this.material.uniforms.uResolution.value.set(e,t)}render(e,t,i,a){this.renderer.setRenderTarget(this.renderTarget),this.renderer.clear(),this.renderer.render(e,t),this.material.uniforms.uTime.value+=i;const s=Math.max(0,a-.7)*3;this.material.uniforms.uAberration.value=5*s,this.material.uniforms.uBloomIntensity.value=.5+a*1.5,this.renderer.setRenderTarget(null),this.renderer.clear(),this.renderer.render(this.scene,this.camera)}dispose(){this.renderTarget.dispose(),this.geometry.dispose(),this.material.dispose()}}class rt{constructor(e,t=5e3){this.scene=e,this.count=t,this.geometry=new k,this.positions=new Float32Array(this.count*3),this.velocities=new Float32Array(this.count*3),this.colors=new Float32Array(this.count*3),this.sizes=new Float32Array(this.count);const i=new A(3718648),a=new A(11032055);for(let h=0;h<this.count;h++){const f=h*3,l=20*Math.cbrt(Math.random()),g=Math.random()*2*Math.PI,c=Math.acos(2*Math.random()-1);this.positions[f]=l*Math.sin(c)*Math.cos(g),this.positions[f+1]=l*Math.sin(c)*Math.sin(g),this.positions[f+2]=l*Math.cos(c),this.velocities[f]=-this.positions[f+2]*.05+(Math.random()-.5),this.velocities[f+1]=(Math.random()-.5)*.5,this.velocities[f+2]=this.positions[f]*.05+(Math.random()-.5);const u=i.clone().lerp(a,Math.random());this.colors[f]=u.r,this.colors[f+1]=u.g,this.colors[f+2]=u.b,this.sizes[h]=Math.random()*2+.5}this.geometry.setAttribute("position",new D(this.positions,3)),this.geometry.setAttribute("color",new D(this.colors,3)),this.geometry.setAttribute("size",new D(this.sizes,1));const s=document.createElement("canvas");s.width=64,s.height=64;const o=s.getContext("2d"),r=o.createRadialGradient(32,32,0,32,32,32);r.addColorStop(0,"rgba(255,255,255,1)"),r.addColorStop(.2,"rgba(255,255,255,0.8)"),r.addColorStop(.6,"rgba(255,255,255,0.2)"),r.addColorStop(1,"rgba(0,0,0,0)"),o.fillStyle=r,o.fillRect(0,0,64,64);const n=new J(s);this.material=new V({uniforms:{uTime:{value:0},uAudioLevel:{value:0},tSprite:{value:n}},vertexShader:`
                uniform float uTime;
            ...
            `,transparent:!0,blending:T,depthWrite:!1}),this.particles=new W(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var f;this.boxOuter=new I;const e=new ce(new fe(3,3,3)),t=new ae({color:16777215,transparent:!0,opacity:.9,blending:T}),i=new ae({color:3900150,transparent:!0,opacity:.5,blending:T});this.boxOuter.add(new ie(e,t));for(let l=1;l<=3;l++){const g=new ie(e,i);g.scale.setScalar(1+l*.012),this.boxOuter.add(g)}const a=new ce(new fe(2,2,2)),s=new ae({color:14742270,transparent:!0,opacity:.8,blending:T}),o=new ae({color:6333946,transparent:!0,opacity:.4,blending:T});this.boxInner=new I,this.boxInner.add(new ie(a,s));for(let l=1;l<=2;l++){const g=new ie(a,o);g.scale.setScalar(1+l*.015),this.boxInner.add(g)}const r=new ce(new fe(3.05,3.05,3.05)),n=new ae({color:9684477,transparent:!0,opacity:.8,blending:T});this.boxEdges=new ie(r,n),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const h=((f=this.customColors)==null?void 0:f.box)||this.customColor;h&&(this.boxOuter.children.forEach(l=>l.material.color.copy(h)),this.boxInner.children.forEach(l=>l.material.color.copy(h)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(h))}initDragon(){var g;this.dragonDummy=new He,this.dragonLength=80;const e=new re(.8,1),t=new R({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:T}),i=new re(.5,1),a=new R({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:T});this.dragonBodyInstanced=new be(e,t,this.dragonLength),this.dragonGlowInstanced=new be(i,a,this.dragonLength);const s=new ue(1.5,3.5,5);s.rotateX(Math.PI/2);const o=new R({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:T});this.dragonHead=new _(s,o),this.dragonPearlGroup=new I;const r=new ne(1,16,16),n=new R({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:T}),h=new ne(1.3,16,16),f=new R({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:T});this.dragonPearl=new _(r,n),this.dragonPearlHalo=new _(h,f),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const l=((g=this.customColors)==null?void 0:g.dragon)||this.customColor;l&&this.updateDragonColor(l)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const i=(t.h+.5)%1,a=this.galaxyStars.geometry.getAttribute("color");if(a){const s=a.count,o=this._tempColor;for(let r=0;r<s;r++){const n=r/s,h=n<.2?.8:n<.5?.6:.4+Math.random()*.15,f=.6+Math.random()*.3;o.setHSL(i,f,h),a.setXYZ(r,o.r,o.g,o.b)}a.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const i=(t.h+.5)%1,a=new A().setHSL(i,t.s,t.l);this.dragonGlowInstanced.material.color.copy(a)}initGalaxy(){const e=this.batterySaver?500:1500,t=new k,i=[],a=[],s=[];for(let n=0;n<e;n++){const h=n/e*Math.PI*10,f=2.5+n/e*20+Math.random()*2,l=n%4*(Math.PI*2/4),g=Math.max(.5,n/e*4),c=Math.cos(h+l)*f+(Math.random()-.5)*g,u=(Math.random()-.5)*1.5,v=Math.sin(h+l)*f+(Math.random()-.5)*g;i.push(c,u,v);const z=n/e;z<.2?a.push(1,.95,.7):z<.5?a.push(.7+Math.random()*.3,.8,1):a.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),s.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new X(i,3)),t.setAttribute("color",new X(a,3)),t.setAttribute("size",new X(s,1));const o=this.createStarTexture(),r=new me({size:.25,vertexColors:!0,map:o,transparent:!0,opacity:.9,blending:T,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new W(t,r),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new I;const t=new R({color:4892415,transparent:!0,opacity:.85,blending:T,depthWrite:!1,side:$}),i=new I;if(e==="sun2"){const a=t.clone();a.side=Xe;const s=new we(1.5,.25,16,64);i.add(new _(s,a));const o=8,r=new ue(.4,2.7,4);r.translate(0,2.7/2,0);const n=new ue(.2,1.7,4);n.translate(0,1.7/2,0);for(let h=0;h<o;h++){const f=h/o*Math.PI*2,l=new _(r,a);l.rotation.z=-f,l.position.set(Math.sin(f)*1.5,Math.cos(f)*1.5,0),i.add(l);const g=f+Math.PI/o,c=new _(n,a);c.rotation.z=-g,c.position.set(Math.sin(g)*1.5,Math.cos(g)*1.5,0),i.add(c)}}else if(e==="sun3"){const a={uTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=a;const s=`
                varying vec2 vUv;
            ...
            `,r=new V({vertexShader:s,fragmentShader:o,uniforms:a,transparent:!0,blending:T,depthWrite:!1,side:$}),n=new ne(2,64,64),h=new _(n,r);i.add(h);const f=new R({color:t.color,transparent:!0,opacity:.15,blending:T,depthWrite:!1,side:Ye}),l=new ne(3,32,32);i.add(new _(l,f))}else{const a=new we(1.5,.12,8,64);i.add(new _(a,t));const s=8;for(let o=0;o<s;o++){const r=o/s*Math.PI*2,n=new Ce;n.moveTo(-.4,0),n.lineTo(.4,0),n.lineTo(0,2.7),n.lineTo(-.4,0);const h=new Me(n),f=new _(h,t);f.rotation.z=-r,f.position.set(Math.sin(r)*1.5,Math.cos(r)*1.5,0),i.add(f);const l=r+Math.PI/s,g=new Ce;g.moveTo(-.2,0),g.lineTo(.2,0),g.lineTo(0,1.7),g.lineTo(-.2,0);const c=new Me(g),u=new _(c,t);u.rotation.z=-l,u.position.set(Math.sin(l)*1.5,Math.cos(l)*1.5,0),i.add(u)}}this.galaxySunMesh.add(i),this.galaxySunMesh.position.set(0,0,.1),this.galaxyGroup.add(this.galaxySunMesh)}setGalaxySunStyle(e){e!=="sun"&&e!=="sun2"&&e!=="sun3"||(this.galaxySunStyle=e,this.galaxyGroup&&this.galaxyGroup.children.length>0&&this.createGalaxySun(e))}setGalaxySunRotation(e,t){e==="x"&&(this.sunRotationSpeedX=parseFloat(t)),e==="y"&&(this.sunRotationSpeedY=parseFloat(t)),e==="z"&&(this.sunRotationSpeedZ=parseFloat(t))}createStarTexture(){if(this.textures.star)return this.textures.star;const e=64,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e);const o=i.createRadialGradient(a,s,0,a,s,e/2);return o.addColorStop(0,"rgba(255, 255, 255, 1.0)"),o.addColorStop(.1,"rgba(255, 255, 240, 0.8)"),o.addColorStop(.25,"rgba(255, 255, 200, 0.3)"),o.addColorStop(.5,"rgba(200, 200, 255, 0.1)"),o.addColorStop(1,"rgba(100, 100, 255, 0)"),i.fillStyle=o,i.fillRect(0,0,e,e),i.fillStyle="rgba(255, 255, 255, 0.6)",i.beginPath(),i.moveTo(0,s-1),i.lineTo(a,s-.5),i.lineTo(e,s-1),i.lineTo(e,s+1),i.lineTo(a,s+.5),i.lineTo(0,s+1),i.closePath(),i.fill(),i.beginPath(),i.moveTo(a-1,0),i.lineTo(a-.5,s),i.lineTo(a-1,e),i.lineTo(a+1,e),i.lineTo(a+.5,s),i.lineTo(a+1,0),i.closePath(),i.fill(),i.beginPath(),i.arc(a,s,2,0,Math.PI*2),i.fillStyle="rgba(255, 255, 255, 1.0)",i.fill(),this.textures.star=new J(t),this.textures.star}initMandala(){var s;this.mandalaRings=[];const e=[2450411,15357964,3900150,16347926,12573694];for(let o=0;o<5;o++){const r=1.2+o*.8,n=6+o*6,h=new je(r-.05,r+.05,n),f=new R({color:e[o],side:$,transparent:!0,opacity:.4-o*.05,blending:T}),l=new _(h,f);l.userData={speed:(.01+o*.005)*(o%2===0?1:-1),segments:n},this.mandalaRings.push(l),this.mandalaGroup.add(l)}const t=new Qe(.3,32),i=new R({color:16347926,transparent:!0,opacity:.6,blending:T});this.mandalaCenter=new _(t,i),this.mandalaGroup.add(this.mandalaCenter),this.mandalaGroup.visible=!1;const a=(s=this.customColors)==null?void 0:s.mandala;a&&(this.mandalaRings.forEach(o=>o.material.color.copy(a)),this.mandalaCenter.material.color.copy(a))}createSnowflakeTexture(){if(this.textures.snowflake)return this.textures.snowflake;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e),i.strokeStyle="rgba(220,240,255,1.0)",i.lineCap="round";for(let o=0;o<6;o++){const r=o/6*Math.PI*2;i.save(),i.translate(a,s),i.rotate(r),i.lineWidth=2.5,i.beginPath(),i.moveTo(0,0),i.lineTo(0,-52),i.stroke();const n=[{d:18,len:14,angle:Math.PI/4},{d:32,len:20,angle:Math.PI/4},{d:46,len:10,angle:Math.PI/5}];i.lineWidth=1.5,n.forEach(({d:h,len:f,angle:l})=>{[1,-1].forEach(g=>{i.beginPath(),i.moveTo(0,-h),i.lineTo(g*f*Math.cos(Math.PI/2-l),-h-f*Math.sin(Math.PI/2-l)),i.stroke()})}),i.restore()}i.beginPath();for(let o=0;o<6;o++){const r=o/6*Math.PI*2-Math.PI/6,n=a+Math.cos(r)*4,h=s+Math.sin(r)*4;o===0?i.moveTo(n,h):i.lineTo(n,h)}return i.closePath(),i.fillStyle="rgba(255, 255, 255, 0.8)",i.fill(),this.textures.snowflake=new J(t),this.textures.snowflake}initSnowflake(){for(;this.snowflakeGroup.children.length>0;){const c=this.snowflakeGroup.children[0];this.snowflakeGroup.remove(c),c.geometry&&c.geometry.dispose(),c.material&&c.material.dispose()}this._snowData=null;const e=700,t=new Float32Array(e*3),i=new Float32Array(e),a=new Float32Array(e),s=new Float32Array(e),o=new Float32Array(e),r=new Float32Array(e),n=new Float32Array(e);for(let c=0;c<e;c++){const u=c*3;t[u]=(Math.random()-.5)*80,t[u+1]=(Math.random()-.5)*60,t[u+2]=-40+Math.random()*35;const v=(t[u+2]+40)/35;i[c]=1.5+v*8,a[c]=.2+v*.6,s[c]=Math.random()*Math.PI*2,o[c]=.015+Math.random()*.04+v*.03,r[c]=.01+Math.random()*.02,n[c]=.4+Math.random()*.8}const h=new k;h.setAttribute("position",new D(t,3)),h.setAttribute("aSize",new D(i,1)),h.setAttribute("aOpacity",new D(a,1));const f=this.createSnowflakeTexture(),l=new V({uniforms:{uTexture:{value:f},uColor:{value:this.customColor?this.customColor.clone():new A(10875883)},uIntensity:{value:0},uSizeMultiplier:{value:1},uGlowAmount:{value:.5}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),g=new W(h,l);this.snowflakeGroup.add(g),this._snowData={count:e,positions:t,phases:s,speeds:o,drifts:r,driftFreqs:n,points:g,material:l,spinMeshes:[],spinSpeeds:[]}}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)))}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)))}initLava(){var o;this.lavaBlobs=[];const e=16;this.lavaUniforms={uBlobs:{value:[]},uColor:{value:new A(((o=x.visualColors)==null?void 0:o.lava)||16737792)},uSecondaryColor:{value:new A(16755200)},uTime:{value:0},uIntensity:{value:0},uResolution:{value:new le(window.innerWidth,window.innerHeight)}};for(let r=0;r<e;r++)this.lavaUniforms.uBlobs.value.push(new Ze(0,-100,0,0));const t=new V({uniforms:this.lavaUniforms,vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,transparent:!0,blending:T,depthWrite:!1,side:$}),i=new K(100,100),a=new _(i,t);a.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(r=>{for(let n=0;n<r.count;n++){const h=r.minSize+Math.random()*(r.maxSize-r.minSize),f=["heating","rising","cooling","falling"],l=f[Math.floor(Math.random()*f.length)],g=-18+Math.random()*4,c=18+Math.random()*4;let u=0,v=.5;l==="heating"?(u=g,v=Math.random()*.5):l==="rising"?(u=g+Math.random()*(c-g),v=.8+Math.random()*.2):l==="cooling"?(u=c,v=1-Math.random()*.3):l==="falling"&&(u=c-Math.random()*(c-g),v=.2+Math.random()*.3),this.lavaBlobs.push({position:new $e((Math.random()-.5)*12,u,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:h,state:l,temperature:v,floatMin:g,floatMax:c,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(h*.5),fallSpeed:(.05+Math.random()*.05)/(h*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(a),this.lavaGroup.visible=!1}initFireplace(){const i=new K(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new _(i,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new Ke(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const a=650,s=new k,o=[];for(let r=0;r<a;r++)o.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);s.setAttribute("position",new X(o,3)),this.emberMat=new me({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:T,depthWrite:!1}),this.embers=new W(s,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(a);for(let r=0;r<a;r++)this.emberVelocities[r]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new V({uniforms:{uTime:{value:0},uColor:{value:new A(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:$,blending:T,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new k,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*40,i[o+2]=(Math.random()-.5)*40,a[o]=Math.random(),a[o+1]=Math.random(),a[o+2]=.08+Math.random()*.12}t.setAttribute("position",new D(i,3)),t.setAttribute("aRandom",new D(a,3)),this.rainMaterial=new V({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),this.raindrops=new W(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new k,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;i[r]=(Math.random()-.5)*40,i[r+1]=(Math.random()-.5)*20,i[r+2]=(Math.random()-.5)*40,a[r]=Math.random(),a[r+1]=Math.random(),a[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new D(i,3)),t.setAttribute("aRandom",new D(a,3)),this.petalMaterial=new V({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new W(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new K(40,40,32,32);this.zenWaterMaterial=new R({color:2245734,transparent:!0,opacity:.3,side:$}),this.zenWater=new _(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new K(300,100,128,64);this.oceanWave=new _(e,new V({uniforms:{uTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new A(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:$})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new k,a=[];for(let n=0;n<t;n++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new X(a,3));const s=new me({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:T,depthWrite:!1});this.oceanFoam=new W(i,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const s=8,o=8,r=1024/s,n=1024/o;let h="🪷MINDWAVE";const f=e.logicMode,l=e.customText;f==="custom"||f==="txt"?h="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(f==="random"||f==="rnd"||f==="matrix"||f==="int"||f==="interstellar")&&(h="");const g=f==="matrix"||f==="int"||f==="interstellar"?[]:["LOGO",...h],c=g.length;for(let v=0;v<64;v++){const z=v%8,q=Math.floor(v/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(z*r,q*n,r,n),a.save(),a.translate(z*r+r/2,q*n+n/2);let P="",M=!1;if(v<c){const G=g[v];G==="LOGO"?M=!0:P=G}else{const w="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";P=w.charAt(Math.floor(Math.random()*w.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(P,0,0),a.restore(),P="")}if(P||M)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",M)if(this.logoImage){const B=document.createElement("canvas");B.width=100,B.height=100;const U=B.getContext("2d");U.imageSmoothingEnabled=!0,U.imageSmoothingQuality="high",U.drawImage(this.logoImage,0,0,100,100);const j=U.getImageData(0,0,100,100),L=j.data;for(let O=0;O<L.length;O+=4){const ee=180+(L[O]+L[O+1]+L[O+2])/3/255*75;L[O]=ee,L[O+1]=ee,L[O+2]=ee}U.putImageData(j,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(B,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new Je().load("./mindwave-logo-icon.png",w=>{if(this.logoImage=w,this.logoLoading=!1,this.cyberMaterial){const B=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=B}},void 0,w=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(P,0,0);a.restore()}const u=new J(i);return u.magFilter=Se,u.minFilter=Se,u}createCyberShader(e,t=this.matrixConfig){return new V({uniforms:{uTexture:{value:e},uColor:{value:new A(t.color||65345)},uHeadColor:{value:new A(15794160)},uTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
