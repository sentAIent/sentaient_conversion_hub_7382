import{h as Ne,T as lo,e as Jt}from"./controls_v3-CSW6-NR-.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-app.js";/**
 * @license
...
`,Qm=i=>i===1?`
        ...
        void main() {
            ...
            float yVal = pHeart.y - 0.3 - sqrt(abs(pHeart.x)) * 0.5;
            float heartSDF = x2 + yVal*yVal - 0.2;
            
            float ripples = sin(heartSDF * 30.0 - time * 8.0 + baseLuma * 12.0);
            vec2 warp = grad * ripples * 0.06 * (1.0 + lowPulse) + normalize(p) * sin(heartSDF * 15.0 - time * 4.0) * 0.02 * lowPulse;
            
            vec2 dUv = clamp(uv + warp * uIntensity, 0.001, 0.999);
            ...
            vec2 warp = flowDir * (0.06 + midPulse * 0.08) * sin(flowVar * 8.0 + time * 2.0);
            warp += grad * cos(baseLuma * 20.0 - time * 5.0) * 0.03 * (1.0 + midPulse);
            ...
            vec2 vibration = grad * sin(waveField * 15.0 - time * 10.0) * 0.03 * highPulse;
            ...
            vec2 warp = grad * contour * 0.06 * (1.0 + midPulse) + normalize(p) * sin(mouseDist * 20.0 - time * 5.0) * 0.02 * uMouseSync;
            ...
            vec2 polarWarp = vec2(cos(angle), sin(angle)) * radialWave * 0.04 * (1.0 + lowPulse);
            polarWarp += vec2(-sin(angle), cos(angle)) * sectorAngle * 0.02 * lowPulse;
            ...
            lattice += smoothstep(0.02, 0.0, abs(r - 0.35)) * 0.4;
            lattice += smoothstep(0.015, 0.0, abs(r - 0.6)) * 0.3;
...
//# sourceMappingURL=visualizer_vGOLD_SYNC-YTZsqdLK.js.map
