...
const classes = [
    { id: 14, name: 'Class XIV: Fractal Mandalas', count: 10, defaultColors: ['#ffd700', '#800080'] },
    { id: 15, name: 'Class XV: Interference Patterns', count: 10, defaultColors: ['#0000cd', '#00ffff'] },
    { id: 16, name: 'Class XVI: Cymatic Blooms', count: 10, defaultColors: ['#ff69b4', '#ffff00'] }
];
...
if (htmlStr.includes(targetStr)) {
    ...
    console.log("Successfully injected cymatics UI for Classes 14, 15, 16!");
} else {
