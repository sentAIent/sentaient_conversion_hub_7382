import{c as fe,a6 as ha,e as Jt}from"./persistence-2_wyzSkG.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-app.js";/**
 * @license
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
            ...
            `,transparent:!0,depthWrite:!1,blending:Ye}),f=new jt(c,u);this.snowflakeGroup.add(f),this._snowData={count:e,positions:t,phases:r,speeds:a,drifts:o,driftFreqs:l,points:f,material:u,spinMeshes:[],spinSpeeds:[]},console.log("[Viz] ❄️ Real snowfall initialized —",e,"crystals")}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)),console.log("[Viz] Snow Size Override:",e))}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)),console.log("[Viz] Snow Glow Override:",e))}setCymaticIntensity(e){this._cymaticIntensityOverride=e,this.cymaticMaterial&&this.cymaticMaterial.uniforms.uIntensity&&(this.cymaticMaterial.uniforms.uIntensity.value=e)}setCymaticHarmonics(e){fe.harmonicsLevel=e,this.cymaticMaterial&&this.cymaticMaterial.uniforms.uHarmonics&&(this.cymaticMaterial.uniforms.uHarmonics.value=e)}setSnowColor(e){var t,n;(t=this._snowData)!=null&&t.material&&this._snowData.material.uniforms.uColor.value.set(e),(n=this._snowData)!=null&&n.spinMeshes&&this._snowData.spinMeshes.forEach(i=>{i.material&&i.material.color.set(e)})}static get CYMATIC_PATTERNS(){return[{n:3,m:2,name:"Sri Yantra",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_0.png"},{n:4,m:3,name:"Flower of Life",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_1.png"},{n:5,m:5,name:"Metatron Cube",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_2.png"},{n:2,m:6,name:"Vector Equil",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_3.png"},{n:3,m:8,name:"Fibonacci",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_4.png"},{n:6,m:2,name:"Torus Field",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_5.png"},{n:4,m:7,name:"Mandelbrot",cat:"fractal",image:"binaural-assets/images/cymatics/ai_cymatic_6.png"},{n:5,m:9,name:"Julia Loop",cat:"fractal",image:"binaural-assets/images/cymatics/ai_cymatic_7.png"},{n:7,m:3,name:"Recursive",cat:"fractal",image:"binaural-assets/images/cymatics/ai_cymatic_8.png"},{n:8,m:5,name:"Polygon",cat:"geometry",image:"binaural-assets/images/cymatics/ai_cymatic_9.png"},{n:6,m:6,name:"Lattice",cat:"geometry",image:"binaural-assets/images/cymatics/ai_cymatic_10.png"},{n:9,m:3,name:"Singularity",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_11.png"},{n:4,m:10,name:"Neural Web",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_12.png"},{n:7,m:7,name:"Quantum Flux",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_13.png"},{n:1,m:9,name:"Golden Ratio",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_14.png"},{n:8,m:2,name:"Celestial",cat:"radial",image:"binaural-assets/images/cymatics/ai_cymatic_15.png"},{n:10,m:4,name:"Void Geometry",cat:"geometry",image:"binaural-assets/images/cymatics/ai_cymatic_16.png"},{n:3,m:12,name:"Infinite",cat:"fractal",image:"binaural-assets/images/cymatics/ai_cymatic_0.png"},{n:6,m:9,name:"Prism Fold",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_1.png"},{n:12,m:1,name:"Cosmic Knot",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_2.png"},{n:5,m:11,name:"Zen Mandala",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_3.png"},{n:8,m:8,name:"Astral",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_4.png"},{n:11,m:5,name:"Etheric",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_5.png"},{n:4,m:14,name:"Plasma Bloom",cat:"fractal",image:"binaural-assets/images/cymatics/ai_cymatic_6.png"},{n:9,m:9,name:"Synchronicity",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_7.png"},{n:7,m:12,name:"Unified Field",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_8.png"},{n:15,m:3,name:"Omega Point",cat:"complex",image:"binaural-assets/images/cymatics/ai_cymatic_9.png"},{n:6,m:13,name:"Source Fold",cat:"sacred",image:"binaural-assets/images/cymatics/ai_cymatic_10.png"},{name:"Prime Prime",n:13,m:17,type:4,cat:"advanced",image:"binaural-assets/images/prime_prime.png"},{name:"Metatron's Grid",n:6,m:12,type:4,cat:"advanced",image:"binaural-assets/images/metatrons_grid.png"},{name:"Aetheric Weaver",n:11,m:11,type:4,cat:"advanced",image:"binaural-assets/images/aetheric_weaver.png"},{name:"Neural Singularity",n:15,m:5,type:4,cat:"advanced",image:"binaural-assets/images/neural_singularity.png"},{name:"Chronos Vortex",n:7,m:14,type:4,cat:"advanced",image:"binaural-assets/images/chronos_vortex.png"},{name:"Void Fractal",n:22,m:22,type:4,cat:"advanced",image:"binaural-assets/images/void_fractal.png"},{name:"Crystalline Pulse",n:9,m:18,type:4,cat:"advanced",image:"binaural-assets/images/crystalline_pulse.png"},{name:"Stellar Loom",n:13,m:3,type:4,cat:"advanced",image:"binaural-assets/images/stellar_loom.png"},{n:1,m:1,name:"Fundamental Zenith",cat:"classic"},{n:1,m:2,name:"Dual Horizon",cat:"classic"},{n:1,m:3,name:"Triple Axis",cat:"classic"},{n:1,m:4,name:"Quad Core",cat:"classic"},{n:1,m:5,name:"Penta Wave",cat:"classic"},{n:2,m:2,name:"Square Harmony",cat:"classic"},{n:2,m:3,name:"Lotus Flow",cat:"classic"},{n:2,m:4,name:"Cresent Node",cat:"classic"},{n:2,m:5,name:"Orchid Ring",cat:"classic"},{n:3,m:3,name:"Cross Pulse",cat:"classic"},{n:3,m:1,name:"Nodal Ribbon",cat:"classic"},{n:3,m:5,name:"Radial Seed",cat:"classic"},{n:4,m:4,name:"Diamond Lattice",cat:"classic"},{n:4,m:2,name:"Solar Grate",cat:"classic"},{n:5,m:5,name:"Cellular Grid",cat:"classic"},{n:6,m:2,name:"Star Resonance",cat:"classic"},{n:6,m:6,name:"Hexa Flux",cat:"classic"},{n:7,m:3,name:"Solar Mandala",cat:"classic"},{n:8,m:4,name:"Graphene Matrix",cat:"classic"},{n:8,m:8,name:"Hyper Lobe",cat:"classic"},{n:9,m:2,name:"Atomic Shell",cat:"classic"},{n:9,m:9,name:"Omega Sphere",cat:"classic"},{n:1,m:8,name:"Fibonacci Spiral",cat:"classic"},{n:10,m:4,name:"Fractal Lace",cat:"classic"},{n:11,m:3,name:"Cosmic Gear",cat:"classic"},{n:12,m:12,name:"Interstellar Mesh",cat:"classic"},{n:5,m:13,name:"Quantum Foam",cat:"classic"},{n:20,m:2,name:"Singularity",cat:"classic"},{name:"Aura Genesis",n:8,m:16,type:4,cat:"advanced"},{name:"Cosmic Weaver",n:14,m:7,type:4,cat:"advanced"},{name:"Quantum Singularity",n:17,m:3,type:5,cat:"live_shader"},{name:"Neural Core",n:21,m:7,type:5,cat:"live_shader"},{name:"Void Matrix",n:14,m:14,type:5,cat:"live_shader"},{name:"Omega Resonance",n:25,m:2,type:5,cat:"live_shader"},{name:"Stellar Nexus",n:19,m:8,type:5,cat:"live_shader"},{name:"Chronos Weave",n:23,m:5,type:5,cat:"live_shader"}]}initCymatics(){try{if(!this.cymaticsGroup)return;for(;this.cymaticsGroup.children.length>0;){const l=this.cymaticsGroup.children[0];this.cymaticsGroup.remove(l),l.geometry&&l.geometry.dispose(),l.material&&(l.material.map&&l.material.map.dispose(),l.material.dispose())}const e=new Kt(45,45,128,128);this.cymaticMaterial=new ft({uniforms:{uN:{value:this.currentCymaticData?this.currentCymaticData.n:1},uM:{value:this.currentCymaticData?this.currentCymaticData.m:3},uBassN:{value:1},uBassM:{value:1},uHighN:{value:5},uHighM:{value:5},uType:{value:this.currentCymaticData&&this.currentCymaticData.type||0},uEnergy:{value:.5},uTime:{value:0},uIntensity:{value:.5},uHarmonics:{value:0},uBeatFreq:{value:0},uColor:{value:new _e(fe.visualColors.sphere||"#60a9ff")},uSecondaryColor:{value:new _e(16777215)},uResolution:{value:new oe(window.innerWidth,window.innerHeight)},uNormMids:{value:0},uNormHighs:{value:0},uMedium:{value:fe.cymaticMedium||0},uTexture:{value:null},uHasTexture:{value:0},uShiver:{value:0},uMouse:{value:new oe(.5,.5)},uMouseActive:{value:0},uResonance:{value:fe.cymaticResonance??1},uEntropy:{value:fe.cymaticEntropy??1},uFlow:{value:fe.cymaticFlow??1}},vertexShader:`
                    varying vec2 vUv;
...
//# sourceMappingURL=visualizer_vGOLD_SYNC-C02bTngj.js.map
