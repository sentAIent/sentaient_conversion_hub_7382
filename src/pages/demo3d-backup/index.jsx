...
import CoreValuesSection from '../home/components/CoreValuesSection';
import Scene3D from './components/Scene3D';

const Demo3DBackupHome = () => {
  useEffect(() => {
  ...
  return (
    <div className="relative min-h-screen bg-[#050505] font-sans selection:bg-white/20 text-white overflow-hidden">
      <Helmet>
        <title>sentAIent | Interactive 3D Experience</title>
        <meta
          name="description"
          content="Explore our portfolio of autonomous marketing, legal analysis, wellness, and interactive entertainment platforms in full 3D."
        />
      ...
      <footer className="bg-[#0A0A0B] border-t border-white/5 py-12 relative z-20">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-16">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              {name: 'AutoPilot', tag: 'B2B Marketing', logo: '/autopilot_logo.png', gradient: 'from-[#8E9AAF]/25 to-[#4A5568]/25', scale: 'scale-[1.4] translate-y-2'},
...
export default Demo3DBackupHome;
