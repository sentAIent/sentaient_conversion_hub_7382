class HazardManager {
    ...
    spawnHazards() {
        ...
        // Spawn new mines
        let mineSpawnAttempts = 0;
        while (this.game.spaceMines.length < targetMines && mineSpawnAttempts++ < 20) {
        ...
        let bhSpawnAttempts = 0;
        while (this.game.hazardBlackHoles.length < targetBlackHoles && bhSpawnAttempts++ < 10) {
            const angle = safeAngle();
        ...
        let baseSpawnAttempts = 0;
        while (this.game.missileBases.length < targetBases && baseSpawnAttempts++ < 10) {
            const angle = safeAngle();
