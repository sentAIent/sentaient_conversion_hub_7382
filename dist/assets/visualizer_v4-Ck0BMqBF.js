...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                if (uLoopActive > 0.5) {
                    ...
                    // Keep the wave mostly centered. Move it slightly from x=30 to x=-30 
                    // so it feels like it's rolling forward without dumping us into the trough.
                ...
                if (pos.z > curlStartHeight) {
                    ...
                    float bendAngle = heightAbovePivot * 0.03 * activeCurl * envelope; 
        ...
        `,s=new O({vertexShader:i,fragmentShader:a,uniforms:t,transparent:!0,side:K,wireframe:!1});this.tsunamiMaterial=s;const o=new G(e,s);o.rotation.x=-Math.PI/2,o.position.y=-25,o.position.z=-180,o.position.x=0,o.frustumCulled=!1,this.tsunamiGroup.add(o);const n="data:image/svg+xml;charset=utf-8,"+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
            <g>
...
//# sourceMappingURL=visualizer_v4-Ck0BMqBF.js.map
