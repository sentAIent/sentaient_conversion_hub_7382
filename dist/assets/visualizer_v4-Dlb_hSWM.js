        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                if (uLoopActive > 0.5) {
                    ...
                    // Forming - never drop to 0.1, always maintain at least 50% of the wave so we never stare at a flat trough
                    ...
                    // The wave peak starts slightly left (+30) and rolls slightly right (-30)
                    // This keeps it perfectly framed in the camera view the entire time!
                    waveX = pos.x + 30.0 - (phase * 60.0);
                }
...
//# sourceMappingURL=visualizer_v4-Dlb_hSWM.js.map
