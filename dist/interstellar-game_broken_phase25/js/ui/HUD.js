class HUDManager {
    ...
    closeAllModals() {
        ...
        const modals = [
            ...
            'ascensionOverlay', 'baseBuilderModal', 'academyPanel'
        ];
        modals.forEach(id => {
        ...
        const popups = ['adminPanel', 'matrixPanel', 'rotationPanel', 'logBookPanel', 'academyPanel', 'colonyHud'];
        popups.forEach(id => {
            const el = document.getElementById(id);
    ...
    updateBgUI() {
        ...
        const styles = ['deep-space', 'nebula', 'alien', 'cyber'];
