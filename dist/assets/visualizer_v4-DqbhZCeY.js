...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                // We sweep the wave based on phase so it travels across the screen.
                ...
                if (uLoopActive > 0.5) {
                    ...
                    // Sweep the wave horizontally, from left to right!
                    // Add pos.y slant so the wave peels down the line instead of closing out simultaneously!
                    waveX = pos.x + (pos.y * 0.5) + 100.0 - (phase * 200.0);
                }
...
//# sourceMappingURL=visualizer_v4-DqbhZCeY.js.map
