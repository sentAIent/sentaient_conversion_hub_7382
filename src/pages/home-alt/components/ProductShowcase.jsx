        ...
        <section id="products" className="py-24 bg-zinc-950">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl lg:text-5xl font-bold text-white mb-4">Flagship Products</h2>
                    <p className="text-white/40 text-lg">Tools designed to reshape human perception and productivity.</p>
                </div>
                ...
                <div className="space-y-24">
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="order-2 lg:order-1">
                            <div className="flex items-center space-x-3 mb-6">
                                ...
                                <h3 className="text-4xl font-black text-white tracking-tight">MindWave</h3>
                            </div>
                            ...
                            <Button
                                size="xl"
                                className="bg-blue-600 hover:bg-blue-500 text-white px-8 rounded-xl"
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="relative group">
                            <div className="absolute inset-0 bg-teal-500/10 blur-3xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div className="aspect-video bg-zinc-900 rounded-3xl border border-white/10 flex items-center justify-center relative z-10 overflow-hidden">
                                {/* Placeholder for Interstellar since image gen failed, using a stylish gradients */}
                                <div className="absolute inset-0 bg-gradient-to-br from-teal-900/20 to-zinc-950"></div>
                                <Icon name="Globe" size={100} className="text-teal-500/20" />
                                <div className="absolute inset-0 flex items-center justify-center">
                                    <div className="text-center">
                                        <Icon name="Navigation" size={48} className="text-teal-400 mb-4 animate-pulse" />
                                        <p className="text-teal-400 font-mono text-sm tracking-[0.3em]">MAPPING THE COSMOS</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div className="flex items-center space-x-3 mb-6">
                                <div className="w-12 h-12 bg-teal-500/20 rounded-xl flex items-center justify-center">
                                    <Icon name="Send" size={24} className="text-teal-400" />
                                </div>
                                <h3 className="text-4xl font-black text-white tracking-tight">Interstellar</h3>
                            </div>
                            <p className="text-xl text-white/70 mb-8 leading-relaxed">
                            ...
                            <Button
                                size="xl"
                                className="bg-teal-600 hover:bg-teal-500 text-white px-8 rounded-xl"
