...
`,ot=f=>f===1?`
        ...
        `,a=new O({vertexShader:t,fragmentShader:i,uniforms:e,transparent:!0,side:Z,wireframe:!1});this.tsunamiMaterial=a,mesh.position.y=-40,mesh.position.z=-50,mesh.position.x=0,mesh.frustumCulled=!1,this.tsunamiGroup.add(mesh);const o="data:image/svg+xml;charset=utf-8,"+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
            <g>
