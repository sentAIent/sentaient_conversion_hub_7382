class AcademyManager {
    constructor(game) {
        ...
        this.lessons = [
            ...
            { id: 'ordnance', title: 'Advanced Ordnance', desc: 'Master weapon loadouts and switching.', completed: false },
    ...
    getObjectiveForLesson(id) {
        const objectives = {
            ...
            ordnance: 'Open the Ordnance panel [[] and test fire your weapons.',
    ...
    update(dt) {
        ...
        switch (lessonId) {
            ...
            case 'ordnance':
                // Check if ordnance panel was opened or weapons fired
                const fired = this.game.projectiles.length > 0;
                const panelOpen = !document.getElementById('ordnancePanel')?.classList.contains('hidden');
                if (fired && panelOpen) {
                    this.completeLesson('ordnance');
                }
                break;
