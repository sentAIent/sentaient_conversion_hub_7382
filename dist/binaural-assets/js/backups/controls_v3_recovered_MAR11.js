...
export function setupUI() {
    ...
    els.matrixBtn = document.getElementById('matrixBtn'); // Cyber
    els.interstellarBtn = document.getElementById('interstellarBtn'); // Matrix
    ...
    if (els.interstellarBtn) els.interstellarBtn.addEventListener('click', () => setVisualMode('interstellar'));
