...
class InputManager {
    ...
    onPointerDown(e) {
        ...
        const x = (e.clientX - rect.left - this.game.camera.x) / this.game.camera.zoom;
        const y = (e.clientY - rect.top - this.game.camera.y) / this.game.camera.zoom;
    ...
    onPointerMove(e) {
        ...
        if (this.game.mode === 'select' && this.game.isDragging && this.game.selectedStar) {
            ...
            const x = (e.clientX - rect.left - this.game.camera.x) / this.game.camera.zoom;
            const y = (e.clientY - rect.top - this.game.camera.y) / this.game.camera.zoom;
            this.game.selectedStar.x = x + this.game.dragOffset.x;
            this.game.selectedStar.y = y + this.game.dragOffset.y;
            if (this.game.renderManager) this.game.renderManager.draw();
        }
    }
