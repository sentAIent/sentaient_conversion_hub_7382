...
`,st=f=>f===1?`
        ...
        `;this.tsunamiMaterial=new E({uniforms:t,vertexShader:i,fragmentShader:a,transparent:!0,side:N}),this.tsunamiWave=new P(e,this.tsunamiMaterial),this.tsunamiWave.rotation.x=-Math.PI/2,this.tsunamiWave.position.y=-50,this.tsunamiGroup.add(this.tsunamiWave);const s=new $(3e3,3e3,10,10),o=new E({uniforms:t,vertexShader:`
            ...
            `,wireframe:!0,transparent:!0,side:N})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new B,a=[];for(let n=0;n<t;n++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new K(a,3));const s=new me({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:T,depthWrite:!1});this.oceanFoam=new j(i,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const s=8,o=8,r=1024/s,n=1024/o;let m="🪷MINDWAVE";const p=e.logicMode,l=e.customText;p==="custom"||p==="txt"?m="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(p==="random"||p==="rnd"||p==="matrix"||p==="int"||p==="interstellar")&&(m="");const g=p==="matrix"||p==="int"||p==="interstellar"?[]:["LOGO",...m],c=g.length;for(let x=0;x<64;x++){const I=x%8,D=Math.floor(x/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(I*r,D*n,r,n),a.save(),a.translate(I*r+r/2,D*n+n/2);let _="",M=!1;if(x<c){const F=g[x];F==="LOGO"?M=!0:_=F}else{const S="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";_=S.charAt(Math.floor(Math.random()*S.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(_,0,0),a.restore(),_="")}if(_||M)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",M)if(this.logoImage){const w=document.createElement("canvas");w.width=100,w.height=100;const k=w.getContext("2d");k.imageSmoothingEnabled=!0,k.imageSmoothingQuality="high",k.drawImage(this.logoImage,0,0,100,100);const Q=k.getImageData(0,0,100,100),q=Q.data;for(let L=0;L<q.length;L+=4){const Z=180+(q[L]+q[L+1]+q[L+2])/3/255*75;q[L]=Z,q[L+1]=Z,q[L+2]=Z}k.putImageData(Q,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(w,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new tt().load("./mindwave-logo-icon.png",S=>{if(this.logoImage=S,this.logoLoading=!1,this.cyberMaterial){const w=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=w}},void 0,S=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(_,0,0);a.restore()}const u=new oe(i);return u.magFilter=Ie,u.minFilter=Ie,u}createCyberShader(e,t=this.matrixConfig){return new E({uniforms:{uTexture:{value:e},uColor:{value:new A(t.color||65345)},uHeadColor:{value:new A(15794160)},uTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
