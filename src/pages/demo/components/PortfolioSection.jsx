...
const projects = [
  ...
  {
    title: 'Legal Eagle',
    description: 'Eagle-eyed contract review for your peace of mind. AI document analysis proposes new clauses based on US contract law.',
    ...
    path: 'https://sentaient.com/legaleagle',
    tag: 'Legal'
  },
  {
    title: 'AutoPilot',
    description: 'Enterprise B2B social media marketing automation platform. AI-driven content creation that handles scheduling and posting.',
  ...
  },
  {
    ...
    bgImage: '/cloveh2o_app_icon_1783126137288.jpg', // No explicit hero slide generated yet, use app icon
...
const PortfolioSection = () => {
  ...
  return (
    <section id="platforms" className="py-24 bg-[#050505] relative border-t border-white/5 overflow-hidden">
        ...
        <div className="mb-16 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 uppercase tracking-widest">
              Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Experience</span>
            </h2>
          </motion.div>
        </div>
      </div>
      ...
      <div className="w-[90vw] max-w-[1800px] mx-auto h-[600px] md:h-[700px] flex overflow-hidden px-4 md:px-12 group/accordion perspective-1000">
          {projects.map((project, index) => (
            <button
              ...
              className="relative flex-1 h-full -mx-2 md:-mx-4 transition-all duration-700 ease-[cubic-bezier(0.25,1,0.5,1)] hover:flex-[3] skew-x-[-8deg] border-x border-black/50 overflow-hidden cursor-pointer group/card focus:outline-none"
              style={{ zIndex: index }}
            >
              {/* Un-skew wrapper for content to keep it straight */}
              <div className="absolute inset-[-50px] md:inset-[-100px] skew-x-[8deg] overflow-hidden pointer-events-none">
                ...
                <div className="absolute inset-0 pointer-events-auto">
                  ...
                  <div className="absolute bottom-[100px] md:bottom-[150px] left-1/2 -translate-x-1/2 w-[90%] max-w-md transform translate-y-12 opacity-0 group-hover/card:translate-y-0 group-hover/card:opacity-100 transition-all duration-700 ease-out flex flex-col items-center text-center">
                    ...
                    {/* Fake CTA button (just visual, click is handled by parent) */}
                    <div className="inline-flex items-center justify-center gap-2 px-8 py-3.5 bg-white text-black font-bold uppercase tracking-wide text-sm hover:bg-gray-200 transition-colors shadow-xl">
                      View Platform <ArrowUpRight className="w-4 h-4" />
                    </div>
                  </div>
                </div>
