        ...
        <div className="flex items-center justify-between h-16 px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <Button
              ...
              onClick={() => window.open.href = 'https://sentaient.setmore.com/brian?step=time-slot&products=ab1e4953-92d5-442d-b53b-cf759334c2b4&type=service&staff=429be748-e76f-45c9-9e76-760cf1210fb7&staffSelected=false'}
            >
              Book Consultation
            </Button>
          </div>
