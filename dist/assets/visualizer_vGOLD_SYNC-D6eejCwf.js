var Pe=Object.defineProperty;var Fe=(v,e,t)=>e in v?Pe(v,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):v[e]=t;var de=(v,e,t)=>Fe(v,typeof e!="symbol"?e+"":e,t);import{c as y,a6 as me,e as H}from"./controls_v3-D8hlp0GS.js";import{C as F,G as L,S as Ae,P as Re,W as De,I as ae,M as E,a as P,A as G,B as q,b as k,c as O,d as U,E as oe,e as re,L as K,f as ee,O as _e,g as fe,h as ne,i as se,F as Y,j as le,D as Z,k as Ee,T as pe,l as Ve,m as ve,n as ge,o as te,R as Be,p as Oe,V as ye,q as We,r as $,s as He,t as ke,u as Ne,N as we,v as qe,w as Ue,x as xe,y as be}from"./three-BCNwNaIT.js";import{C as Ye}from"./CymaticsCore-D4gGyA6k.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-app.js";let u=null;class Me{constructor(e,t={}){this.canvas=e,this.activeModes=t.activeModes||new Set,this.mode=t.mode||"none",this.mindWaveMode=t.mindWaveMode!==void 0?t.mindWaveMode:!0,this.galaxySunStyle=t.galaxySunStyle||"sun",this.currentCymaticData={name:"Fundamental Zenith",n:1,m:1,energy:.2},this.cymaticsHistory=[],this.cymaticsHistoryIndex=-1,this._cymaticDriftOffset=Math.random()*1e3,this.cyberConfig={logicMode:t.cyberLogicMode||"matrix",customText:t.cyberCustomText||"WELCOME",angle:t.cyberAngle||0,speed:t.cyberSpeedMultiplier||1,length:1,color:"#00FF41",rainbow:!0},this.matrixConfig={logicMode:t.matrixLogicMode||"interstellar",customText:t.matrixCustomText||"MINDWAVE",angle:0,speed:1,length:1,color:"#00FF41",rainbow:!1},this.initialized=!1,this._rainbowEnabled=t.rainbowEnabled||!1,this.isVisualizer3D=!0,this.overlayCanvas=document.getElementById("cyberCanvas"),this.overlayCtx=this.overlayCanvas?this.overlayCanvas.getContext("2d",{alpha:!0}):null,this.overlayCanvas&&(this.resizeOverlayCanvas(),window.addEventListener("resize",()=>this.resizeOverlayCanvas())),this.matrixCyberStreams=[],this.currentCyberAngle=t.cyberAngle!==void 0?t.cyberAngle:0,this.cyberColorCustomized=!1;try{const a=localStorage.getItem("cyberThemeHistory");this.themeHistory=a?JSON.parse(a):[],this.lastCyberFamily=localStorage.getItem("cyberLastFamily")||""}catch{this.themeHistory=[],this.lastCyberFamily=""}this.currentLogoOpacity=.8,this.targetLogoOpacity=.8,u=this,this.themeType=document.body.dataset.themeType||"dark";const i=/Mobile|Android|iPhone|iPad/i.test(navigator.userAgent);this.batterySaver=t.batterySaver!==void 0?t.batterySaver:i,this.isLowPower=this.batterySaver||localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode"),this.lastFrameRenderTime=0,this.targetFPS=this.isLowPower?30:60,this.vibrationEnabled=typeof y<"u"&&y.visualVibration!==void 0?y.visualVibration:t.visualVibration!==void 0?t.visualVibration:!1,this._fpsRingBuffer=new Float64Array(60),this._fpsRingIndex=0,this._fpsRingCount=0,this.lastLodDegradation=0,this.currentLodLevel="high",this._tempColor=new F,this._logoRenderCanvas=null,this.sphereGroup=new L,this.particleGroup=new L,this.lightspeedGroup=new L,this.lavaGroup=new L,this.fireplaceGroup=new L,this.rainforestGroup=new L,this.zenGardenGroup=new L,this.oceanGroup=new L,this.wavesGroup=new L,this.cyberGroup=new L,this.boxGroup=new L,this.dragonGroup=new L,this.galaxyGroup=new L,this.mandalaGroup=new L,this.cymaticsGroup=new L,this.snowflakeGroup=new L,this._snowData=null;try{this.scene=new Ae,this.cymaticsCore=new Ye(this.cymaticsGroup),[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup].forEach(s=>this.scene.add(s)),this.camera=new Re(75,e.width/e.height,.1,1e3),this.renderer=new De({canvas:e,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),this.renderer.autoClear=!1,this.renderer.setClearColor(0,0),this.renderer.setSize(e.clientWidth,e.clientHeight);const o=this.isLowPower?1:2;this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,o)),this.textures={},this.customColors={},this.customColor=null,this._isRendering=!1,this._freqDataArray=null,this.initEnvironment(),this.camera.position.z=5,this.handleLayoutChange=this.handleLayoutChange.bind(this),window.addEventListener("resize",()=>{this.resize(),this.handleLayoutChange()}),window.addEventListener("mindwave:layout-change",this.handleLayoutChange),this._boundSafeMode=()=>{this.currentLodLevel!=="low"&&(this.degradeLOD(),this.degradeLOD())},window.addEventListener("mindwave:safe-mode-start",this._boundSafeMode),this._boundVisibilityChange=()=>{document.hidden||(this.lastTime=performance.now()*.001,this.active!==!1&&this.initialized&&this.render(y.analyserLeft,y.analyserRight))},document.addEventListener("visibilitychange",this._boundVisibilityChange),this._boundContextLost=s=>{s.preventDefault(),this.active=!1,y.animationId&&(cancelAnimationFrame(y.animationId),y.animationId=null)},e.addEventListener("webglcontextlost",this._boundContextLost),this._boundContextRestored=()=>{try{this.initialized=!1,this._freqDataArray=null,this.initEnvironment(),this.updateVisibility(),this.initialized=!0,this.active=!0,this.lastTime=performance.now()*.001,y.animationId&&cancelAnimationFrame(y.animationId),this._isRendering=!1,this.render(y.analyserLeft,y.analyserRight)}catch{}},e.addEventListener("webglcontextrestored",this._boundContextRestored),this._boundCymaticPointer=s=>{const r=s.touches?s.touches[0].clientX:s.clientX,n=s.touches?s.touches[0].clientY:s.clientY;this.mouseX=r/window.innerWidth*2-1,this.mouseY=-(n/window.innerHeight)*2+1},window.addEventListener("mousemove",this._boundCymaticPointer),window.addEventListener("touchmove",this._boundCymaticPointer,{passive:!0}),this.resize(),setTimeout(this.handleLayoutChange,100),this._boundThemeChange=s=>{if(s.detail&&s.detail.type){const r=s.detail.type;this.themeType!==r&&(this.themeType=r,this.updateLogoTexture())}},window.addEventListener("themeChanged",this._boundThemeChange),this.speedMultiplier=1,this.brightnessMultiplier=1,this.lastTime=performance.now()*.001,this.simTime=0,this.targetFPS=60,this.lastFrameRenderTime=0,this.active=!0,this.updateVisibility(),this.initialized=!0,this.initOverlayLogo(),window.viz3D=this}catch{this.initialized=!1}}resize(){if(!this.renderer||!this.canvas||!this.camera)return;const e=window.innerWidth,t=window.innerHeight;this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.handleLayoutChange()}handleLayoutChange(){!this.renderer||!this.camera||this.camera.clearViewOffset()}resizeOverlayCanvas(){this.overlayCanvas&&(this.overlayCanvas.width=window.innerWidth,this.overlayCanvas.height=window.innerHeight)}generateCyberStyle(){const e=this.overlayCanvas,t=this.overlayCtx;if(!e||!t)return;this.matrixCyberStreams=[];const i=Math.max(11,Math.min(21,Math.floor(e.width/50)));this.isLowPower=localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode");let a=Math.ceil(e.width/i);this.isLowPower||(a*=1.5);let o=window.getCurrentTheme?window.getCurrentTheme():{color:"#2dd4bf"};this.resizeOverlayCanvas(),this.cyberColorCustomized=!1;const s=[{name:"System Yellow",color:"#FFFF00",family:"yellow"},{name:"Neon Pink",color:"#FF1493",family:"pink"},{name:"Chrome Static",color:"#C0C0C0",family:"mono"},{name:"Royal Data",color:"#4169E1",family:"blue"},{name:"White Noise",color:"#FFFFFF",family:"mono"},{name:"Cyan Future",color:"#00FFFF",family:"blue"},{name:"Lime Access",color:"#32CD32",family:"green"},{name:"Purple Haze",color:"#800080",family:"purple"},{name:"Emerald Link",color:"#50C878",family:"green"},{name:"Ice Blue",color:"#A5F2F3",family:"blue"},{name:"sentAIent Blue",color:"#60A9FF",family:"blue"},{name:"Rainbow Surge",color:"rainbow",family:"rainbow"}],r=this.lastCyberFamily||"";let n=s.filter(c=>!this.themeHistory.includes(c.name));const f=n.filter(c=>c.family!==r);f.length>0&&(n=f);let m=n;if(m.length===0){const c=this.themeHistory[this.themeHistory.length-1];m=s.filter(h=>h.name!==c)}const l=m[Math.floor(Math.random()*m.length)];this.themeHistory.push(l.name),this.themeHistory.length>5&&this.themeHistory.shift(),this.lastCyberFamily=l.family;try{localStorage.setItem("cyberThemeHistory",JSON.stringify(this.themeHistory)),localStorage.setItem("cyberLastFamily",this.lastCyberFamily)}catch{}this.cyberSpeedMultiplier===void 0&&(this.cyberSpeedMultiplier=.2),this.cyberLengthMultiplier===void 0&&(this.cyberLengthMultiplier=.7);const g=document.getElementById("cyberRainbowToggle");if(g&&this.cyberRainbowMode===void 0&&(this.cyberRainbowMode=!0,this.cyberConfig.rainbow=!0,g.checked=!0),!this.cyberRainbowMode&&o.color!=="rainbow"){this.cyberColor=o.color;const c=document.getElementById("cyberColorPicker");c&&(c.value=this.cyberColor)}for(let c=0;c<a;c++){const h=Math.random(),p=Math.floor(8+h*11),z=(2+h*8+Math.random()*2)*this.cyberSpeedMultiplier;this.matrixCyberStreams.push({x:c*i,y:Math.random()*this.overlayCanvas.height*1.5-this.overlayCanvas.height*.5,baseSpeed:z,opacity:.2+h*.8,size:p,chars:[],color:o.color!=="rainbow"?o.color:"#FFFFFF"})}this.updateCyberStrings(),this.matrixCyberStreams.sort((c,h)=>c.size-h.size)}renderCyberCyber(){const e=this.activeModes.has("cyber");if(!this.overlayCtx||!this.matrixCyberStreams||!e)return;const t=this.overlayCtx,i=this.overlayCanvas;t.clearRect(0,0,i.width,i.height);const a=this.activeModes.size>1;t.fillStyle=a?"rgba(0, 0, 0, 0.4)":"rgba(0, 0, 0, 0.85)",t.fillRect(0,0,i.width,i.height),t.save(),t.textAlign="center";const o=this.cyberConfig,s=o.speed||1,r=o.length||1;o.angle!==0&&(t.translate(i.width/2,i.height/2),t.rotate(o.angle*Math.PI/180),t.translate(-i.width/2,-i.height/2));const n=20,f=Date.now()*.1;t.textBaseline="middle";let m=-1;this.matrixCyberStreams.forEach((l,g)=>{l.y+=l.baseSpeed*s;let c=Math.max(3,Math.floor(n*r));(this.isLowPower||this.currentLodLevel==="low")&&(c=Math.floor(c*.4)),l.y-c*l.size>i.height*1.5&&(l.y=0);const h="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";l.size!==m&&(t.font=`${l.size}px monospace`,m=l.size);const p=this.isLowPower&&this.currentLodLevel==="low"?2:1;for(let z=0;z<c&&z<l.chars.length;z+=p){!l.isTextMode&&Math.random()<.02&&(l.chars[z]=h.charAt(Math.floor(Math.random()*h.length)));const A=l.chars[z],I=l.y-z*l.size;if(I<-l.size*2||I>i.height*1.5)continue;const S=1-z/c,T=Math.pow(S,.4)*(l.opacity*1.2);if(t.globalAlpha=Math.min(1,T),this.cyberRainbowMode){const b=(f+g*15+z*5)%360;t.fillStyle=`hsl(${b}, 100%, 60%)`}else t.fillStyle=l.color||this.cyberColor;t.fillText(A,l.x,I)}}),t.shadowBlur=0,t.globalAlpha=1,t.restore()}initSphere(){var s;const e=new ae(2,2),t=new E({color:6334975,wireframe:!0,transparent:!0,opacity:.5});this.sphere=new P(e,t);const i=new ae(1.8,1),a=new E({color:6334975,transparent:!0,opacity:.1,blending:G});this.core=new P(i,a),this.sphereGroup.add(this.sphere),this.sphereGroup.add(this.core),this.sphereGroup.visible=!1;const o=((s=this.customColors)==null?void 0:s.sphere)||this.customColor;o&&(this.sphere.material.color.copy(o),this.core.material.color.copy(o))}initLightspeed(){const t=new q,i=new Float32Array(2e3*3);for(let a=0;a<2e3*3;a++)i[a]=(Math.random()-.5)*80;t.setAttribute("position",new k(i,3)),this.lightspeedMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new F(3003583)},uTexture:{value:this.createCircleTexture()}},vertexShader:`
            ...
            `,transparent:!0,blending:G,depthWrite:!1}),this.lightspeed=new U(t,this.lightspeedMaterial),this.lightspeedGroup.add(this.lightspeed)}initParticles(){const e=this.batterySaver?400:1e3,t=new q,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const s=o*3;i[s]=(Math.random()-.5)*60,i[s+1]=(Math.random()-.5)*60,i[s+2]=(Math.random()-.5)*80;const r=Math.random();r<.3?(a[s]=.4,a[s+1]=.7,a[s+2]=1):r<.6?(a[s]=.3,a[s+1]=.9,a[s+2]=.95):r<.85?(a[s]=.6,a[s+1]=.4,a[s+2]=1):(a[s]=.9,a[s+1]=.9,a[s+2]=1)}t.setAttribute("position",new k(i,3)),t.setAttribute("color",new k(a,3)),this.particleMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uSize:{value:.4},uTexture:{value:this.createCircleTexture()}},vertexShader:`
                varying vec3 vColor;
                uniform float uTime, uSpeed;
            ...
            `,transparent:!0,blending:G,depthWrite:!1}),this.particles=new U(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var m;this.boxOuter=new L;const e=new oe(new re(3,3,3)),t=new K({color:16777215,transparent:!0,opacity:.9,blending:G}),i=new K({color:3900150,transparent:!0,opacity:.5,blending:G});this.boxOuter.add(new ee(e,t));for(let l=1;l<=3;l++){const g=new ee(e,i);g.scale.setScalar(1+l*.012),this.boxOuter.add(g)}const a=new oe(new re(2,2,2)),o=new K({color:14742270,transparent:!0,opacity:.8,blending:G}),s=new K({color:6333946,transparent:!0,opacity:.4,blending:G});this.boxInner=new L,this.boxInner.add(new ee(a,o));for(let l=1;l<=2;l++){const g=new ee(a,s);g.scale.setScalar(1+l*.015),this.boxInner.add(g)}const r=new oe(new re(3.05,3.05,3.05)),n=new K({color:9684477,transparent:!0,opacity:.8,blending:G});this.boxEdges=new ee(r,n),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const f=((m=this.customColors)==null?void 0:m.box)||this.customColor;f&&(this.boxOuter.children.forEach(l=>l.material.color.copy(f)),this.boxInner.children.forEach(l=>l.material.color.copy(f)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(f))}initDragon(){var g;this.dragonDummy=new _e,this.dragonLength=80;const e=new ae(.8,1),t=new E({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:G}),i=new ae(.5,1),a=new E({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:G});this.dragonBodyInstanced=new fe(e,t,this.dragonLength),this.dragonGlowInstanced=new fe(i,a,this.dragonLength);const o=new ne(1.5,3.5,5);o.rotateX(Math.PI/2);const s=new E({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:G});this.dragonHead=new P(o,s),this.dragonPearlGroup=new L;const r=new se(1,16,16),n=new E({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:G}),f=new se(1.3,16,16),m=new E({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:G});this.dragonPearl=new P(r,n),this.dragonPearlHalo=new P(f,m),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const l=((g=this.customColors)==null?void 0:g.dragon)||this.customColor;l&&this.updateDragonColor(l)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const i=(t.h+.5)%1,a=this.galaxyStars.geometry.getAttribute("color");if(a){const o=a.count,s=this._tempColor;for(let r=0;r<o;r++){const n=r/o,f=n<.2?.8:n<.5?.6:.4+Math.random()*.15,m=.6+Math.random()*.3;s.setHSL(i,m,f),a.setXYZ(r,s.r,s.g,s.b)}a.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const i=(t.h+.5)%1,a=new F().setHSL(i,t.s,t.l);this.dragonGlowInstanced.material.color.copy(a)}initGalaxy(){const e=this.batterySaver?500:1500,t=new q,i=[],a=[],o=[];for(let n=0;n<e;n++){const f=n/e*Math.PI*10,m=2.5+n/e*20+Math.random()*2,l=n%4*(Math.PI*2/4),g=Math.max(.5,n/e*4),c=Math.cos(f+l)*m+(Math.random()-.5)*g,h=(Math.random()-.5)*1.5,p=Math.sin(f+l)*m+(Math.random()-.5)*g;i.push(c,h,p);const z=n/e;z<.2?a.push(1,.95,.7):z<.5?a.push(.7+Math.random()*.3,.8,1):a.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),o.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new Y(i,3)),t.setAttribute("color",new Y(a,3)),t.setAttribute("size",new Y(o,1));const s=this.createStarTexture(),r=new le({size:.25,vertexColors:!0,map:s,transparent:!0,opacity:.9,blending:G,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new U(t,r),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new L;const t=new E({color:4892415,transparent:!0,opacity:.85,blending:G,depthWrite:!1,side:Z}),i=new L;if(e==="sun2"){const a=t.clone();a.side=Ee;const o=new pe(1.5,.25,16,64);i.add(new P(o,a));const s=8,r=new ne(.4,2.7,4);r.translate(0,2.7/2,0);const n=new ne(.2,1.7,4);n.translate(0,1.7/2,0);for(let f=0;f<s;f++){const m=f/s*Math.PI*2,l=new P(r,a);l.rotation.z=-m,l.position.set(Math.sin(m)*1.5,Math.cos(m)*1.5,0),i.add(l);const g=m+Math.PI/s,c=new P(n,a);c.rotation.z=-g,c.position.set(Math.sin(g)*1.5,Math.cos(g)*1.5,0),i.add(c)}}else if(e==="sun3"){const a={uTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=a;const o=`
                varying vec2 vUv;
            ...
            `,transparent:!0,depthWrite:!1,blending:G}),g=new U(f,l);this.snowflakeGroup.add(g),this._snowData={count:e,positions:t,phases:o,speeds:s,drifts:r,driftFreqs:n,points:g,material:l,spinMeshes:[],spinSpeeds:[]}}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)))}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)))}initLava(){var s;this.lavaBlobs=[];const e=16;this.lavaUniforms={uBlobs:{value:[]},uColor:{value:new F(((s=y.visualColors)==null?void 0:s.lava)||16737792)},uSecondaryColor:{value:new F(16755200)},uTime:{value:0},uIntensity:{value:0},uResolution:{value:new ye(window.innerWidth,window.innerHeight)}};for(let r=0;r<e;r++)this.lavaUniforms.uBlobs.value.push(new We(0,-100,0,0));const t=new O({uniforms:this.lavaUniforms,vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,transparent:!0,blending:G,depthWrite:!1,side:Z}),i=new $(100,100),a=new P(i,t);a.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(r=>{for(let n=0;n<r.count;n++){const f=r.minSize+Math.random()*(r.maxSize-r.minSize),m=["heating","rising","cooling","falling"],l=m[Math.floor(Math.random()*m.length)],g=-18+Math.random()*4,c=18+Math.random()*4;let h=0,p=.5;l==="heating"?(h=g,p=Math.random()*.5):l==="rising"?(h=g+Math.random()*(c-g),p=.8+Math.random()*.2):l==="cooling"?(h=c,p=1-Math.random()*.3):l==="falling"&&(h=c-Math.random()*(c-g),p=.2+Math.random()*.3),this.lavaBlobs.push({position:new He((Math.random()-.5)*12,h,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:f,state:l,temperature:p,floatMin:g,floatMax:c,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(f*.5),fallSpeed:(.05+Math.random()*.05)/(f*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(a),this.lavaGroup.visible=!1}initFireplace(){const i=new $(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new P(i,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new ke(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const a=650,o=new q,s=[];for(let r=0;r<a;r++)s.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);o.setAttribute("position",new Y(s,3)),this.emberMat=new le({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:G,depthWrite:!1}),this.embers=new U(o,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(a);for(let r=0;r<a;r++)this.emberVelocities[r]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new O({uniforms:{uTime:{value:0},uColor:{value:new F(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:Z,blending:G,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new q,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const s=o*3;i[s]=(Math.random()-.5)*60,i[s+1]=(Math.random()-.5)*40,i[s+2]=(Math.random()-.5)*40,a[s]=Math.random(),a[s+1]=Math.random(),a[s+2]=.08+Math.random()*.12}t.setAttribute("position",new k(i,3)),t.setAttribute("aRandom",new k(a,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new F(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:G}),this.raindrops=new U(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new q,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const r=s*3;i[r]=(Math.random()-.5)*40,i[r+1]=(Math.random()-.5)*20,i[r+2]=(Math.random()-.5)*40,a[r]=Math.random(),a[r+1]=Math.random(),a[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new k(i,3)),t.setAttribute("aRandom",new k(a,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new F(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new U(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const o=new $(40,40,32,32);this.zenWaterMaterial=new E({color:2245734,transparent:!0,opacity:.3,side:Z}),this.zenWater=new P(o,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new $(300,100,128,64);this.oceanWave=new P(e,new O({uniforms:{uTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new F(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:Z})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new q,a=[];for(let n=0;n<t;n++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new Y(a,3));const o=new le({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:G,depthWrite:!1});this.oceanFoam=new U(i,o),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const s=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;s&&(this.oceanWave&&this.oceanWave.material.color.copy(s),this.oceanFoam&&this.oceanFoam.material.color.copy(s))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const o=8,s=8,r=1024/o,n=1024/s;let f="🪷MINDWAVE";const m=e.logicMode,l=e.customText;m==="custom"||m==="txt"?f="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(m==="random"||m==="rnd"||m==="matrix"||m==="int"||m==="interstellar")&&(f="");const g=m==="matrix"||m==="int"||m==="interstellar"?[]:["LOGO",...f],c=g.length;for(let p=0;p<64;p++){const z=p%8,A=Math.floor(p/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(z*r,A*n,r,n),a.save(),a.translate(z*r+r/2,A*n+n/2);let I="",S=!1;if(p<c){const T=g[p];T==="LOGO"?S=!0:I=T}else{const b="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";I=b.charAt(Math.floor(Math.random()*b.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(I,0,0),a.restore(),I="")}if(I||S)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",S)if(this.logoImage){const D=document.createElement("canvas");D.width=100,D.height=100;const V=D.getContext("2d");V.imageSmoothingEnabled=!0,V.imageSmoothingQuality="high",V.drawImage(this.logoImage,0,0,100,100);const Q=V.getImageData(0,0,100,100),_=Q.data;for(let B=0;B<_.length;B+=4){const J=180+(_[B]+_[B+1]+_[B+2])/3/255*75;_[B]=J,_[B+1]=J,_[B+2]=J}V.putImageData(Q,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(D,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new Ne().load("./mindwave-logo-icon.png",b=>{if(this.logoImage=b,this.logoLoading=!1,this.cyberMaterial){const D=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=D}},void 0,b=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(I,0,0);a.restore()}const h=new te(i);return h.magFilter=we,h.minFilter=we,h}createCyberShader(e,t=this.matrixConfig){return new O({uniforms:{uTexture:{value:e},uColor:{value:new F(t.color||65345)},uHeadColor:{value:new F(15794160)},uTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
