...
`,ot=f=>f===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class st{constructor(e){this.group=e,this.meshes=[],this.activeClassId=22,this.activeVariationId=0,this.materials={},this.rainbowMode=!1;const t=new Ue(new Uint8Array([0,0,0,0]),1,1,ke);t.needsUpdate=!0,this.dummyTexture=t;const i=new J(2,2);for(let a=1;a<=25;a++){let o=ot(a);if(a<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        uniform float uAudioHigh;`),o=o.replace("float intMod = max(0.1, uIntensity);","float intMod = max(0.1, uIntensity * (1.0 + uAudioLow * 3.0 + uAudioMid * 1.5));")),!o.includes("uniform float uMouseSync;")){let h="";/uniform\s+vec2\s+uMouse\s*;/.test(o)||(h+=`uniform vec2 uMouse;
        `),h+=`uniform float uMouseSync;
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            `,transparent:!0,blending:A,depthWrite:!1}),this.lightspeed=new Y(t,this.lightspeedMaterial),this.lightspeedGroup.add(this.lightspeed)}initParticles(){const e=this.batterySaver?400:1e3,t=new B,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*60,i[o+2]=(Math.random()-.5)*80;const r=Math.random();r<.3?(a[o]=.4,a[o+1]=.7,a[o+2]=1):r<.6?(a[o]=.3,a[o+1]=.9,a[o+2]=.95):r<.85?(a[o]=.6,a[o+1]=.4,a[o+2]=1):(a[o]=.9,a[o+1]=.9,a[o+2]=1)}t.setAttribute("position",new k(i,3)),t.setAttribute("color",new k(a,3)),this.particleMaterial=new O({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uSize:{value:.4},uTexture:{value:this.createCircleTexture()},uIntensity:{value:1}},vertexShader:`
                varying vec3 vColor;
                uniform float uTime, uSpeed;
            ...
            `,transparent:!0,blending:A,depthWrite:!1}),this.particles=new Y(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var p;this.boxOuter=new G;const e=new me(new he(3,3,3)),t=new ie({color:16777215,transparent:!0,opacity:.9,blending:A}),i=new ie({color:3900150,transparent:!0,opacity:.5,blending:A});this.boxOuter.add(new oe(e,t));for(let l=1;l<=3;l++){const g=new oe(e,i);g.scale.setScalar(1+l*.012),this.boxOuter.add(g)}const a=new me(new he(2,2,2)),s=new ie({color:14742270,transparent:!0,opacity:.8,blending:A}),o=new ie({color:6333946,transparent:!0,opacity:.4,blending:A});this.boxInner=new G,this.boxInner.add(new oe(a,s));for(let l=1;l<=2;l++){const g=new oe(a,o);g.scale.setScalar(1+l*.015),this.boxInner.add(g)}const r=new me(new he(3.05,3.05,3.05)),n=new ie({color:9684477,transparent:!0,opacity:.8,blending:A});this.boxEdges=new oe(r,n),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const h=((p=this.customColors)==null?void 0:p.box)||this.customColor;h&&(this.boxOuter.children.forEach(l=>l.material.color.copy(h)),this.boxInner.children.forEach(l=>l.material.color.copy(h)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(h))}initDragon(){var g;this.dragonDummy=new Ne,this.dragonLength=80;const e=new le(.8,1),t=new U({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:A}),i=new le(.5,1),a=new U({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:A});this.dragonBodyInstanced=new Se(e,t,this.dragonLength),this.dragonGlowInstanced=new Se(i,a,this.dragonLength);const s=new de(1.5,3.5,5);s.rotateX(Math.PI/2);const o=new U({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:A});this.dragonHead=new L(s,o),this.dragonPearlGroup=new G;const r=new ce(1,16,16),n=new U({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:A}),h=new ce(1.3,16,16),p=new U({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:A});this.dragonPearl=new L(r,n),this.dragonPearlHalo=new L(h,p),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const l=((g=this.customColors)==null?void 0:g.dragon)||this.customColor;l&&this.updateDragonColor(l)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const i=(t.h+.5)%1,a=this.galaxyStars.geometry.getAttribute("color");if(a){const s=a.count,o=this._tempColor;for(let r=0;r<s;r++){const n=r/s,h=n<.2?.8:n<.5?.6:.4+Math.random()*.15,p=.6+Math.random()*.3;o.setHSL(i,p,h),a.setXYZ(r,o.r,o.g,o.b)}a.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const i=(t.h+.5)%1,a=new I().setHSL(i,t.s,t.l);this.dragonGlowInstanced.material.color.copy(a)}initGalaxy(){const e=this.batterySaver?500:1500,t=new B,i=[],a=[],s=[];for(let n=0;n<e;n++){const h=n/e*Math.PI*10,p=2.5+n/e*20+Math.random()*2,l=n%4*(Math.PI*2/4),g=Math.max(.5,n/e*4),c=Math.cos(h+l)*p+(Math.random()-.5)*g,u=(Math.random()-.5)*1.5,x=Math.sin(h+l)*p+(Math.random()-.5)*g;i.push(c,u,x);const _=n/e;_<.2?a.push(1,.95,.7):_<.5?a.push(.7+Math.random()*.3,.8,1):a.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),s.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new j(i,3)),t.setAttribute("color",new j(a,3)),t.setAttribute("size",new j(s,1));const o=this.createStarTexture(),r=new pe({size:.25,vertexColors:!0,map:o,transparent:!0,opacity:.9,blending:A,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new Y(t,r),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new G;const t=new U({color:4892415,transparent:!0,opacity:.85,blending:A,depthWrite:!1,side:Z}),i=new G;if(e==="sun2"){const a=t.clone();a.side=He;const s=new Te(1.5,.25,16,64);i.add(new L(s,a));const o=8,r=new de(.4,2.7,4);r.translate(0,2.7/2,0);const n=new de(.2,1.7,4);n.translate(0,1.7/2,0);for(let h=0;h<o;h++){const p=h/o*Math.PI*2,l=new L(r,a);l.rotation.z=-p,l.position.set(Math.sin(p)*1.5,Math.cos(p)*1.5,0),i.add(l);const g=p+Math.PI/o,c=new L(n,a);c.rotation.z=-g,c.position.set(Math.sin(g)*1.5,Math.cos(g)*1.5,0),i.add(c)}}else if(e==="sun3"){const a={uTime:{value:0},uLoopTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=a;const s=`
                varying vec2 vUv;
            ...
            `,r=new O({vertexShader:s,fragmentShader:o,uniforms:a,transparent:!0,blending:A,depthWrite:!1,side:Z}),n=new ce(2,64,64),h=new L(n,r);i.add(h);const p=new U({color:t.color,transparent:!0,opacity:.15,blending:A,depthWrite:!1,side:Xe}),l=new ce(3,32,32);i.add(new L(l,p))}else{const a=new Te(1.5,.12,8,64);i.add(new L(a,t));const s=8;for(let o=0;o<s;o++){const r=o/s*Math.PI*2,n=new Ae;n.moveTo(-.4,0),n.lineTo(.4,0),n.lineTo(0,2.7),n.lineTo(-.4,0);const h=new Ie(n),p=new L(h,t);p.rotation.z=-r,p.position.set(Math.sin(r)*1.5,Math.cos(r)*1.5,0),i.add(p);const l=r+Math.PI/s,g=new Ae;g.moveTo(-.2,0),g.lineTo(.2,0),g.lineTo(0,1.7),g.lineTo(-.2,0);const c=new Ie(g),u=new L(c,t);u.rotation.z=-l,u.position.set(Math.sin(l)*1.5,Math.cos(l)*1.5,0),i.add(u)}}this.galaxySunMesh.add(i),this.galaxySunMesh.position.set(0,0,.1),this.galaxyGroup.add(this.galaxySunMesh)}setGalaxySunStyle(e){e!=="sun"&&e!=="sun2"&&e!=="sun3"||(this.galaxySunStyle=e,this.galaxyGroup&&this.galaxyGroup.children.length>0&&this.createGalaxySun(e))}setGalaxySunRotation(e,t){e==="x"&&(this.sunRotationSpeedX=parseFloat(t)),e==="y"&&(this.sunRotationSpeedY=parseFloat(t)),e==="z"&&(this.sunRotationSpeedZ=parseFloat(t))}createStarTexture(){if(this.textures.star)return this.textures.star;const e=64,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e);const o=i.createRadialGradient(a,s,0,a,s,e/2);return o.addColorStop(0,"rgba(255, 255, 255, 1.0)"),o.addColorStop(.1,"rgba(255, 255, 240, 0.8)"),o.addColorStop(.25,"rgba(255, 255, 200, 0.3)"),o.addColorStop(.5,"rgba(200, 200, 255, 0.1)"),o.addColorStop(1,"rgba(100, 100, 255, 0)"),i.fillStyle=o,i.fillRect(0,0,e,e),i.fillStyle="rgba(255, 255, 255, 0.6)",i.beginPath(),i.moveTo(0,s-1),i.lineTo(a,s-.5),i.lineTo(e,s-1),i.lineTo(e,s+1),i.lineTo(a,s+.5),i.lineTo(0,s+1),i.closePath(),i.fill(),i.beginPath(),i.moveTo(a-1,0),i.lineTo(a-.5,s),i.lineTo(a-1,e),i.lineTo(a+1,e),i.lineTo(a+.5,s),i.lineTo(a+1,0),i.closePath(),i.fill(),i.beginPath(),i.arc(a,s,2,0,Math.PI*2),i.fillStyle="rgba(255, 255, 255, 1.0)",i.fill(),this.textures.star=new se(t),this.textures.star}initMandala(){var s;this.mandalaRings=[];const e=[2450411,15357964,3900150,16347926,12573694];for(let o=0;o<5;o++){const r=1.2+o*.8,n=6+o*6,h=new Ye(r-.05,r+.05,n),p=new U({color:e[o],side:Z,transparent:!0,opacity:.4-o*.05,blending:A}),l=new L(h,p);l.userData={speed:(.01+o*.005)*(o%2===0?1:-1),segments:n},this.mandalaRings.push(l),this.mandalaGroup.add(l)}const t=new je(.3,32),i=new U({color:16347926,transparent:!0,opacity:.6,blending:A});this.mandalaCenter=new L(t,i),this.mandalaGroup.add(this.mandalaCenter),this.mandalaGroup.visible=!1;const a=(s=this.customColors)==null?void 0:s.mandala;a&&(this.mandalaRings.forEach(o=>o.material.color.copy(a)),this.mandalaCenter.material.color.copy(a))}createSnowflakeTexture(){if(this.textures.snowflake)return this.textures.snowflake;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e),i.strokeStyle="rgba(220,240,255,1.0)",i.lineCap="round";for(let o=0;o<6;o++){const r=o/6*Math.PI*2;i.save(),i.translate(a,s),i.rotate(r),i.lineWidth=2.5,i.beginPath(),i.moveTo(0,0),i.lineTo(0,-52),i.stroke();const n=[{d:18,len:14,angle:Math.PI/4},{d:32,len:20,angle:Math.PI/4},{d:46,len:10,angle:Math.PI/5}];i.lineWidth=1.5,n.forEach(({d:h,len:p,angle:l})=>{[1,-1].forEach(g=>{i.beginPath(),i.moveTo(0,-h),i.lineTo(g*p*Math.cos(Math.PI/2-l),-h-p*Math.sin(Math.PI/2-l)),i.stroke()})}),i.restore()}i.beginPath();for(let o=0;o<6;o++){const r=o/6*Math.PI*2-Math.PI/6,n=a+Math.cos(r)*4,h=s+Math.sin(r)*4;o===0?i.moveTo(n,h):i.lineTo(n,h)}return i.closePath(),i.fillStyle="rgba(255, 255, 255, 0.8)",i.fill(),this.textures.snowflake=new se(t),this.textures.snowflake}setTsunamiAmplitude(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uAmplitude.value=parseFloat(e))}setTsunamiCurl(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uCurl.value=parseFloat(e))}setTsunamiMist(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uMist.value=parseFloat(e)),this.tsunamiSun&&this.tsunamiSun.material&&(this.tsunamiSun.material.opacity=Math.max(parseFloat(e),.2),this.tsunamiSun.material.uniforms&&(this.tsunamiSun.material.uniforms.uMist.value=parseFloat(e)))}setTsunamiStyle(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uStyle.value=parseFloat(e))}setTsunamiReactivity(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uReactivity.value=parseFloat(e))}setTsunamiLoop(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uLoopActive.value=e?1:0,e&&(this.tsunamiMaterial.uniforms.uTime.value=0))}initTsunami(){if(!this.tsunamiGroup)return;this.tsunamiGroup.clear();const e=new J(300,200,600,400),t={uTime:{value:0},uLoopTime:{value:0},uNormBass:{value:0},uColor:{value:new I(775123)},uSecondaryColor:{value:new I(27028)},uDeepColor:{value:new I(23477)},uFoamColor:{value:new I(16777215)},uAmplitude:{value:1},uCurl:{value:1},uMist:{value:1},uStyle:{value:1},uReactivity:{value:1},uLoopActive:{value:0}},i=`
            varying vec2 vUv;
        ...
        `,s=new O({vertexShader:i,fragmentShader:a,uniforms:t,transparent:!0,side:Z,wireframe:!1});this.tsunamiMaterial=s;const o=new L(e,s);o.rotation.x=-Math.PI/2,o.position.y=-40,o.position.z=-50,o.position.x=0,o.frustumCulled=!1,this.tsunamiGroup.add(o);const n="data:image/svg+xml;charset=utf-8,"+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
            <g>
            ...
            `,transparent:!0,depthWrite:!1,blending:A}),g=new Y(h,l);this.snowflakeGroup.add(g),this._snowData={count:e,positions:t,phases:s,speeds:o,drifts:r,driftFreqs:n,points:g,material:l,spinMeshes:[],spinSpeeds:[]}}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)))}setSnowCount(e){this.snowCount=parseInt(e)||200,this.snowflakeGroup&&this.snowflakeGroup.visible&&this.initSnowflake()}setSnowDrift(e){this.snowDriftMultiplier=parseFloat(e)||1}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)))}initLava(){var o;this.lavaBlobs=[];const e=16;this.lavaUniforms={uBlobs:{value:[]},uColor:{value:new I(((o=v.visualColors)==null?void 0:o.lava)||16737792)},uSecondaryColor:{value:new I(16755200)},uTime:{value:0},uLoopTime:{value:0},uIntensity:{value:0},uResolution:{value:new xe(window.innerWidth,window.innerHeight)}};for(let r=0;r<e;r++)this.lavaUniforms.uBlobs.value.push(new Qe(0,-100,0,0));const t=new O({uniforms:this.lavaUniforms,vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,transparent:!0,blending:A,depthWrite:!1,side:Z}),i=new J(100,100),a=new L(i,t);a.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(r=>{for(let n=0;n<r.count;n++){const h=r.minSize+Math.random()*(r.maxSize-r.minSize),p=["heating","rising","cooling","falling"],l=p[Math.floor(Math.random()*p.length)],g=-18+Math.random()*4,c=18+Math.random()*4;let u=0,x=.5;l==="heating"?(u=g,x=Math.random()*.5):l==="rising"?(u=g+Math.random()*(c-g),x=.8+Math.random()*.2):l==="cooling"?(u=c,x=1-Math.random()*.3):l==="falling"&&(u=c-Math.random()*(c-g),x=.2+Math.random()*.3),this.lavaBlobs.push({position:new $e((Math.random()-.5)*12,u,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:h,state:l,temperature:x,floatMin:g,floatMax:c,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(h*.5),fallSpeed:(.05+Math.random()*.05)/(h*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(a),this.lavaGroup.visible=!1}initFireplace(){const i=new J(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new L(i,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new Je(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const a=650,s=new B,o=[];for(let r=0;r<a;r++)o.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);s.setAttribute("position",new j(o,3)),this.emberMat=new pe({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:A,depthWrite:!1}),this.embers=new Y(s,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(a);for(let r=0;r<a;r++)this.emberVelocities[r]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new O({uniforms:{uTime:{value:0},uLoopTime:{value:0},uColor:{value:new I(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:Z,blending:A,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new B,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*40,i[o+2]=(Math.random()-.5)*40,a[o]=Math.random(),a[o+1]=Math.random(),a[o+2]=.08+Math.random()*.12}t.setAttribute("position",new k(i,3)),t.setAttribute("aRandom",new k(a,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uColor:{value:new I(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:A}),this.raindrops=new Y(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new B,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;i[r]=(Math.random()-.5)*40,i[r+1]=(Math.random()-.5)*20,i[r+2]=(Math.random()-.5)*40,a[r]=Math.random(),a[r+1]=Math.random(),a[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new k(i,3)),t.setAttribute("aRandom",new k(a,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uColor:{value:new I(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new Y(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new J(40,40,32,32);this.zenWaterMaterial=new U({color:2245734,transparent:!0,opacity:.3,side:Z}),this.zenWater=new L(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new J(300,100,128,64);this.oceanWave=new L(e,new O({uniforms:{uTime:{value:0},uLoopTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new I(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:Z})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new B,a=[];for(let n=0;n<t;n++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new j(a,3));const s=new pe({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:A,depthWrite:!1});this.oceanFoam=new Y(i,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const s=8,o=8,r=1024/s,n=1024/o;let h="🪷MINDWAVE";const p=e.logicMode,l=e.customText;p==="custom"||p==="txt"?h="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(p==="random"||p==="rnd"||p==="matrix"||p==="int"||p==="interstellar")&&(h="");const g=p==="matrix"||p==="int"||p==="interstellar"?[]:["LOGO",...h],c=g.length;for(let x=0;x<64;x++){const _=x%8,R=Math.floor(x/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(_*r,R*n,r,n),a.save(),a.translate(_*r+r/2,R*n+n/2);let z="",M=!1;if(x<c){const F=g[x];F==="LOGO"?M=!0:z=F}else{const T="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";z=T.charAt(Math.floor(Math.random()*T.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(z,0,0),a.restore(),z="")}if(z||M)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",M)if(this.logoImage){const w=document.createElement("canvas");w.width=100,w.height=100;const E=w.getContext("2d");E.imageSmoothingEnabled=!0,E.imageSmoothingQuality="high",E.drawImage(this.logoImage,0,0,100,100);const K=E.getImageData(0,0,100,100),D=K.data;for(let q=0;q<D.length;q+=4){const Q=180+(D[q]+D[q+1]+D[q+2])/3/255*75;D[q]=Q,D[q+1]=Q,D[q+2]=Q}E.putImageData(K,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(w,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new et().load("./mindwave-logo-icon.png",T=>{if(this.logoImage=T,this.logoLoading=!1,this.cyberMaterial){const w=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=w}},void 0,T=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(z,0,0);a.restore()}const u=new se(i);return u.magFilter=_e,u.minFilter=_e,u}createCyberShader(e,t=this.matrixConfig){return new O({uniforms:{uTexture:{value:e},uColor:{value:new I(t.color||65345)},uHeadColor:{value:new I(15794160)},uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
