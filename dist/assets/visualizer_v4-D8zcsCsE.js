...
`,ot=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            void main() {
                ...
                float noiseDisp = 0.0;
                if (envelope > 0.01) {
                    float chaos = snoise(pos.xy * 0.1 + vec2(time * 3.0, time * 4.0));
        ...
        `,a=`
            ...
            void main() {
                ...
                if (uMist > 0.05) {
                    ...
                    float ripple = snoise(vWorldPosition.xy * 0.1 - vec2(uTime * 4.0, uTime * 6.0));
                    normal.x += ripple * 0.2;
                    normal.y += ripple * 0.2;
