...
`,je=f=>f===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class Ye{constructor(e){this.group=e,this.meshes=[],this.activeClassId=1,this.activeVariationId=0,this.materials={};const t=new Pe(new Uint8Array([0,0,0,0]),1,1,Ge);t.needsUpdate=!0,this.dummyTexture=t;const a=new j(2,2);for(let i=1;i<=22;i++){let o=je(i);if(i<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        ...
        void main() {`,o=o.replace("void main() {",h)}i!==22&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            up -= uMouse * uMouseSync * 0.5;`)));const r=`
                ...
                ${o}
            `;this.materials[i]=new O({vertexShader:Xe,fragmentShader:r,defines:{VARIATION:0},uniforms:{uTime:{value:0},uAspect:{value:1},uColor1:{value:new P(6334975)},uColor2:{value:new P(11032055)},uIntensity:{value:1},uSpeed:{value:1},uHarmonics:{value:0},uVariation:{value:0},uAudioLow:{value:0},uAudioMid:{value:0},uAudioHigh:{value:0},uMouse:{value:new re(0,0)},uAlpha:{value:1},uSpawnTime:{value:0},uTexture:{value:this.dummyTexture},uMouseSync:{value:0}},transparent:!0,depthWrite:!1,blending:T});const n=new G(a,this.materials[i]);n.visible=!1,n.position.z=-1,this.meshes.push(n),this.group.add(n)}this._boundCymaticsToggleMouseSync=i=>{for(let s=1;s<=22;s++)this.materials[s]&&this.materials[s].uniforms.uMouseSync&&(this.materials[s].uniforms.uMouseSync.value=i.detail.sync)},window.addEventListener("cymaticsToggleMouseSync",this._boundCymaticsToggleMouseSync)}setPattern(e,t){if(this.activeClassId=e,this.activeVariationId=t,this.meshes.forEach((a,i)=>{a.visible=i+1===e}),this.materials[e]){this.materials[e].uniforms.uVariation.value=t;let a=t;if(e===22&&(a=t%14),(e===17||e===18||e===19||e===20||e===21||e===22)&&this.materials[e].defines.VARIATION!==a&&(this.materials[e].defines.VARIATION=a,this.materials[e].needsUpdate=!0,this.materials[e].uniforms.uSpawnTime&&(this.materials[e].uniforms.uSpawnTime.value=performance.now()*.001%(2e3*Math.PI))),se[e]&&se[e][t]){const i=se[e][t];this.materials[e].uniforms.uColor1.value.setHex(i[0]),this.materials[e].uniforms.uColor2.value.setHex(i[1]);try{window.dispatchEvent(new CustomEvent("cymaticColorSync",{detail:{classId:e,color1:"#"+i[0].toString(16).padStart(6,"0"),color2:"#"+i[1].toString(16).padStart(6,"0")}}))}catch{}}if(e===22){const i=["binaural-assets/images/cymatics/cymatics_fractal_heart_1779756441610.png","binaural-assets/images/cymatics/cymatics_fluid_sdf_1779756501734.png","binaural-assets/images/cymatics/cymatics_particle_swarm_1779756471939.png","binaural-assets/images/cymatics/cymatics_quantum_topology_1779756531135.png","binaural-assets/images/cymatics/ai_cymatic_15_1779566362935.png","binaural-assets/images/cymatics/ai_cymatic_16_1779566377245.png","binaural-assets/images/cymatics/cymatic_sacred_gold_obsidian.png","binaural-assets/images/cymatics/cymatic_biolum_abyssal.png","binaural-assets/images/cymatics/cymatic_nebula_plasma.png","binaural-assets/images/cymatics/cymatic_emerald_cyber_matrix.png","binaural-assets/images/cymatics/cymatic_liquid_mercury_crimson.png","binaural-assets/images/cymatics/cymatic_quantum_crystal_lattice.png","binaural-assets/images/cymatics/cymatic_solar_flare_harmonics.png","binaural-assets/images/cymatics/cymatic_amethyst_hyperdimensional.png","binaural-assets/images/cymatics/cymatic_astral_lotus.png","binaural-assets/images/cymatics/cymatic_celestial_mandala.png","binaural-assets/images/cymatics/cymatic_quantum_flower.png","binaural-assets/images/cymatics/cymatic_ethereal_nexus.png","binaural-assets/images/cymatics/cymatic_neon_labyrinth.png","binaural-assets/images/cymatics/cymatic_prismatic_core.png","binaural-assets/images/cymatics/cymatic_obsidian_bloom.png","binaural-assets/images/cymatics/cymatic_void_resonance.png","binaural-assets/images/cymatics/cymatic_golden_ratio_spiral.png","binaural-assets/images/cymatics/cymatic_sacred_sun_resonance.png","binaural-assets/images/cymatics/cymatic_lunar_tides.png","binaural-assets/images/cymatics/cymatic_cybernetic_lotus.png","binaural-assets/images/cymatics/cymatic_bioluminescent_shroom.png","binaural-assets/images/cymatics/cymatic_vortex_of_time.png","binaural-assets/images/cymatics/cymatic_diamond_lattice.png","binaural-assets/images/cymatics/cymatic_seraphim_wings.png"];i[t]&&(this.textureCache||(this.textureCache={}),this.textureCache[t]?this.materials[e].uniforms.uTexture.value=this.textureCache[t]:new qe().load(i[t],o=>{o.generateMipmaps=!1,o.minFilter=ne,this.textureCache[t]=o,this.activeClassId===e&&this.activeVariationId===t&&(this.materials[e].uniforms.uTexture.value=o)}))}this.materials[e]&&this.materials[e].uniforms.uMouseSync&&(this.materials[e].uniforms.uMouseSync.value=window.cymaticsMouseSync||0)}}setColor(e,t,a){if(this.materials[e]){const i=t===1?"uColor1":"uColor2";if(this.materials[e].uniforms[i]){const s=this.materials[e].uniforms[i].value;typeof a=="string"?s.setStyle(a):typeof a=="number"?s.setHex(a):a&&a.isColor?s.copy(a):s.set(a)}}}setParam(e,t,a){this.materials[e]&&(t==="intensity"?this.materials[e].uniforms.uIntensity.value=a:t==="speed"&&this.materials[e].uniforms.uSpeed?this.materials[e].uniforms.uSpeed.value=a:t==="harmonics"&&this.materials[e].uniforms.uHarmonics?this.materials[e].uniforms.uHarmonics.value=a:this.materials[e].uniforms[`u${t.charAt(0).toUpperCase()+t.slice(1)}`]&&(this.materials[e].uniforms[`u${t.charAt(0).toUpperCase()+t.slice(1)}`].value=a))}update(e,t,a){if(this.materials[this.activeClassId]&&(this.materials[this.activeClassId].uniforms.uTime.value=e,this.materials[this.activeClassId].uniforms.uAspect.value=window.innerWidth/(window.innerHeight||1),t&&(this.materials[this.activeClassId].uniforms.uAudioLow.value=t.bass||0,this.materials[this.activeClassId].uniforms.uAudioMid.value=t.mids||0,this.materials[this.activeClassId].uniforms.uAudioHigh.value=t.highs||0),a&&this.materials[this.activeClassId].uniforms.uMouse.value.set(a.x||0,a.y||0)),this.crossfadeData&&this.crossfadeData.active){let i=e-this.crossfadeData.startTime,s=Math.min(1,i/this.crossfadeData.duration);this.materials[this.crossfadeData.nextId]&&(this.materials[this.crossfadeData.nextId].uniforms.uAlpha.value=s),this.materials[this.crossfadeData.prevId]&&(this.materials[this.crossfadeData.prevId].uniforms.uAlpha.value=1-s),s>=1&&(this.crossfadeData.active=!1,this.activeClassId=this.crossfadeData.nextId)}}dispose(){if(this._boundCymaticsToggleMouseSync&&window.removeEventListener("cymaticsToggleMouseSync",this._boundCymaticsToggleMouseSync),this.dummyTexture&&(this.dummyTexture.dispose(),this.dummyTexture=null),this.meshes.forEach(e=>{e.geometry&&e.geometry.dispose(),e.material&&e.material.dispose(),this.group.remove(e)}),this.textureCache){for(const e in this.textureCache)this.textureCache[e]&&this.textureCache[e].dispose();this.textureCache={}}}}let p=null;class ge{constructor(e,t={}){this.canvas=e,this.activeModes=t.activeModes||new Set,this.mode=t.mode||"none",this.mindWaveMode=t.mindWaveMode!==void 0?t.mindWaveMode:!0,this.galaxySunStyle=t.galaxySunStyle||"sun",this.currentCymaticData={name:"Fundamental Zenith",n:1,m:1,energy:.2},this.cymaticsHistory=[],this.cymaticsHistoryIndex=-1,this._cymaticDriftOffset=Math.random()*1e3,this.cyberConfig={logicMode:t.cyberLogicMode||"matrix",customText:t.cyberCustomText||"WELCOME",angle:t.cyberAngle||0,speed:t.cyberSpeedMultiplier||1,length:1,color:"#00FF41",rainbow:!0},this.matrixConfig={logicMode:t.matrixLogicMode||"interstellar",customText:t.matrixCustomText||"MINDWAVE",angle:0,speed:1,length:1,color:"#00FF41",rainbow:!1},this.initialized=!1,this._rainbowEnabled=t.rainbowEnabled||!1,this.isVisualizer3D=!0,this.overlayCanvas=document.getElementById("cyberCanvas"),this.overlayCtx=this.overlayCanvas?this.overlayCanvas.getContext("2d",{alpha:!0}):null,this.overlayCanvas&&(this.resizeOverlayCanvas(),window.addEventListener("resize",()=>this.resizeOverlayCanvas())),this.matrixCyberStreams=[],this.currentCyberAngle=t.cyberAngle!==void 0?t.cyberAngle:0,this.cyberColorCustomized=!1;try{const i=localStorage.getItem("cyberThemeHistory");this.themeHistory=i?JSON.parse(i):[],this.lastCyberFamily=localStorage.getItem("cyberLastFamily")||""}catch{this.themeHistory=[],this.lastCyberFamily=""}this.currentLogoOpacity=.8,this.targetLogoOpacity=.8,p=this,this.themeType=document.body.dataset.themeType||"dark";const a=/Mobile|Android|iPhone|iPad/i.test(navigator.userAgent);this.batterySaver=t.batterySaver!==void 0?t.batterySaver:a,this.isLowPower=this.batterySaver||localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode"),this.lastFrameRenderTime=0,this.targetFPS=this.isLowPower?30:60,this.vibrationEnabled=typeof b<"u"&&b.visualVibration!==void 0?b.visualVibration:t.visualVibration!==void 0?t.visualVibration:!1,this._fpsRingBuffer=new Float64Array(60),this._fpsRingIndex=0,this._fpsRingCount=0,this.lastLodDegradation=0,this.currentLodLevel="high",this._tempColor=new P,this._logoRenderCanvas=null,this.sphereGroup=new z,this.particleGroup=new z,this.lightspeedGroup=new z,this.lavaGroup=new z,this.fireplaceGroup=new z,this.rainforestGroup=new z,this.zenGardenGroup=new z,this.oceanGroup=new z,this.wavesGroup=new z,this.cyberGroup=new z,this.boxGroup=new z,this.dragonGroup=new z,this.galaxyGroup=new z,this.mandalaGroup=new z,this.cymaticsGroup=new z,this.snowflakeGroup=new z,this._snowData=null;try{this.scene=new _e,this.cymaticsCore=new Ye(this.cymaticsGroup),[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup].forEach(o=>this.scene.add(o)),this.camera=new De(75,e.width/e.height,.1,1e3),this.renderer=new Fe({canvas:e,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),this.renderer.autoClear=!1,this.renderer.setClearColor(0,0),this.renderer.setSize(e.clientWidth,e.clientHeight);const s=this.isLowPower?1:2;this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,s)),this.textures={},this.customColors={},this.customColor=null,this._isRendering=!1,this._freqDataArray=null,this.initEnvironment(),this.camera.position.z=5,this.handleLayoutChange=this.handleLayoutChange.bind(this),window.addEventListener("resize",()=>{this.resize(),this.handleLayoutChange()}),window.addEventListener("mindwave:layout-change",this.handleLayoutChange),this._boundSafeMode=()=>{this.currentLodLevel!=="low"&&(this.degradeLOD(),this.degradeLOD())},window.addEventListener("mindwave:safe-mode-start",this._boundSafeMode),this._boundVisibilityChange=()=>{document.hidden||(this.lastTime=performance.now()*.001,this.active!==!1&&this.initialized&&this.render(b.analyserLeft,b.analyserRight))},document.addEventListener("visibilitychange",this._boundVisibilityChange),this._boundContextLost=o=>{o.preventDefault(),this.active=!1,b.animationId&&(cancelAnimationFrame(b.animationId),b.animationId=null)},e.addEventListener("webglcontextlost",this._boundContextLost),this._boundContextRestored=()=>{try{this.initialized=!1,this._freqDataArray=null,this.initEnvironment(),this.updateVisibility(),this.initialized=!0,this.active=!0,this.lastTime=performance.now()*.001,b.animationId&&cancelAnimationFrame(b.animationId),this._isRendering=!1,this.render(b.analyserLeft,b.analyserRight)}catch{}},e.addEventListener("webglcontextrestored",this._boundContextRestored),this.resize(),setTimeout(this.handleLayoutChange,100),this._boundThemeChange=o=>{if(o.detail&&o.detail.type){const r=o.detail.type;this.themeType!==r&&(this.themeType=r,this.updateLogoTexture())}},window.addEventListener("themeChanged",this._boundThemeChange),this.speedMultiplier=1,this.brightnessMultiplier=1,this.lastTime=performance.now()*.001,this.simTime=0,this.targetFPS=60,this.lastFrameRenderTime=0,this.active=!0,this.updateVisibility(),this.initialized=!0,this.initOverlayLogo(),window.viz3D=this}catch{this.initialized=!1}}resize(){if(!this.renderer||!this.canvas||!this.camera)return;const e=window.innerWidth,t=window.innerHeight;this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.handleLayoutChange()}handleLayoutChange(){!this.renderer||!this.camera||this.camera.clearViewOffset()}resizeOverlayCanvas(){this.overlayCanvas&&(this.overlayCanvas.width=window.innerWidth,this.overlayCanvas.height=window.innerHeight)}generateCyberStyle(){const e=this.overlayCanvas,t=this.overlayCtx;if(!e||!t)return;this.matrixCyberStreams=[];const a=Math.max(11,Math.min(21,Math.floor(e.width/50)));this.isLowPower=localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode");let i=Math.ceil(e.width/a);this.isLowPower||(i*=1.5);let s=window.getCurrentTheme?window.getCurrentTheme():{color:"#2dd4bf"};this.resizeOverlayCanvas(),this.cyberColorCustomized=!1;const o=[{name:"System Yellow",color:"#FFFF00",family:"yellow"},{name:"Neon Pink",color:"#FF1493",family:"pink"},{name:"Chrome Static",color:"#C0C0C0",family:"mono"},{name:"Royal Data",color:"#4169E1",family:"blue"},{name:"White Noise",color:"#FFFFFF",family:"mono"},{name:"Cyan Future",color:"#00FFFF",family:"blue"},{name:"Lime Access",color:"#32CD32",family:"green"},{name:"Purple Haze",color:"#800080",family:"purple"},{name:"Emerald Link",color:"#50C878",family:"green"},{name:"Ice Blue",color:"#A5F2F3",family:"blue"},{name:"sentAIent Blue",color:"#60A9FF",family:"blue"},{name:"Rainbow Surge",color:"rainbow",family:"rainbow"}],r=this.lastCyberFamily||"";let n=o.filter(c=>!this.themeHistory.includes(c.name));const h=n.filter(c=>c.family!==r);h.length>0&&(n=h);let u=n;if(u.length===0){const c=this.themeHistory[this.themeHistory.length-1];u=o.filter(g=>g.name!==c)}const l=u[Math.floor(Math.random()*u.length)];this.themeHistory.push(l.name),this.themeHistory.length>5&&this.themeHistory.shift(),this.lastCyberFamily=l.family;try{localStorage.setItem("cyberThemeHistory",JSON.stringify(this.themeHistory)),localStorage.setItem("cyberLastFamily",this.lastCyberFamily)}catch{}this.cyberSpeedMultiplier===void 0&&(this.cyberSpeedMultiplier=.2),this.cyberLengthMultiplier===void 0&&(this.cyberLengthMultiplier=.7);const v=document.getElementById("cyberRainbowToggle");if(v&&this.cyberRainbowMode===void 0&&(this.cyberRainbowMode=!0,this.cyberConfig.rainbow=!0,v.checked=!0),!this.cyberRainbowMode&&s.color!=="rainbow"){this.cyberColor=s.color;const c=document.getElementById("cyberColorPicker");c&&(c.value=this.cyberColor)}for(let c=0;c<i;c++){const g=Math.random(),d=Math.floor(8+g*11),x=(2+g*8+Math.random()*2)*this.cyberSpeedMultiplier;this.matrixCyberStreams.push({x:c*a,y:Math.random()*this.overlayCanvas.height*1.5-this.overlayCanvas.height*.5,baseSpeed:x,opacity:.2+g*.8,size:d,chars:[],color:s.color!=="rainbow"?s.color:"#FFFFFF"})}this.updateCyberStrings(),this.matrixCyberStreams.sort((c,g)=>c.size-g.size)}renderCyberCyber(){const e=this.activeModes.has("cyber");if(!this.overlayCtx||!this.matrixCyberStreams||!e)return;const t=this.overlayCtx,a=this.overlayCanvas;t.clearRect(0,0,a.width,a.height);const i=this.activeModes.size>1;t.fillStyle=i?"rgba(0, 0, 0, 0.4)":"rgba(0, 0, 0, 0.85)",t.fillRect(0,0,a.width,a.height),t.save(),t.textAlign="center";const s=this.cyberConfig,o=s.speed||1,r=s.length||1;s.angle!==0&&(t.translate(a.width/2,a.height/2),t.rotate(s.angle*Math.PI/180),t.translate(-a.width/2,-a.height/2));const n=20,h=Date.now()*.1;t.textBaseline="middle";let u=-1;this.matrixCyberStreams.forEach((l,v)=>{l.y+=l.baseSpeed*o;let c=Math.max(3,Math.floor(n*r));(this.isLowPower||this.currentLodLevel==="low")&&(c=Math.floor(c*.4)),l.y-c*l.size>a.height*1.5&&(l.y=0);const g="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";l.size!==u&&(t.font=`${l.size}px monospace`,u=l.size);const d=this.isLowPower&&this.currentLodLevel==="low"?2:1;for(let x=0;x<c&&x<l.chars.length;x+=d){!l.isTextMode&&Math.random()<.02&&(l.chars[x]=g.charAt(Math.floor(Math.random()*g.length)));const q=l.chars[x],_=l.y-x*l.size;if(_<-l.size*2||_>a.height*1.5)continue;const S=1-x/c,D=Math.pow(S,.4)*(l.opacity*1.2);if(t.globalAlpha=Math.min(1,D),this.cyberRainbowMode){const A=(h+v*15+x*5)%360;t.fillStyle=`hsl(${A}, 100%, 60%)`}else t.fillStyle=l.color||this.cyberColor;t.fillText(q,l.x,_)}}),t.shadowBlur=0,t.globalAlpha=1,t.restore()}initSphere(){var o;const e=new J(2,2),t=new L({color:6334975,wireframe:!0,transparent:!0,opacity:.5});this.sphere=new G(e,t);const a=new J(1.8,1),i=new L({color:6334975,transparent:!0,opacity:.1,blending:T});this.core=new G(a,i),this.sphereGroup.add(this.sphere),this.sphereGroup.add(this.core),this.sphereGroup.visible=!1;const s=((o=this.customColors)==null?void 0:o.sphere)||this.customColor;s&&(this.sphere.material.color.copy(s),this.core.material.color.copy(s))}initLightspeed(){const t=new k,a=new Float32Array(2e3*3);for(let i=0;i<2e3*3;i++)a[i]=(Math.random()-.5)*80;t.setAttribute("position",new B(a,3)),this.lightspeedMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new P(3003583)},uTexture:{value:this.createCircleTexture()}},vertexShader:`
            ...
            `,transparent:!0,blending:T,depthWrite:!1}),this.lightspeed=new N(t,this.lightspeedMaterial),this.lightspeedGroup.add(this.lightspeed)}initParticles(){const e=this.batterySaver?400:1e3,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;a[o]=(Math.random()-.5)*60,a[o+1]=(Math.random()-.5)*60,a[o+2]=(Math.random()-.5)*80;const r=Math.random();r<.3?(i[o]=.4,i[o+1]=.7,i[o+2]=1):r<.6?(i[o]=.3,i[o+1]=.9,i[o+2]=.95):r<.85?(i[o]=.6,i[o+1]=.4,i[o+2]=1):(i[o]=.9,i[o+1]=.9,i[o+2]=1)}t.setAttribute("position",new B(a,3)),t.setAttribute("color",new B(i,3)),this.particleMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uSize:{value:.4},uTexture:{value:this.createCircleTexture()}},vertexShader:`
                varying vec3 vColor;
                uniform float uTime, uSpeed;
            ...
            `,transparent:!0,blending:T,depthWrite:!1}),this.particles=new N(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var u;this.boxOuter=new z;const e=new te(new ae(3,3,3)),t=new Z({color:16777215,transparent:!0,opacity:.9,blending:T}),a=new Z({color:3900150,transparent:!0,opacity:.5,blending:T});this.boxOuter.add(new $(e,t));for(let l=1;l<=3;l++){const v=new $(e,a);v.scale.setScalar(1+l*.012),this.boxOuter.add(v)}const i=new te(new ae(2,2,2)),s=new Z({color:14742270,transparent:!0,opacity:.8,blending:T}),o=new Z({color:6333946,transparent:!0,opacity:.4,blending:T});this.boxInner=new z,this.boxInner.add(new $(i,s));for(let l=1;l<=2;l++){const v=new $(i,o);v.scale.setScalar(1+l*.015),this.boxInner.add(v)}const r=new te(new ae(3.05,3.05,3.05)),n=new Z({color:9684477,transparent:!0,opacity:.8,blending:T});this.boxEdges=new $(r,n),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const h=((u=this.customColors)==null?void 0:u.box)||this.customColor;h&&(this.boxOuter.children.forEach(l=>l.material.color.copy(h)),this.boxInner.children.forEach(l=>l.material.color.copy(h)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(h))}initDragon(){var v;this.dragonDummy=new Re,this.dragonLength=80;const e=new J(.8,1),t=new L({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:T}),a=new J(.5,1),i=new L({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:T});this.dragonBodyInstanced=new he(e,t,this.dragonLength),this.dragonGlowInstanced=new he(a,i,this.dragonLength);const s=new ie(1.5,3.5,5);s.rotateX(Math.PI/2);const o=new L({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:T});this.dragonHead=new G(s,o),this.dragonPearlGroup=new z;const r=new ee(1,16,16),n=new L({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:T}),h=new ee(1.3,16,16),u=new L({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:T});this.dragonPearl=new G(r,n),this.dragonPearlHalo=new G(h,u),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const l=((v=this.customColors)==null?void 0:v.dragon)||this.customColor;l&&this.updateDragonColor(l)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const a=(t.h+.5)%1,i=this.galaxyStars.geometry.getAttribute("color");if(i){const s=i.count,o=this._tempColor;for(let r=0;r<s;r++){const n=r/s,h=n<.2?.8:n<.5?.6:.4+Math.random()*.15,u=.6+Math.random()*.3;o.setHSL(a,u,h),i.setXYZ(r,o.r,o.g,o.b)}i.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const a=(t.h+.5)%1,i=new P().setHSL(a,t.s,t.l);this.dragonGlowInstanced.material.color.copy(i)}initGalaxy(){const e=this.batterySaver?500:1500,t=new k,a=[],i=[],s=[];for(let n=0;n<e;n++){const h=n/e*Math.PI*10,u=2.5+n/e*20+Math.random()*2,l=n%4*(Math.PI*2/4),v=Math.max(.5,n/e*4),c=Math.cos(h+l)*u+(Math.random()-.5)*v,g=(Math.random()-.5)*1.5,d=Math.sin(h+l)*u+(Math.random()-.5)*v;a.push(c,g,d);const x=n/e;x<.2?i.push(1,.95,.7):x<.5?i.push(.7+Math.random()*.3,.8,1):i.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),s.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new H(a,3)),t.setAttribute("color",new H(i,3)),t.setAttribute("size",new H(s,1));const o=this.createStarTexture(),r=new oe({size:.25,vertexColors:!0,map:o,transparent:!0,opacity:.9,blending:T,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new N(t,r),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new z;const t=new L({color:4892415,transparent:!0,opacity:.85,blending:T,depthWrite:!1,side:X}),a=new z;if(e==="sun2"){const i=t.clone();i.side=Le;const s=new me(1.5,.25,16,64);a.add(new G(s,i));const o=8,r=new ie(.4,2.7,4);r.translate(0,2.7/2,0);const n=new ie(.2,1.7,4);n.translate(0,1.7/2,0);for(let h=0;h<o;h++){const u=h/o*Math.PI*2,l=new G(r,i);l.rotation.z=-u,l.position.set(Math.sin(u)*1.5,Math.cos(u)*1.5,0),a.add(l);const v=u+Math.PI/o,c=new G(n,i);c.rotation.z=-v,c.position.set(Math.sin(v)*1.5,Math.cos(v)*1.5,0),a.add(c)}}else if(e==="sun3"){const i={uTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=i;const s=`
                varying vec2 vUv;
            ...
            `,r=new O({vertexShader:s,fragmentShader:o,uniforms:i,transparent:!0,blending:T,depthWrite:!1,side:X}),n=new ee(2,64,64),h=new G(n,r);a.add(h);const u=new L({color:t.color,transparent:!0,opacity:.15,blending:T,depthWrite:!1,side:Ve}),l=new ee(3,32,32);a.add(new G(l,u))}else{const i=new me(1.5,.12,8,64);a.add(new G(i,t));const s=8;for(let o=0;o<s;o++){const r=o/s*Math.PI*2,n=new de;n.moveTo(-.4,0),n.lineTo(.4,0),n.lineTo(0,2.7),n.lineTo(-.4,0);const h=new pe(n),u=new G(h,t);u.rotation.z=-r,u.position.set(Math.sin(r)*1.5,Math.cos(r)*1.5,0),a.add(u);const l=r+Math.PI/s,v=new de;v.moveTo(-.2,0),v.lineTo(.2,0),v.lineTo(0,1.7),v.lineTo(-.2,0);const c=new pe(v),g=new G(c,t);g.rotation.z=-l,g.position.set(Math.sin(l)*1.5,Math.cos(l)*1.5,0),a.add(g)}}this.galaxySunMesh.add(a),this.galaxySunMesh.position.set(0,0,.1),this.galaxyGroup.add(this.galaxySunMesh)}setGalaxySunStyle(e){e!=="sun"&&e!=="sun2"&&e!=="sun3"||(this.galaxySunStyle=e,this.galaxyGroup&&this.galaxyGroup.children.length>0&&this.createGalaxySun(e))}setGalaxySunRotation(e,t){e==="x"&&(this.sunRotationSpeedX=parseFloat(t)),e==="y"&&(this.sunRotationSpeedY=parseFloat(t)),e==="z"&&(this.sunRotationSpeedZ=parseFloat(t))}createStarTexture(){if(this.textures.star)return this.textures.star;const e=64,t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d"),i=e/2,s=e/2;a.clearRect(0,0,e,e);const o=a.createRadialGradient(i,s,0,i,s,e/2);return o.addColorStop(0,"rgba(255, 255, 255, 1.0)"),o.addColorStop(.1,"rgba(255, 255, 240, 0.8)"),o.addColorStop(.25,"rgba(255, 255, 200, 0.3)"),o.addColorStop(.5,"rgba(200, 200, 255, 0.1)"),o.addColorStop(1,"rgba(100, 100, 255, 0)"),a.fillStyle=o,a.fillRect(0,0,e,e),a.fillStyle="rgba(255, 255, 255, 0.6)",a.beginPath(),a.moveTo(0,s-1),a.lineTo(i,s-.5),a.lineTo(e,s-1),a.lineTo(e,s+1),a.lineTo(i,s+.5),a.lineTo(0,s+1),a.closePath(),a.fill(),a.beginPath(),a.moveTo(i-1,0),a.lineTo(i-.5,s),a.lineTo(i-1,e),a.lineTo(i+1,e),a.lineTo(i+.5,s),a.lineTo(i+1,0),a.closePath(),a.fill(),a.beginPath(),a.arc(i,s,2,0,Math.PI*2),a.fillStyle="rgba(255, 255, 255, 1.0)",a.fill(),this.textures.star=new Q(t),this.textures.star}initMandala(){var s;this.mandalaRings=[];const e=[2450411,15357964,3900150,16347926,12573694];for(let o=0;o<5;o++){const r=1.2+o*.8,n=6+o*6,h=new Oe(r-.05,r+.05,n),u=new L({color:e[o],side:X,transparent:!0,opacity:.4-o*.05,blending:T}),l=new G(h,u);l.userData={speed:(.01+o*.005)*(o%2===0?1:-1),segments:n},this.mandalaRings.push(l),this.mandalaGroup.add(l)}const t=new Ee(.3,32),a=new L({color:16347926,transparent:!0,opacity:.6,blending:T});this.mandalaCenter=new G(t,a),this.mandalaGroup.add(this.mandalaCenter),this.mandalaGroup.visible=!1;const i=(s=this.customColors)==null?void 0:s.mandala;i&&(this.mandalaRings.forEach(o=>o.material.color.copy(i)),this.mandalaCenter.material.color.copy(i))}createSnowflakeTexture(){if(this.textures.snowflake)return this.textures.snowflake;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d"),i=e/2,s=e/2;a.clearRect(0,0,e,e);const o=a.createRadialGradient(i,s,0,i,s,e*.5);o.addColorStop(0,"rgba(200,230,255,0.5)"),o.addColorStop(.4,"rgba(180,220,255,0.15)"),o.addColorStop(1,"rgba(150,200,255,0)"),a.fillStyle=o,a.fillRect(0,0,e,e),a.strokeStyle="rgba(220,240,255,1.0)",a.lineCap="round";for(let r=0;r<6;r++){const n=r/6*Math.PI*2;a.save(),a.translate(i,s),a.rotate(n),a.lineWidth=2.5,a.beginPath(),a.moveTo(0,0),a.lineTo(0,-52),a.stroke();const h=[{d:18,len:14,angle:Math.PI/4},{d:32,len:20,angle:Math.PI/4},{d:46,len:10,angle:Math.PI/5}];a.lineWidth=1.5,h.forEach(({d:u,len:l,angle:v})=>{[1,-1].forEach(c=>{a.beginPath(),a.moveTo(0,-u),a.lineTo(c*l*Math.cos(Math.PI/2-v),-u-l*Math.sin(Math.PI/2-v)),a.stroke()})}),a.restore()}a.beginPath();for(let r=0;r<6;r++){const n=r/6*Math.PI*2-Math.PI/6,h=i+Math.cos(n)*4,u=s+Math.sin(n)*4;r===0?a.moveTo(h,u):a.lineTo(h,u)}return a.closePath(),a.fillStyle="rgba(255, 255, 255, 0.8)",a.fill(),this.textures.snowflake=new Q(t),this.textures.snowflake}initSnowflake(){for(;this.snowflakeGroup.children.length>0;){const c=this.snowflakeGroup.children[0];this.snowflakeGroup.remove(c),c.geometry&&c.geometry.dispose(),c.material&&c.material.dispose()}this._snowData=null;const e=700,t=new Float32Array(e*3),a=new Float32Array(e),i=new Float32Array(e),s=new Float32Array(e),o=new Float32Array(e),r=new Float32Array(e),n=new Float32Array(e);for(let c=0;c<e;c++){const g=c*3;t[g]=(Math.random()-.5)*80,t[g+1]=(Math.random()-.5)*60,t[g+2]=-40+Math.random()*35;const d=(t[g+2]+40)/35;a[c]=1.5+d*8,i[c]=.2+d*.6,s[c]=Math.random()*Math.PI*2,o[c]=.015+Math.random()*.04+d*.03,r[c]=.01+Math.random()*.02,n[c]=.4+Math.random()*.8}const h=new k;h.setAttribute("position",new B(t,3)),h.setAttribute("aSize",new B(a,1)),h.setAttribute("aOpacity",new B(i,1));const u=this.createSnowflakeTexture(),l=new O({uniforms:{uTexture:{value:u},uColor:{value:this.customColor?this.customColor.clone():new P(10875883)},uIntensity:{value:0},uSizeMultiplier:{value:1},uGlowAmount:{value:.5}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),v=new N(h,l);this.snowflakeGroup.add(v),this._snowData={count:e,positions:t,phases:s,speeds:o,drifts:r,driftFreqs:n,points:v,material:l,spinMeshes:[],spinSpeeds:[]}}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)))}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)))}initLava(){var o;this.lavaBlobs=[];const e=16;this.lavaUniforms={uBlobs:{value:[]},uColor:{value:new P(((o=b.visualColors)==null?void 0:o.lava)||16737792)},uSecondaryColor:{value:new P(16755200)},uTime:{value:0},uIntensity:{value:0},uResolution:{value:new re(window.innerWidth,window.innerHeight)}};for(let r=0;r<e;r++)this.lavaUniforms.uBlobs.value.push(new Ue(0,-100,0,0));const t=new O({uniforms:this.lavaUniforms,vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
            ...
            `,transparent:!0,blending:T,depthWrite:!1,side:X}),a=new j(100,100),i=new G(a,t);i.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(r=>{for(let n=0;n<r.count;n++){const h=r.minSize+Math.random()*(r.maxSize-r.minSize),u=["heating","rising","cooling","falling"],l=u[Math.floor(Math.random()*u.length)],v=-18+Math.random()*4,c=18+Math.random()*4;let g=0,d=.5;l==="heating"?(g=v,d=Math.random()*.5):l==="rising"?(g=v+Math.random()*(c-v),d=.8+Math.random()*.2):l==="cooling"?(g=c,d=1-Math.random()*.3):l==="falling"&&(g=c-Math.random()*(c-v),d=.2+Math.random()*.3),this.lavaBlobs.push({position:new Be((Math.random()-.5)*12,g,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:h,state:l,temperature:d,floatMin:v,floatMax:c,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(h*.5),fallSpeed:(.05+Math.random()*.05)/(h*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(i),this.lavaGroup.visible=!1}initFireplace(){const a=new j(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new G(a,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new ke(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const i=650,s=new k,o=[];for(let r=0;r<i;r++)o.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);s.setAttribute("position",new H(o,3)),this.emberMat=new oe({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:T,depthWrite:!1}),this.embers=new N(s,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(i);for(let r=0;r<i;r++)this.emberVelocities[r]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new O({uniforms:{uTime:{value:0},uColor:{value:new P(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:X,blending:T,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;a[o]=(Math.random()-.5)*60,a[o+1]=(Math.random()-.5)*40,a[o+2]=(Math.random()-.5)*40,i[o]=Math.random(),i[o+1]=Math.random(),i[o+2]=.08+Math.random()*.12}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new P(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),this.raindrops=new N(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;a[r]=(Math.random()-.5)*40,a[r+1]=(Math.random()-.5)*20,a[r+2]=(Math.random()-.5)*40,i[r]=Math.random(),i[r+1]=Math.random(),i[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new P(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new N(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new j(40,40,32,32);this.zenWaterMaterial=new L({color:2245734,transparent:!0,opacity:.3,side:X}),this.zenWater=new G(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new j(300,100,128,64);this.oceanWave=new G(e,new O({uniforms:{uTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new P(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:X})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,a=new k,i=[];for(let n=0;n<t;n++)i.push((Math.random()-.5)*50),i.push(-2.5+Math.random()*.5),i.push((Math.random()-.5)*40);a.setAttribute("position",new H(i,3));const s=new oe({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:T,depthWrite:!1});this.oceanFoam=new N(a,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const a=document.createElement("canvas");a.width=1024,a.height=1024;const i=a.getContext("2d");i.fillStyle="rgba(0,0,0,0)",i.fillRect(0,0,1024,1024),i.shadowBlur=12,i.shadowColor="rgba(255, 255, 255, 0.4)",i.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',i.fillStyle="#ffffff",i.textAlign="center",i.textBaseline="middle";const s=8,o=8,r=1024/s,n=1024/o;let h="🪷MINDWAVE";const u=e.logicMode,l=e.customText;u==="custom"||u==="txt"?h="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(u==="random"||u==="rnd"||u==="matrix"||u==="int"||u==="interstellar")&&(h="");const v=u==="matrix"||u==="int"||u==="interstellar"?[]:["LOGO",...h],c=v.length;for(let d=0;d<64;d++){const x=d%8,q=Math.floor(d/8);i.fillStyle="rgba(0,0,0,0)",i.fillRect(x*r,q*n,r,n),i.save(),i.translate(x*r+r/2,q*n+n/2);let _="",S=!1;if(d<c){const D=v[d];D==="LOGO"?S=!0:_=D}else{const A="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";_=A.charAt(Math.floor(Math.random()*A.length)),Math.random()>.5&&(i.save(),i.scale(-1,1),i.fillStyle="#ffffff",i.font="bold 80px monospace",i.fillText(_,0,0),i.restore(),_="")}if(_||S)if(i.fillStyle="#ffffff",i.font="bold 80px monospace",i.textAlign="center",i.textBaseline="middle",i.shadowBlur=16,i.shadowColor="rgba(255, 255, 255, 0.6)",S)if(this.logoImage){const C=document.createElement("canvas");C.width=100,C.height=100;const F=C.getContext("2d");F.imageSmoothingEnabled=!0,F.imageSmoothingQuality="high",F.drawImage(this.logoImage,0,0,100,100);const Y=F.getImageData(0,0,100,100),R=Y.data;for(let V=0;V<R.length;V+=4){const E=180+(R[V]+R[V+1]+R[V+2])/3/255*75;R[V]=E,R[V+1]=E,R[V+2]=E}F.putImageData(Y,0,0),i.imageSmoothingEnabled=!0,i.imageSmoothingQuality="high",i.drawImage(C,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new Ne().load("./mindwave-logo-icon.png",A=>{if(this.logoImage=A,this.logoLoading=!1,this.cyberMaterial){const C=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=C}},void 0,A=>{this.logoFailed=!0,this.logoLoading=!1})),i.font="bold 80px monospace",i.fillStyle="#2dd4bf",i.fillText("🪷",0,0);else i.fillText(_,0,0);i.restore()}const g=new Q(a);return g.magFilter=ve,g.minFilter=ve,g}createCyberShader(e,t=this.matrixConfig){return new O({uniforms:{uTexture:{value:e},uColor:{value:new P(t.color||65345)},uHeadColor:{value:new P(15794160)},uTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
            ...
            `,transparent:!0,wireframe:!1,side:X,extensions:{derivatives:!0}}),this.wavesMesh=new G(e,this.wavesMaterial),this.wavesMesh.rotation.x=-Math.PI/2.2,this.wavesMesh.position.y=-5,this.wavesMesh.position.z=-10,this.wavesGroup.add(this.wavesMesh)}setSpeed(e){this.speedMultiplier=e}setIntent(e){this.currentIntent=e,e==="delta"||e==="theta"?this.particles&&this.particles.material&&(this.particles.material.size=.3,this.particles.material.opacity=.5):e==="gamma"||e==="hyper-gamma"?(this.particles&&this.particles.material&&(this.particles.material.size=.08,this.particles.material.opacity=.9),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uHeadColor.value.setHex(16777215),this.cyberMaterial.uniforms.uTailLength.value=.4)):(this.particles&&this.particles.material&&(this.particles.material.size=.15,this.particles.material.opacity=.8),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uHeadColor.value.setHex(15794160),this.cyberMaterial.uniforms.uTailLength.value=1)),this.renderSingleFrame()}setColor(e,t=null){var a,i,s,o;this.customColors||(this.customColors={}),!t||t==="all"?(this.customColors={},this.customColor=new P(e)):this.customColors[t]=new P(e);try{const r=n=>{n&&(n.color&&typeof n.color.set=="function"?n.color.set(e):n.uniforms&&n.uniforms.uColor&&n.uniforms.uColor.value.set(e))};this.particles&&this.particles.material&&r(this.particles.material),this.lightspeed&&this.lightspeed.material&&r(this.lightspeed.material),this.sphere&&this.sphere.material&&(r(this.sphere.material),this.core&&this.core.material&&r(this.core.material)),(t==="box"||!t||t==="all")&&(this.boxOuter&&this.boxOuter.children.forEach(n=>r(n.material)),this.boxInner&&this.boxInner.children.forEach(n=>r(n.material)),this.boxEdges&&this.boxEdges.material&&r(this.boxEdges.material)),t==="mandala"&&(this.mandalaRings&&this.mandalaRings.forEach(n=>r(n.material)),this.mandalaCenter&&this.mandalaCenter.material&&r(this.mandalaCenter.material)),this.wavesMesh&&this.wavesMesh.material&&r(this.wavesMesh.material),this.lavaBlobs&&this.lavaBlobs.forEach(n=>r(n.material)),this.lavaGlow&&this.lavaGlow.material&&r(this.lavaGlow.material),this.flames&&this.flames.material&&r(this.flames.material),this.raindrops&&this.raindrops.material&&r(this.raindrops.material),this.petals&&this.petals.material&&r(this.petals.material),this.zenWater&&this.zenWater.material&&r(this.zenWater.material),this.oceanWave&&this.oceanWave.material&&r(this.oceanWave.material),this.oceanFoam&&this.oceanFoam.material&&r(this.oceanFoam.material),this.cyberRain&&this.cyberRain.material&&this.cyberRain.material.uniforms&&this.cyberRain.material.uniforms.uColor&&this.cyberRain.material.uniforms.uColor.value.set(e),this.logoMesh&&this.originalLogoImg&&this.updateLogoTexture(),this.dragonGroup&&this.updateDragonColor&&this.updateDragonColor(new P(e)),(this.galaxyStars||this.galaxySunMesh)&&this.updateGalaxyColor(new P(e)),this.cymaticMaterial&&((a=this.cymaticMaterial.uniforms)!=null&&a.uColor)&&this.cymaticMaterial.uniforms.uColor.value.set(e),(t==="snowflake"||!t||t==="all")&&this.setSnowColor(e),(o=(s=(i=this._snowData)==null?void 0:i.material)==null?void 0:s.uniforms)!=null&&o.uColor&&this._snowData.material.uniforms.uColor.value.set(e)}catch{}this.renderSingleFrame()}renderSingleFrame(){!this.renderer||!this.scene||!this.camera||(this.renderer.clear(),this.renderer.render(this.scene,this.camera))}createCircleTexture(){if(this.textures.circle)return this.textures.circle;const e=32,t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d");return a.beginPath(),a.arc(e/2,e/2,e/2,0,Math.PI*2),a.fillStyle="#ffffff",a.fill(),this.textures.circle=new Q(t),this.textures.circle}render(e,t){var a,i,s,o,r,n,h,u,l;if(!this.initialized||!this.renderer||document.hidden||!this.active){this._isRendering=!1;return}if(!(this._isRendering&&typeof e=="number")){this._isRendering=!0;try{(typeof e=="number"||!e&&b.analyserLeft)&&(e=b.analyserLeft,t=b.analyserRight);let v=0,c=0,g=0;if(e){const m=e.frequencyBinCount;(!this._freqDataArray||this._freqDataArray.length!==m)&&(this._freqDataArray=new Uint8Array(m)),e.getByteFrequencyData(this._freqDataArray);let w=0;for(let M=0;M<15;M++)w+=this._freqDataArray[M];v=Math.pow(w/15/255,.8);let I=0;for(let M=10;M<100;M++)I+=this._freqDataArray[M];c=I/90/255;let y=0;for(let M=100;M<300;M++)y+=this._freqDataArray[M];g=y/200/255}const d=Math.max(.001,this.speedMultiplier||1),x=performance.now()*.001;if(this.activeModes.has("cymatics")&&this.cymaticsCore){const m=window.cymaticsAudioSync!==!1?{bass:v||0,mids:c||0,highs:g||0}:{bass:0,mids:0,highs:0};this.cymaticsCore.update(x*d,m)}this.lastTime||(this.lastTime=x);const q=Math.min(.1,x-this.lastTime);this.lastTime=x;const _=b.visualSpeedAuto?b.beatFrequency||10:d*10,S=Math.sin(x*Math.PI*2*_)*.5+.5,D=this.vibrationEnabled?1:0,A=(S||0)*D,C=(v||0)*D,F=D*(.02+C*.15+A*.08),Y=Math.sin(x*47.3)*Math.cos(x*31.7)*F,R=Math.cos(x*53.1)*Math.sin(x*29.3)*F,V=Math.sin(x*37.9)*Math.cos(x*43.1)*F,ce=[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup];for(const m of ce)m&&m.position.set(Y,R,V);if(this.activeModes.has("galaxy")&&this.galaxyGroup){const m=this.sunRotationSpeedY||.002,w=this.sunRotationSpeedZ||5e-4;if(this.galaxyStars&&(this.galaxyStars.rotation.y+=m*d*.5,this.galaxyStars.rotation.z+=w*d*.5),this.galaxySunMesh){this.galaxySunMesh.rotation.z-=w*d*1.5,this.galaxySunMesh.rotation.y+=m*d*2;const I=1+C*.15*(this.galaxySunStyle==="sun3"?2.5:1);this.galaxySunMesh.scale.setScalar(I)}this.galaxySunUniforms&&(this.galaxySunUniforms.uTime.value=x*d,this.galaxySunUniforms.uBassIntt.value=C,this._cymaticV2&&this._cymaticV2.shiver>.5&&(this.galaxySunUniforms.uTime.value+=this._cymaticV2.shiver*.05))}if(this.activeModes.has("sphere")&&this.sphere&&(this.sphere.scale.setScalar(1+C*.15),this.sphere.rotation.y+=.005*d),this.activeModes.has("particles")&&this.particleMaterial){const m=((i=(a=window.MindWaveState)==null?void 0:a.envIntensities)==null?void 0:i.flow)??1,w=(.015*d+C*.08+A*.05)*m;this.particleMaterial.uniforms.uTime.value=x,this.particleMaterial.uniforms.uSpeed.value=w*10,this.particleGroup.rotation.z+=(.001*d+C*.005)*m}if(this.activeModes.has("lightspeed")&&this.lightspeedMaterial&&(this.lightspeedMaterial.uniforms.uTime.value=x,this.lightspeedMaterial.uniforms.uSpeed.value=d),this.activeModes.has("matrix")&&this.cyberMaterial&&(this.cyberMaterial.uniforms.uTime.value=x*d),this.activeModes.has("waves")&&this.wavesMaterial){const m=((o=(s=window.MindWaveState)==null?void 0:s.envIntensities)==null?void 0:o.ocean)??1;this.wavesMaterial.uniforms.uTime.value=x*d*.5,this.wavesMaterial.uniforms.uNormBass.value=C*m,this.wavesMaterial.uniforms.uIntensity&&(this.wavesMaterial.uniforms.uIntensity.value=m)}if(this.activeModes.has("ocean")&&this.oceanWave&&this.oceanWave.material.uniforms){const m=((n=(r=window.MindWaveState)==null?void 0:r.envIntensities)==null?void 0:n.ocean)??1;this.oceanWave.material.uniforms.uTime.value=x*d,this.oceanWave.material.uniforms.uNormBass.value=C*m,this.oceanWave.material.uniforms.uBeatPulse.value=A*m,this.oceanFoam&&(this.oceanFoam.material.opacity=(.4+C*.3+A*.2)*(this.brightnessMultiplier||1)*m)}if(this.activeModes.has("box")&&this.boxOuter&&(this.boxOuter.rotation.x+=.008*d+C*.02,this.boxOuter.rotation.y+=.012*d,this.boxInner&&(this.boxInner.rotation.x-=.015*d,this.boxInner.rotation.y-=.01*d,this.boxInner.scale.setScalar(.95+C*.2)),this.boxOuter.scale.setScalar(1+C*.2),this.boxEdges&&this.boxEdges.rotation.copy(this.boxOuter.rotation)),this.activeModes.has("dragon")&&this.dragonBodyInstanced&&this.dragonDummy){this.dragonGroup.rotation.y+=.005*d;const m=x*d*2,w=1+C*.2;for(let I=0;I<this.dragonLength;I++){const y=m-I*.12,M=Math.sin(y)*8,W=Math.cos(y*1.5)*4+Math.sin(y*.5)*3,we=Math.cos(y*.8)*8;this.dragonDummy.position.set(M,W,we);const K=y+.1,Ce=Math.sin(K)*8,Me=Math.cos(K*1.5)*4+Math.sin(K*.5)*3,Se=Math.cos(K*.8)*8;this.dragonDummy.lookAt(Ce,Me,Se);const Ie=1-I/this.dragonLength*.8,Te=1+Math.sin(y*4)*.15*(.5+C);this.dragonDummy.scale.setScalar(Ie*Te*w),this.dragonDummy.updateMatrix(),this.dragonBodyInstanced.setMatrixAt(I,this.dragonDummy.matrix),this.dragonGlowInstanced&&this.dragonGlowInstanced.setMatrixAt(I,this.dragonDummy.matrix),I===0&&this.dragonHead&&(this.dragonHead.position.copy(this.dragonDummy.position),this.dragonHead.quaternion.copy(this.dragonDummy.quaternion),this.dragonHead.scale.copy(this.dragonDummy.scale).multiplyScalar(1.4))}if(this.dragonBodyInstanced.instanceMatrix.needsUpdate=!0,this.dragonGlowInstanced&&(this.dragonGlowInstanced.instanceMatrix.needsUpdate=!0),this.dragonPearlGroup){const I=m+.5;this.dragonPearlGroup.position.set(Math.sin(I)*9,Math.cos(I*1.5)*5+Math.sin(I*.5)*4,Math.cos(I*.8)*9),this.dragonPearlGroup.rotation.x+=.08*d,this.dragonPearlGroup.rotation.y+=.12*d}}if(this.activeModes.has("mandala")&&this.mandalaRings&&(this.mandalaRings.forEach((m,w)=>{m.userData&&m.userData.speed&&(m.rotation.z+=m.userData.speed*d+C*.005);const I=1+A*.1*(w+1)*.3;m.scale.setScalar(I)}),this.mandalaCenter&&(this.mandalaCenter.rotation.z-=.01*d,this.mandalaCenter.scale.setScalar(1+C*.3))),this.logoMesh){const m=b.lotusState||"auto";let w=.8;m==="faded"||m==="full"&&(w=1),this._lotusCurrentOpacity===void 0&&(this._lotusCurrentOpacity=.8),this._lotusCurrentOpacity+=(w-this._lotusCurrentOpacity)*.1,this.logoMesh.material.opacity=this._lotusCurrentOpacity,this.logoMesh.scale.setScalar(1+C*(.05+((h=this._cymaticV2)==null?void 0:h.shiver)*.1)+A*.02)}if(this.activeModes.has("lava")&&this.lavaBlobs&&this.lavaUniforms){const m=((l=(u=window.MindWaveState)==null?void 0:u.envIntensities)==null?void 0:l.lava)??1;this.lavaUniforms.uTime.value=x*d,this.lavaUniforms.uIntensity.value=C*m,this.lavaBlobs.forEach((w,I)=>{const y=w.userData,M=d*(1+C*.8);if(y.state==="heating"?(y.temperature+=y.heatRate*q*M,y.temperature>=1&&(y.temperature=1,y.state="rising")):y.state==="rising"?(w.position.y+=y.riseSpeed*M,w.position.y>=y.floatMax&&(y.state="cooling")):y.state==="cooling"?(y.temperature-=y.coolRate*q*M,y.temperature<=0&&(y.temperature=0,y.state="falling")):y.state==="falling"&&(w.position.y-=y.fallSpeed*M,w.position.y<=y.floatMin&&(y.state="heating")),w.position.x+=Math.sin(x*y.driftSpeed+y.driftPhase)*.02*M,this.lavaUniforms.uBlobs.value[I]){const W=y.baseSize*(.8+.5*y.temperature);this.lavaUniforms.uBlobs.value[I].set(w.position.x,w.position.y,w.position.z,W)}})}if(this.snowflakeGroup&&this.snowflakeGroup.visible&&this._snowData){const m=this._snowData,w=m.points.geometry.attributes.position.array,I=d*2;for(let y=0;y<m.count;y++){const M=y*3;w[M+1]-=m.speeds[y]*I;let W=Math.sin(x*m.driftFreqs[y]+m.phases[y])*m.drifts[y]*I;w[M]+=W,w[M+1]<-22&&(w[M+1]=22),w[M]>35&&(w[M]=-35),w[M]<-35&&(w[M]=35)}if(m.points.geometry.attributes.position.needsUpdate=!0,m.spinMeshes){const y=1+(C||0)*.15;m.spinMeshes.forEach((M,W)=>{M.rotation.z+=m.spinSpeeds[W]*I,M.position.y-=m.spinSpeeds[W]*.1*I,M.scale.setScalar(y),M.position.y<-25&&(M.position.y=25)})}m.material&&m.material.uniforms&&m.material.uniforms.uIntensity&&(m.material.uniforms.uIntensity.value=.2+C*.8)}if(this.activeModes.has("rainforest")&&this.rainMaterial){const m=d*.8*(1+A*.3);this.rainMaterial.uniforms.uTime.value=x,this.rainMaterial.uniforms.uSpeed.value=m,this.rainMaterial.uniforms.uIntensity.value=(.5+C*.2+A*.2)*(this.brightnessMultiplier||1)}if(this.activeModes.has("zengarden")&&this.petalMaterial){const m=d*.3*(1+A*.5);this.petalMaterial.uniforms.uTime.value=x,this.petalMaterial.uniforms.uSpeed.value=m,this.zenWater&&(this.zenWater.material.opacity=(.3+A*.2)*(this.brightnessMultiplier||1))}if(this.activeModes.has("fireplace")&&this.fireMesh&&this.fireMesh.material&&this.fireMesh.material.uniforms){const m=.8+.2*Math.sin(x*15)*Math.sin(x*7),w=this.fireMesh.material.uniforms;w.uTime&&(w.uTime.value=x*1.5*d),w.uIntensity&&(w.uIntensity.value=m+C*.5),this.fireLight&&(this.fireLight.intensity=(2+C*5)*m)}const E=performance.now(),ye=E-(this._lastFrameStartTime||E);if(this._lastFrameStartTime=E,this._fpsRingBuffer&&(this._fpsRingBuffer[this._fpsRingIndex]=ye,this._fpsRingIndex=(this._fpsRingIndex+1)%60,this._fpsRingCount=Math.min(60,this._fpsRingCount+1),this._fpsRingCount===60)){let m=0;for(let I=0;I<60;I++)m+=this._fpsRingBuffer[I];m/=60,1e3/m<35&&E-(this._lastLodDegradation||0)>3e3&&(this.degradeLOD(),this._lastLodDegradation=E,this._fpsRingCount=0)}const be=1e3/(this.targetFPS||60);E-this.lastFrameRenderTime>=be&&(this.renderer.autoClear=!this.activeModes.has("lightspeed"),this.renderer.autoClear&&this.renderer.clear(),this.renderer.render(this.scene,this.camera),this.activeModes.has("cyber")&&this.renderCyberCyber(),this.lastFrameRenderTime=E)}catch(v){v.name==="TypeError"&&v.message.includes("uniforms")}finally{this._isRendering=!1}this.active&&!document.hidden?b.animationId=requestAnimationFrame(()=>this.render(b.analyserLeft,b.analyserRight)):b.animationId=null}}setCyberColor(e){this.cyberConfig.color=e,this.cyberConfig.rainbow=!1,this.cyberColorCustomized=!0,this.matrixCyberStreams&&this.matrixCyberStreams.forEach(t=>{t.color=e})}setMatrixColor(e){this.matrixConfig.color=e,this.matrixConfig.rainbow=!1,this.cyberMaterial&&this.cyberMaterial.uniforms.uColor&&(this.cyberMaterial.uniforms.uColor.value.set(e),this._tempColor.set(e),this._tempColor.r+=(1-this._tempColor.r)*.8,this._tempColor.g+=(1-this._tempColor.g)*.8,this._tempColor.b+=(1-this._tempColor.b)*.8,this.cyberMaterial.uniforms.uHeadColor.value.copy(this._tempColor),this.cyberMaterial.uniforms.uRainbow&&(this.cyberMaterial.uniforms.uRainbow.value=0))}getAverageFrequency(e,t){let a=b.analyserLeft||b.analyserRight;if(!a)return 0;const i=a.frequencyBinCount;(!this._freqDataArray||this._freqDataArray.length!==i)&&(this._freqDataArray=new Uint8Array(i));const s=this._freqDataArray;a.getByteFrequencyData(s),e===void 0&&(e=0),t===void 0&&(t=s.length);let o=0,r=0;for(let n=e;n<t&&n<s.length;n++)o+=s[n],r++;return r>0?o/r:0}setMouseInfluence(e){this.mouseInfluence=e}setGlobalSpeed(e){this.speedMultiplier=e,this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uSpeed&&(this.cyberMaterial.uniforms.uSpeed.value=1+(e-1)*.5)}setGlobalBrightness(e){this.brightnessMultiplier=e,this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uBrightness&&(this.cyberMaterial.uniforms.uBrightness.value=e)}setCyberBrightness(e){this.cyberConfig.brightness=e}setMatrixBrightness(e){this.matrixConfig.brightness=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uBrightness&&(this.cyberMaterial.uniforms.uBrightness.value=e)}setCyberSpeed(e){this.cyberConfig.speed=e}setCyberLength(e){this.cyberConfig.length=e}setMatrixSpeed(e){this.matrixConfig.speed=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uSpeed&&(this.cyberMaterial.uniforms.uSpeed.value=e)}setMatrixLength(e){this.matrixConfig.length=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uTailLength.value=e)}setCyberRainbow(e){if(this.cyberConfig.rainbow=e,this.cyberRainbowMode=e,!e){const t=this.cyberConfig.color||this.cyberColor||"#00FF41";this.matrixCyberStreams&&this.matrixCyberStreams.forEach(a=>{a.color=t})}}setMatrixRainbow(e){this.matrixConfig.rainbow=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uRainbow&&(this.cyberMaterial.uniforms.uRainbow.value=e?1:0)}setBatterySaver(e){this.batterySaver=e,this.targetFPS=e?30:60;const t=e?1:2;this.renderer&&(this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,t)),this.resize())}degradeLOD(){this.renderer&&(this.currentLodLevel==="high"?(this.renderer.setPixelRatio(1),this.currentLodLevel="medium",this.resize()):this.currentLodLevel==="medium"&&(this.renderer.setPixelRatio(.75),this.currentLodLevel="low",this.resize()))}updateCyberStrings(){if(!this.matrixCyberStreams)return;let e=!1,t="MINDWAVE🪷";const a=this.cyberConfig;a.logicMode==="custom"||a.logicMode==="txt"?(e=!0,t="🪷"+(a.customText||"WELCOME TO MINDWAVE")):(a.logicMode==="mindwave"||a.logicMode==="mw")&&(e=!0,t="MINDWAVE🪷");const i="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ",s="0123456789·:.-+x[]<>/\\∆ΣΩ∞",o=100;this.matrixCyberStreams.forEach(r=>{if(r.chars=[],r.isTextMode=e,e&&t.length>0){const n=[...t].reverse();for(let h=0;h<o;h++)r.chars.push(n[h%n.length])}else if(a.logicMode==="matrix"||a.logicMode==="interstellar"||a.logicMode==="int")for(let n=0;n<o;n++)r.chars.push(s.charAt(Math.floor(Math.random()*s.length)));else for(let n=0;n<o;n++)r.chars.push(i.charAt(Math.floor(Math.random()*i.length)))})}setCyberLogicMode(e,t){this.cyberConfig.logicMode=e,t!==void 0&&(this.cyberConfig.customText=t),this.updateCyberStrings()}setMatrixLogicMode(e,t){if(this.matrixConfig.logicMode=e,t!==void 0&&(this.matrixConfig.customText=t),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTexture){const a=this.cyberMaterial.uniforms.uTexture.value,i=this.createCyberTexture(this.matrixConfig);this.cyberMaterial.uniforms.uTexture.value=i,this.cyberMaterial.needsUpdate=!0,a&&a.dispose()}this.initCyber()}setCyberColor(e){this.cyberConfig.color=e,this.matrixCyberStreams&&this.matrixCyberStreams.forEach(t=>{t.color=e})}setMatrixColor(e){this.matrixConfig.color=e,this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uColor&&this.cyberMaterial.uniforms.uColor.value.set(e)}setCyberAngle(e){this.cyberConfig.angle=e}setMatrixAngle(e){this.matrixConfig.angle=e,this.currentCyberAngle=e,this.cyberRotationGroup&&(this.cyberRotationGroup.rotation.z=xe.degToRad(-e))}setVibrationEnabled(e){this.vibrationEnabled=e}updateLogoTexture(){if(!this.originalLogoImg)return;const e=512;this._logoRenderCanvas||(this._logoRenderCanvas=document.createElement("canvas"),this._logoRenderCanvas.width=e,this._logoRenderCanvas.height=e);const t=this._logoRenderCanvas,a=t.getContext("2d",{willReadFrequently:!0});a.clearRect(0,0,e,e),a.drawImage(this.originalLogoImg,0,0,e,e);const i=a.getImageData(0,0,t.width,t.height),s=i.data,o=document.body.dataset.theme||"default",r=ue[o]||ue.default,n=r.secondary||r.accent||"#ffffff",h=this.customColors&&this.customColors.mandala?this.customColors.mandala:this.customColor,u=h?h.getHex():parseInt(r.accent.replace("#",""),16),l=parseInt(n.replace("#",""),16),v=u>>16&255,c=u>>8&255,g=u&255,d=l>>16&255,x=l>>8&255,q=l&255;this.themeType=document.body.dataset.themeType||"dark",this.themeType;for(let S=0;S<s.length;S+=4){const D=s[S],A=s[S+1],C=s[S+2],F=s[S+3];F<10||(D>200&&A>200&&C>200?(s[S]=v,s[S+1]=c,s[S+2]=g,s[S+3]=255):(s[S]=d,s[S+1]=x,s[S+2]=q,s[S+3]=Math.min(255,F*1.5)))}a.putImageData(i,0,0);const _=new Q(t);if(_.minFilter=ne,_.magFilter=ne,_.generateMipmaps=!0,this.renderer&&(_.anisotropy=this.renderer.capabilities.getMaxAnisotropy()),this.logoMesh){const S=this.logoMesh.material.map;this.logoMesh.material.map=_,this.logoMesh.material.needsUpdate=!0,S&&S.dispose()}else{const S=new j(5.625,4.78),D=new L({map:_,transparent:!0,opacity:.8,color:16777215,depthTest:!1,depthWrite:!1});this.logoMesh=new G(S,D),this.logoMesh.position.set(0,0,-10),this.logoMesh.renderOrder=-1,this.scene.add(this.logoMesh)}}initOverlayLogo(){if(this.logoMesh)return;const e=new Image;e.crossOrigin="anonymous",e.src="./mindwave-logo-icon.png",e.onload=()=>{this.originalLogoImg=e,this.updateLogoTexture(),this.targetLogoOpacity!==void 0?this.setLogoOpacity(this.targetLogoOpacity):this.setLogoOpacity(.8)},e.onerror=t=>{}}setLogoOpacity(e){this.targetLogoOpacity=e,this.logoMesh&&this.logoMesh.material?this.logoMesh.material.opacity=e*this.brightnessMultiplier:!this.logoMesh&&e>0&&this.initOverlayLogo()}applyCymaticClassAndVariation(e,t){this.cymaticsCore&&(this.cymaticsCore.setPattern(e,t),this.activeModes.has("cymatics")||this.toggleMode("cymatics"))}setCymaticColor(e,t,a){if(this.cymaticsCore){if(a!==void 0)this.cymaticsCore.setColor(e,t,a);else if(e!==void 0){const i=e,s=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(s,1,i)}}}setCymaticColor2(e){if(!this.cymaticsCore)return;const t=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(t,2,new P(e))}setCymaticColor3(e){if(!this.cymaticsCore)return;const t=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(t,3,new P(e))}setCymaticParam(e,t,a){this.cymaticsCore&&this.cymaticsCore.setParam(e,t,a)}dispose(){this.active=!1,b.animationId&&(cancelAnimationFrame(b.animationId),b.animationId=null),window.removeEventListener("resize",this.resize),window.removeEventListener("resize",this.resizeOverlayCanvas),window.removeEventListener("mindwave:layout-change",this.handleLayoutChange),this._boundSafeMode&&window.removeEventListener("mindwave:safe-mode-start",this._boundSafeMode),this._boundVisibilityChange&&document.removeEventListener("visibilitychange",this._boundVisibilityChange),this._boundThemeChange&&window.removeEventListener("themeChanged",this._boundThemeChange),this.canvas&&(this._boundContextLost&&this.canvas.removeEventListener("webglcontextlost",this._boundContextLost),this._boundContextRestored&&this.canvas.removeEventListener("webglcontextrestored",this._boundContextRestored)),this._boundCymaticPointer&&(window.removeEventListener("mousemove",this._boundCymaticPointer),window.removeEventListener("touchmove",this._boundCymaticPointer));const e=a=>{if(a)for(;a.children.length>0;){const i=a.children[0];if(a.remove(i),i.geometry&&i.geometry.dispose(),i.material){if(i.material.map&&i.material.map.dispose(),i.material.uniforms)for(const s in i.material.uniforms){const o=i.material.uniforms[s];o&&o.value&&o.value.dispose&&o.value.dispose()}i.material.dispose()}i.children&&i.children.length&&i.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(s.material.map&&s.material.map.dispose(),s.material.dispose())})}},t=[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup];this._fpsRingBuffer=null,this._tempColor=null,this._logoRenderCanvas=null,t.forEach(e),this.cyberMaterial&&(this.cyberMaterial.dispose(),this.cyberMaterial=null),this.fireMaterial&&(this.fireMaterial.dispose(),this.fireMaterial=null),this.particleMaterial&&(this.particleMaterial.dispose(),this.particleMaterial=null),this.lightspeedMaterial&&(this.lightspeedMaterial.dispose(),this.lightspeedMaterial=null),this.rainMaterial&&(this.rainMaterial.dispose(),this.rainMaterial=null),this.petalMaterial&&(this.petalMaterial.dispose(),this.petalMaterial=null),this.logoMesh&&(this.logoMesh.material&&(this.logoMesh.material.map&&this.logoMesh.material.map.dispose(),this.logoMesh.material.dispose()),this.logoMesh.geometry&&this.logoMesh.geometry.dispose(),this.scene&&this.scene.remove(this.logoMesh),this.logoMesh=null);for(const a in this.textures)this.textures[a]&&this.textures[a].dispose&&this.textures[a].dispose();if(this.textures={},this._freqDataArray=null,this.renderer){try{this.renderer.forceContextLoss()}catch{}this.renderer.dispose(),this.renderer=null}this.scene=null,this.camera=null}setWarpSpeed(e){this.lightspeedMaterial&&(this.lightspeedMaterial.uniforms.uSpeed.value=e)}setWarpFov(e){this.camera&&(this.camera.fov=e,this.camera.updateProjectionMatrix())}setWarpChromatic(e){this.lightspeedMaterial}}fe(ge,"CYMATIC_PATTERNS",[{classId:22,variationId:0,name:"Fundamental Zenith",style:"fractal"},{classId:22,variationId:1,name:"Quantum Flower",style:"sacred"},{classId:22,variationId:2,name:"Sacred Sun Resonance",style:"complex"},{classId:22,variationId:3,name:"Ethereal Nexus",style:"geometry"},{classId:22,variationId:4,name:"Golden Ratio Spiral",style:"fractal"},{classId:22,variationId:5,name:"Obsidian Bloom",style:"sacred"},{classId:22,variationId:6,name:"Prismatic Core",style:"complex"},{classId:22,variationId:7,name:"Void Resonance",style:"geometry"},{classId:22,variationId:8,name:"Nebula Plasma",style:"fractal"},{classId:22,variationId:9,name:"Sacred Gold Obsidian",style:"sacred"},{classId:22,variationId:10,name:"Biolum Abyssal",style:"complex"},{classId:22,variationId:11,name:"Emerald Cyber Matrix",style:"geometry"},{classId:22,variationId:12,name:"Liquid Mercury Crimson",style:"fractal"},{classId:22,variationId:13,name:"Quantum Crystal Lattice",style:"sacred"},{classId:22,variationId:14,name:"Solar Flare Harmonics",style:"complex"},{classId:22,variationId:15,name:"Amethyst Hyperdimensional",style:"geometry"},{classId:22,variationId:16,name:"Neon Labyrinth",style:"fractal"},{classId:22,variationId:17,name:"Celestial Mandala",style:"sacred"},{classId:22,variationId:18,name:"Astral Lotus",style:"complex"},{classId:22,variationId:19,name:"Lunar Tides",style:"geometry"},{classId:22,variationId:20,name:"Cybernetic Lotus",style:"fractal"},{classId:22,variationId:21,name:"Bioluminescent Shroom",style:"sacred"},{classId:22,variationId:22,name:"Vortex of Time",style:"complex"},{classId:22,variationId:23,name:"Diamond Lattice",style:"geometry"},{classId:22,variationId:24,name:"Seraphim Wings",style:"fractal"},{classId:22,variationId:25,name:"Fractal Heart",style:"sacred"},{classId:22,variationId:26,name:"Particle Swarm",style:"complex"},{classId:22,variationId:27,name:"Fluid SDF",style:"geometry"},{classId:22,variationId:28,name:"Quantum Topology",style:"fractal"},{classId:22,variationId:29,name:"Ai Cymatic 15",style:"sacred"}]);function it(){return p?Promise.resolve(p):new Promise(f=>{Ze(),setTimeout(()=>f(p),10)})}function Ze(){if(!p&&U.canvas&&U.canvas.activeVisualizer&&U.canvas.activeVisualizer.isVisualizer3D&&(p=U.canvas.activeVisualizer),U.canvas&&U.canvas.activeVisualizer){if(p&&U.canvas.activeVisualizer===p)return p;U.canvas.activeVisualizer.dispose(),U.canvas.activeVisualizer=null,p=null}b.animationId&&(cancelAnimationFrame(b.animationId),b.animationId=null);const f=U.canvas||document.getElementById("visualizer");if(!p&&f){const e=f&&f.activeVisualizer&&f.activeVisualizer.isVisualizer3D?{activeModes:f.activeVisualizer.activeModes,mode:f.activeVisualizer.mode,mindWaveMode:f.activeVisualizer.mindWaveMode,cyberLogicMode:f.activeVisualizer.cyberLogicMode,cyberCustomText:f.activeVisualizer.cyberCustomText,currentCyberAngle:f.activeVisualizer.currentCyberAngle,cyberSpeedMultiplier:f.activeVisualizer.cyberSpeedMultiplier,rainbowEnabled:f.activeVisualizer._rainbowEnabled}:{};p=new ge(f,e),f.activeVisualizer=p,setTimeout(()=>{p&&(p.updateVisibility(),$e())},0)}return p}function ot(){return p}let le=!1;function st(){le=!0,p&&b.animationId&&(cancelAnimationFrame(b.animationId),b.animationId=null,p.renderer&&p.scene&&p.camera&&p.renderer.render(p.scene,p.camera))}function $e(){p&&!b.animationId&&(p.active=!0,p.render(b.analyserLeft,b.analyserRight),le=!1)}function rt(){return le}function nt(f){p&&p.toggleMode(f)}function lt(f){p&&(p.setGlobalSpeed(f),p.setCyberSpeed&&p.setCyberSpeed(f))}function ct(f,e=null){p&&(p.setVisualColor(f,e),p.setCyberColor&&(!e||e=="cyber")&&p.setCyberColor(f))}function ft(f){p&&p.setGlobalBrightness&&p.setGlobalBrightness(f)}function ut(f){p&&p.setLogoOpacity(f)}function ht(f){p&&p.setMouseInfluence(f)}window.toggleGalaxySun=function(){return p?p.toggleGalaxySunStyle():null};window.setCymaticPattern=function(f,e){p&&p.cymaticsCore?(p.cymaticsCore.setPattern(f,e),p.activeModes.has("cymatics")||(window.switchRightTab&&window.switchRightTab("active",document.querySelector('.tab-pill[title="Cymatics"]')),p.activeModes.add("cymatics"),p.cymaticsGroup.visible=!0)):(window.setVisualMode&&window.setVisualMode("cymatics"),setTimeout(()=>{p&&p.cymaticsCore&&p.cymaticsCore.setPattern(f,e)},500))};export{ge as Visualizer3D,ot as getVisualizer,Ze as initVisualizer,rt as isVisualsPaused,st as pauseVisuals,it as preloadVisualizer,$e as resumeVisuals,ht as setMouseInfluence,ft as setVisualBrightness,ct as setVisualColor,ut as setVisualLogoOpacity,lt as setVisualSpeed,nt as toggleVisual};
//# sourceMappingURL=visualizer_vGOLD_SYNC-Dh_DerAH.js.map
