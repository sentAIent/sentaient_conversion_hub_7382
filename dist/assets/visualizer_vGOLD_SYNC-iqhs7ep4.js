...
`,je=f=>f===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class Ye{constructor(e){this.group=e,this.meshes=[],this.activeClassId=1,this.activeVariationId=0,this.materials={};const t=new Pe(new Uint8Array([0,0,0,0]),1,1,Ge);t.needsUpdate=!0,this.dummyTexture=t;const a=new j(2,2);for(let i=1;i<=22;i++){let o=je(i);i<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        ...
        uniform float uMouseSync;
        void main() {`)),i!==22&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            `,r=new O({vertexShader:s,fragmentShader:o,uniforms:i,transparent:!0,blending:T,depthWrite:!1,side:X}),n=new ee(2,64,64),m=new P(n,r);a.add(m);const u=new L({color:t.color,transparent:!0,opacity:.15,blending:T,depthWrite:!1,side:Ve}),l=new ee(3,32,32);a.add(new P(l,u))}else{const i=new me(1.5,.12,8,64);a.add(new P(i,t));const s=8;for(let o=0;o<s;o++){const r=o/s*Math.PI*2,n=new de;n.moveTo(-.4,0),n.lineTo(.4,0),n.lineTo(0,2.7),n.lineTo(-.4,0);const m=new pe(n),u=new P(m,t);u.rotation.z=-r,u.position.set(Math.sin(r)*1.5,Math.cos(r)*1.5,0),a.add(u);const l=r+Math.PI/s,v=new de;v.moveTo(-.2,0),v.lineTo(.2,0),v.lineTo(0,1.7),v.lineTo(-.2,0);const c=new pe(v),g=new P(c,t);g.rotation.z=-l,g.position.set(Math.sin(l)*1.5,Math.cos(l)*1.5,0),a.add(g)}}this.galaxySunMesh.add(a),this.galaxySunMesh.position.set(0,0,.1),this.galaxyGroup.add(this.galaxySunMesh)}setGalaxySunStyle(e){e!=="sun"&&e!=="sun2"&&e!=="sun3"||(this.galaxySunStyle=e,this.galaxyGroup&&this.galaxyGroup.children.length>0&&this.createGalaxySun(e))}setGalaxySunRotation(e,t){e==="x"&&(this.sunRotationSpeedX=parseFloat(t)),e==="y"&&(this.sunRotationSpeedY=parseFloat(t)),e==="z"&&(this.sunRotationSpeedZ=parseFloat(t))}createStarTexture(){if(this.textures.star)return this.textures.star;const e=64,t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d"),i=e/2,s=e/2;a.clearRect(0,0,e,e);const o=a.createRadialGradient(i,s,0,i,s,e/2);return o.addColorStop(0,"rgba(255, 255, 255, 1.0)"),o.addColorStop(.1,"rgba(255, 255, 240, 0.8)"),o.addColorStop(.25,"rgba(255, 255, 200, 0.3)"),o.addColorStop(.5,"rgba(200, 200, 255, 0.1)"),o.addColorStop(1,"rgba(100, 100, 255, 0)"),a.fillStyle=o,a.fillRect(0,0,e,e),a.fillStyle="rgba(255, 255, 255, 0.6)",a.beginPath(),a.moveTo(0,s-1),a.lineTo(i,s-.5),a.lineTo(e,s-1),a.lineTo(e,s+1),a.lineTo(i,s+.5),a.lineTo(0,s+1),a.closePath(),a.fill(),a.beginPath(),a.moveTo(i-1,0),a.lineTo(i-.5,s),a.lineTo(i-1,e),a.lineTo(i+1,e),a.lineTo(i+.5,s),a.lineTo(i+1,0),a.closePath(),a.fill(),a.beginPath(),a.arc(i,s,2,0,Math.PI*2),a.fillStyle="rgba(255, 255, 255, 1.0)",a.fill(),this.textures.star=new $(t),this.textures.star}initMandala(){var s;this.mandalaRings=[];const e=[2450411,15357964,3900150,16347926,12573694];for(let o=0;o<5;o++){const r=1.2+o*.8,n=6+o*6,m=new Oe(r-.05,r+.05,n),u=new L({color:e[o],side:X,transparent:!0,opacity:.4-o*.05,blending:T}),l=new P(m,u);l.userData={speed:(.01+o*.005)*(o%2===0?1:-1),segments:n},this.mandalaRings.push(l),this.mandalaGroup.add(l)}const t=new Ee(.3,32),a=new L({color:16347926,transparent:!0,opacity:.6,blending:T});this.mandalaCenter=new P(t,a),this.mandalaGroup.add(this.mandalaCenter),this.mandalaGroup.visible=!1;const i=(s=this.customColors)==null?void 0:s.mandala;i&&(this.mandalaRings.forEach(o=>o.material.color.copy(i)),this.mandalaCenter.material.color.copy(i))}createSnowflakeTexture(){if(this.textures.snowflake)return this.textures.snowflake;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const a=t.getContext("2d"),i=e/2,s=e/2;a.clearRect(0,0,e,e);const o=a.createRadialGradient(i,s,0,i,s,e*.5);o.addColorStop(0,"rgba(200,230,255,0.5)"),o.addColorStop(.4,"rgba(180,220,255,0.15)"),o.addColorStop(1,"rgba(150,200,255,0)"),a.fillStyle=o,a.fillRect(0,0,e,e),a.strokeStyle="rgba(220,240,255,1.0)",a.lineCap="round";for(let r=0;r<6;r++){const n=r/6*Math.PI*2;a.save(),a.translate(i,s),a.rotate(n),a.lineWidth=2.5,a.beginPath(),a.moveTo(0,0),a.lineTo(0,-52),a.stroke();const m=[{d:18,len:14,angle:Math.PI/4},{d:32,len:20,angle:Math.PI/4},{d:46,len:10,angle:Math.PI/5}];a.lineWidth=1.5,m.forEach(({d:u,len:l,angle:v})=>{[1,-1].forEach(c=>{a.beginPath(),a.moveTo(0,-u),a.lineTo(c*l*Math.cos(Math.PI/2-v),-u-l*Math.sin(Math.PI/2-v)),a.stroke()})}),a.restore()}a.beginPath();for(let r=0;r<6;r++){const n=r/6*Math.PI*2-Math.PI/6,m=i+Math.cos(n)*4,u=s+Math.sin(n)*4;r===0?a.moveTo(m,u):a.lineTo(m,u)}return a.closePath(),a.fillStyle="rgba(255, 255, 255, 0.8)",a.fill(),this.textures.snowflake=new $(t),this.textures.snowflake}initSnowflake(){for(;this.snowflakeGroup.children.length>0;){const c=this.snowflakeGroup.children[0];this.snowflakeGroup.remove(c),c.geometry&&c.geometry.dispose(),c.material&&c.material.dispose()}this._snowData=null;const e=700,t=new Float32Array(e*3),a=new Float32Array(e),i=new Float32Array(e),s=new Float32Array(e),o=new Float32Array(e),r=new Float32Array(e),n=new Float32Array(e);for(let c=0;c<e;c++){const g=c*3;t[g]=(Math.random()-.5)*80,t[g+1]=(Math.random()-.5)*60,t[g+2]=-40+Math.random()*35;const d=(t[g+2]+40)/35;a[c]=1.5+d*8,i[c]=.2+d*.6,s[c]=Math.random()*Math.PI*2,o[c]=.015+Math.random()*.04+d*.03,r[c]=.01+Math.random()*.02,n[c]=.4+Math.random()*.8}const m=new k;m.setAttribute("position",new B(t,3)),m.setAttribute("aSize",new B(a,1)),m.setAttribute("aOpacity",new B(i,1));const u=this.createSnowflakeTexture(),l=new O({uniforms:{uTexture:{value:u},uColor:{value:this.customColor?this.customColor.clone():new G(10875883)},uIntensity:{value:0},uSizeMultiplier:{value:1},uGlowAmount:{value:.5}},vertexShader:`
            ...
            `,transparent:!0,side:X,blending:T,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;a[o]=(Math.random()-.5)*60,a[o+1]=(Math.random()-.5)*40,a[o+2]=(Math.random()-.5)*40,i[o]=Math.random(),i[o+1]=Math.random(),i[o+2]=.08+Math.random()*.12}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new G(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),this.raindrops=new N(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;a[r]=(Math.random()-.5)*40,a[r+1]=(Math.random()-.5)*20,a[r+2]=(Math.random()-.5)*40,i[r]=Math.random(),i[r+1]=Math.random(),i[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new G(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new N(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new j(40,40,32,32);this.zenWaterMaterial=new L({color:2245734,transparent:!0,opacity:.3,side:X}),this.zenWater=new P(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new j(300,100,128,64);this.oceanWave=new P(e,new O({uniforms:{uTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new G(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
