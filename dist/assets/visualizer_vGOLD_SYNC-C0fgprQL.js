...
`,je=f=>f===1?`
        ...
        void main() {`,o=o.replace("void main() {",h)}i!==22&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            `,transparent:!0,side:X,blending:T,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;a[o]=(Math.random()-.5)*60,a[o+1]=(Math.random()-.5)*40,a[o+2]=(Math.random()-.5)*40,i[o]=Math.random(),i[o+1]=Math.random(),i[o+2]=.08+Math.random()*.12}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),this.raindrops=new N(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new k,a=new Float32Array(e*3),i=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;a[r]=(Math.random()-.5)*40,a[r+1]=(Math.random()-.5)*20,a[r+2]=(Math.random()-.5)*40,i[r]=Math.random(),i[r+1]=Math.random(),i[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new B(a,3)),t.setAttribute("aRandom",new B(i,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
