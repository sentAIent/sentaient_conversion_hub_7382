...
`,st=f=>f===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class rt{constructor(e){this.group=e,this.meshes=[],this.activeClassId=22,this.activeVariationId=0,this.materials={},this.rainbowMode=!1;const t=new Ee(new Uint8Array([0,0,0,0]),1,1,Oe);t.needsUpdate=!0,this.dummyTexture=t;const i=new Q(2,2);for(let a=1;a<=25;a++){let o=st(a);if(a<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        ...
        void main() {`,o=o.replace("void main() {",m)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            ...
            `,transparent:!0,blending:T,depthWrite:!1}),this.particles=new Y(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var p;this.boxOuter=new G;const e=new ce(new fe(3,3,3)),t=new ae({color:16777215,transparent:!0,opacity:.9,blending:T}),i=new ae({color:3900150,transparent:!0,opacity:.5,blending:T});this.boxOuter.add(new ie(e,t));for(let l=1;l<=3;l++){const x=new ie(e,i);x.scale.setScalar(1+l*.012),this.boxOuter.add(x)}const a=new ce(new fe(2,2,2)),s=new ae({color:14742270,transparent:!0,opacity:.8,blending:T}),o=new ae({color:6333946,transparent:!0,opacity:.4,blending:T});this.boxInner=new G,this.boxInner.add(new ie(a,s));for(let l=1;l<=2;l++){const x=new ie(a,o);x.scale.setScalar(1+l*.015),this.boxInner.add(x)}const r=new ce(new fe(3.05,3.05,3.05)),n=new ae({color:9684477,transparent:!0,opacity:.8,blending:T});this.boxEdges=new ie(r,n),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const m=((p=this.customColors)==null?void 0:p.box)||this.customColor;m&&(this.boxOuter.children.forEach(l=>l.material.color.copy(m)),this.boxInner.children.forEach(l=>l.material.color.copy(m)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(m))}initDragon(){var x;this.dragonDummy=new Ye,this.dragonLength=80;const e=new ne(.8,1),t=new V({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:T}),i=new ne(.5,1),a=new V({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:T});this.dragonBodyInstanced=new we(e,t,this.dragonLength),this.dragonGlowInstanced=new we(i,a,this.dragonLength);const s=new ue(1.5,3.5,5);s.rotateX(Math.PI/2);const o=new V({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:T});this.dragonHead=new P(s,o),this.dragonPearlGroup=new G;const r=new le(1,16,16),n=new V({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:T}),m=new le(1.3,16,16),p=new V({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:T});this.dragonPearl=new P(r,n),this.dragonPearlHalo=new P(m,p),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const l=((x=this.customColors)==null?void 0:x.dragon)||this.customColor;l&&this.updateDragonColor(l)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const i=(t.h+.5)%1,a=this.galaxyStars.geometry.getAttribute("color");if(a){const s=a.count,o=this._tempColor;for(let r=0;r<s;r++){const n=r/s,m=n<.2?.8:n<.5?.6:.4+Math.random()*.15,p=.6+Math.random()*.3;o.setHSL(i,p,m),a.setXYZ(r,o.r,o.g,o.b)}a.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const i=(t.h+.5)%1,a=new A().setHSL(i,t.s,t.l);this.dragonGlowInstanced.material.color.copy(a)}initGalaxy(){const e=this.batterySaver?500:1500,t=new B,i=[],a=[],s=[];for(let n=0;n<e;n++){const m=n/e*Math.PI*10,p=2.5+n/e*20+Math.random()*2,l=n%4*(Math.PI*2/4),x=Math.max(.5,n/e*4),c=Math.cos(m+l)*p+(Math.random()-.5)*x,u=(Math.random()-.5)*1.5,g=Math.sin(m+l)*p+(Math.random()-.5)*x;i.push(c,u,g);const I=n/e;I<.2?a.push(1,.95,.7):I<.5?a.push(.7+Math.random()*.3,.8,1):a.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),s.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new j(i,3)),t.setAttribute("color",new j(a,3)),t.setAttribute("size",new j(s,1));const o=this.createStarTexture(),r=new me({size:.25,vertexColors:!0,map:o,transparent:!0,opacity:.9,blending:T,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new Y(t,r),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new G;const t=new V({color:4892415,transparent:!0,opacity:.85,blending:T,depthWrite:!1,side:Z}),i=new G;if(e==="sun2"){const a=t.clone();a.side=je;const s=new Ce(1.5,.25,16,64);i.add(new P(s,a));const o=8,r=new ue(.4,2.7,4);r.translate(0,2.7/2,0);const n=new ue(.2,1.7,4);n.translate(0,1.7/2,0);for(let m=0;m<o;m++){const p=m/o*Math.PI*2,l=new P(r,a);l.rotation.z=-p,l.position.set(Math.sin(p)*1.5,Math.cos(p)*1.5,0),i.add(l);const x=p+Math.PI/o,c=new P(n,a);c.rotation.z=-x,c.position.set(Math.sin(x)*1.5,Math.cos(x)*1.5,0),i.add(c)}}else if(e==="sun3"){const a={uTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=a;const s=`
                varying vec2 vUv;
        ...
        `,s=new O({vertexShader:i,fragmentShader:a,uniforms:t,transparent:!0,side:Z,wireframe:!1});this.tsunamiMaterial=s,this.tsunamiWave=new P(e,s),this.tsunamiWave.rotation.x=-Math.PI/2,this.tsunamiWave.position.y=-15,this.tsunamiWave.position.z=-120,this.tsunamiWave.position.x=0,this.tsunamiWave.frustumCulled=!1,this.tsunamiGroup.add(this.tsunamiWave),this.tsunamiSun=new P(new Q(100,100),new V({color:16733440,transparent:!0,opacity:.9,depthWrite:!1})),this.tsunamiSun.position.set(0,30,-300),this.tsunamiSun.material.uniforms={uMist:{value:1}},this.tsunamiGroup.add(this.tsunamiSun)}initSnowflake(){for(;this.snowflakeGroup.children.length>0;){const c=this.snowflakeGroup.children[0];this.snowflakeGroup.remove(c),c.geometry&&c.geometry.dispose(),c.material&&c.material.dispose()}this._snowData=null;const e=this.snowCount||200,t=new Float32Array(e*3),i=new Float32Array(e),a=new Float32Array(e),s=new Float32Array(e),o=new Float32Array(e),r=new Float32Array(e),n=new Float32Array(e);for(let c=0;c<e;c++){const u=c*3;t[u]=(Math.random()-.5)*80,t[u+1]=(Math.random()-.5)*60,t[u+2]=-40+Math.random()*35;const g=(t[u+2]+40)/35;i[c]=1.5+g*8,a[c]=.2+g*.6,s[c]=Math.random()*Math.PI*2,o[c]=.015+Math.random()*.04+g*.03,r[c]=.01+Math.random()*.02,n[c]=.4+Math.random()*.8}const m=new B;m.setAttribute("position",new E(t,3)),m.setAttribute("aSize",new E(i,1)),m.setAttribute("aOpacity",new E(a,1));const p=this.createSnowflakeTexture(),l=new O({uniforms:{uTexture:{value:p},uColor:{value:this.customColor?this.customColor.clone():new A(10875883)},uIntensity:{value:0},uSizeMultiplier:{value:this.snowSizeOverride},uGlowAmount:{value:.5}},vertexShader:`
            ...
            `,transparent:!0,blending:T,depthWrite:!1,side:Z}),i=new Q(100,100),a=new P(i,t);a.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(r=>{for(let n=0;n<r.count;n++){const m=r.minSize+Math.random()*(r.maxSize-r.minSize),p=["heating","rising","cooling","falling"],l=p[Math.floor(Math.random()*p.length)],x=-18+Math.random()*4,c=18+Math.random()*4;let u=0,g=.5;l==="heating"?(u=x,g=Math.random()*.5):l==="rising"?(u=x+Math.random()*(c-x),g=.8+Math.random()*.2):l==="cooling"?(u=c,g=1-Math.random()*.3):l==="falling"&&(u=c-Math.random()*(c-x),g=.2+Math.random()*.3),this.lavaBlobs.push({position:new Je((Math.random()-.5)*12,u,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:m,state:l,temperature:g,floatMin:x,floatMax:c,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(m*.5),fallSpeed:(.05+Math.random()*.05)/(m*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(a),this.lavaGroup.visible=!1}initFireplace(){const i=new Q(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new P(i,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new et(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const a=650,s=new B,o=[];for(let r=0;r<a;r++)o.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);s.setAttribute("position",new j(o,3)),this.emberMat=new me({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:T,depthWrite:!1}),this.embers=new Y(s,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(a);for(let r=0;r<a;r++)this.emberVelocities[r]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new O({uniforms:{uTime:{value:0},uColor:{value:new A(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:Z,blending:T,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new B,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*40,i[o+2]=(Math.random()-.5)*40,a[o]=Math.random(),a[o+1]=Math.random(),a[o+2]=.08+Math.random()*.12}t.setAttribute("position",new E(i,3)),t.setAttribute("aRandom",new E(a,3)),this.rainMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:T}),this.raindrops=new Y(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new B,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const r=o*3;i[r]=(Math.random()-.5)*40,i[r+1]=(Math.random()-.5)*20,i[r+2]=(Math.random()-.5)*40,a[r]=Math.random(),a[r+1]=Math.random(),a[r+2]=Math.random()*Math.PI*2}t.setAttribute("position",new E(i,3)),t.setAttribute("aRandom",new E(a,3)),this.petalMaterial=new O({uniforms:{uTime:{value:0},uSpeed:{value:1},uColor:{value:new A(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new Y(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new Q(40,40,32,32);this.zenWaterMaterial=new V({color:2245734,transparent:!0,opacity:.3,side:Z}),this.zenWater=new P(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var r;const e=new Q(300,100,128,64);this.oceanWave=new P(e,new O({uniforms:{uTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new A(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:Z})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new B,a=[];for(let n=0;n<t;n++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new j(a,3));const s=new me({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:T,depthWrite:!1});this.oceanFoam=new Y(i,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((r=this.customColors)==null?void 0:r.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const s=8,o=8,r=1024/s,n=1024/o;let m="🪷MINDWAVE";const p=e.logicMode,l=e.customText;p==="custom"||p==="txt"?m="🪷"+(l&&l.length>0?l:"WELCOME TO MINDWAVE"):(p==="random"||p==="rnd"||p==="matrix"||p==="int"||p==="interstellar")&&(m="");const x=p==="matrix"||p==="int"||p==="interstellar"?[]:["LOGO",...m],c=x.length;for(let g=0;g<64;g++){const I=g%8,R=Math.floor(g/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(I*r,R*n,r,n),a.save(),a.translate(I*r+r/2,R*n+n/2);let z="",M=!1;if(g<c){const F=x[g];F==="LOGO"?M=!0:z=F}else{const S="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";z=S.charAt(Math.floor(Math.random()*S.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(z,0,0),a.restore(),z="")}if(z||M)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",M)if(this.logoImage){const w=document.createElement("canvas");w.width=100,w.height=100;const U=w.getContext("2d");U.imageSmoothingEnabled=!0,U.imageSmoothingQuality="high",U.drawImage(this.logoImage,0,0,100,100);const K=U.getImageData(0,0,100,100),L=K.data;for(let D=0;D<L.length;D+=4){const $=180+(L[D]+L[D+1]+L[D+2])/3/255*75;L[D]=$,L[D+1]=$,L[D+2]=$}U.putImageData(K,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(w,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new tt().load("./mindwave-logo-icon.png",S=>{if(this.logoImage=S,this.logoLoading=!1,this.cyberMaterial){const w=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=w}},void 0,S=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(z,0,0);a.restore()}const u=new oe(i);return u.magFilter=Te,u.minFilter=Te,u}createCyberShader(e,t=this.matrixConfig){return new O({uniforms:{uTexture:{value:e},uColor:{value:new A(t.color||65345)},uHeadColor:{value:new A(15794160)},uTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
