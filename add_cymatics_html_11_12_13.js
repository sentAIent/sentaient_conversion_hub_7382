...
const classes = [
    { id: 11, name: 'Class XI: Sacred Runes', count: 10, defaultColors: ['#ffa500', '#8b0000'] },
    { id: 12, name: 'Class XII: Wireframe Topologies', count: 10, defaultColors: ['#00ff00', '#000000'] },
    { id: 13, name: 'Class XIII: Ethereal Plasma', count: 10, defaultColors: ['#e6e6fa', '#4b0082'] }
];
...
if (htmlStr.includes(targetStr)) {
    ...
    console.log("Successfully injected cymatics UI for Classes 11, 12, 13!");
} else {
