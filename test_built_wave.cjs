...
(async () => {
    ...
    await page.goto('http://localhost:8080/mindwave.html');
    ...
    await page.screenshot({ path: '/Users/infinitealpha/.gemini/antigravity/brain/da778e0b-fdc4-4e36-a9ee-2bc86efef5dd/built_wave_1.png' });
    console.log("Screenshot 1 taken");

    await page.waitForTimeout(3000); // Let wave form more
    await page.screenshot({ path: '/Users/infinitealpha/.gemini/antigravity/brain/da778e0b-fdc4-4e36-a9ee-2bc86efef5dd/built_wave_2.png' });
