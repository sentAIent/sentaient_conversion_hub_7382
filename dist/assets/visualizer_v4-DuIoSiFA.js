...
`,st=f=>f===1?`
        ...
        `:"void main() { gl_FragColor = vec4(0.0, 0.0, 0.0, 1.0); }";class rt{constructor(e){this.group=e,this.meshes=[],this.activeClassId=22,this.activeVariationId=0,this.materials={},this.rainbowMode=!1;const t=new Oe(new Uint8Array([0,0,0,0]),1,1,Ee);t.needsUpdate=!0,this.dummyTexture=t;const i=new te(2,2);for(let a=1;a<=25;a++){let o=st(a);if(a<=16&&(o=o.replace("uniform float uIntensity;",`uniform float uIntensity;
        uniform float uAudioLow;
        uniform float uAudioMid;
        uniform float uAudioHigh;`),o=o.replace("float intMod = max(0.1, uIntensity);","float intMod = max(0.1, uIntensity * (1.0 + uAudioLow * 3.0 + uAudioMid * 1.5));")),!o.includes("uniform float uMouseSync;")){let d="";/uniform\s+vec2\s+uMouse\s*;/.test(o)||(d+=`uniform vec2 uMouse;
        `),d+=`uniform float uMouseSync;
        void main() {`,o=o.replace("void main() {",d)}a<=21&&(o.includes("vec2 p = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 p = (vUv - 0.5) * 2.0;",`vec2 p = (vUv - 0.5) * 2.0;
            p -= uMouse * uMouseSync * 0.5;`):o.includes("vec2 uv = (vUv - 0.5) * 2.0;")?o=o.replace("vec2 uv = (vUv - 0.5) * 2.0;",`vec2 uv = (vUv - 0.5) * 2.0;
            uv -= uMouse * uMouseSync * 0.5;`):o.includes("vec2 up = (vUv - 0.5) * 2.0;")&&(o=o.replace("vec2 up = (vUv - 0.5) * 2.0;",`vec2 up = (vUv - 0.5) * 2.0;
            up -= uMouse * uMouseSync * 0.5;`)));const n=`
                ...
                ${o}
            `;this.materials[a]=new E({vertexShader:ot,fragmentShader:n,defines:{VARIATION:0},uniforms:{uTime:{value:0},uAspect:{value:1},uColor1:{value:new T(6334975)},uColor2:{value:new T(11032055)},uIntensity:{value:1},uSpeed:{value:1},uHarmonics:{value:0},uVariation:{value:0},uLayer2Type:{value:0},uAudioLow:{value:0},uAudioMid:{value:0},uAudioHigh:{value:0},uMouse:{value:new ye(0,0)},uAlpha:{value:1},uSpawnTime:{value:0},uTexture:{value:this.dummyTexture},uTexture2:{value:this.dummyTexture},uTexture3:{value:this.dummyTexture},uShowLines:{value:1},uMouseSync:{value:0},uObserver:{value:0}},transparent:!0,depthWrite:!1,depthTest:!1,blending:_});const l=new G(i,this.materials[a]);l.visible=!1,l.frustumCulled=!1,l.position.z=-1,this.meshes.push(l),this.group.add(l)}this._boundCymaticsToggleMouseSync=a=>{for(let s=1;s<=25;s++)this.materials[s]&&this.materials[s].uniforms.uMouseSync&&(this.materials[s].uniforms.uMouseSync.value=a.detail.sync)},window.addEventListener("cymaticsToggleMouseSync",this._boundCymaticsToggleMouseSync),setTimeout(()=>{this.setPattern(this.activeClassId,this.activeVariationId)},50)}setPattern(e,t,i=!1){if(this.activeClassId!==e&&this.textureCache){for(const a in this.textureCache)this.textureCache[a]&&this.textureCache[a].dispose();if(this.textureCache={},this.dummyTexture)for(let a=1;a<=25;a++)this.materials[a]&&(this.materials[a].uniforms.uTexture&&(this.materials[a].uniforms.uTexture.value=this.dummyTexture),this.materials[a].uniforms.uTexture2&&(this.materials[a].uniforms.uTexture2.value=this.dummyTexture),this.materials[a].uniforms.uTexture3&&(this.materials[a].uniforms.uTexture3.value=this.dummyTexture))}if(this.activeClassId=e,this.activeVariationId=t,this.meshes.forEach((a,s)=>{a.visible=s+1===e,s+1===25?(a.rotation.x=-Math.PI/3,a.position.y=-2,a.position.z=-10):(a.rotation.x=0,a.position.y=0,a.position.z=-1)}),this.materials[e]){this.materials[e].uniforms.uVariation.value=t;let a=t;if(e===22&&(a=t%14),e>=17&&e<=23&&this.materials[e].defines.VARIATION!==a&&(this._shaderCompileTimeout&&clearTimeout(this._shaderCompileTimeout),this._shaderCompileTimeout=setTimeout(()=>{this.activeVariationId===t&&this.activeClassId===e&&(this.materials[e].defines.VARIATION=a,this.materials[e].needsUpdate=!0,this.materials[e].uniforms.uSpawnTime&&(this.materials[e].uniforms.uSpawnTime.value=performance.now()*.001%(2e3*Math.PI)))},300)),!i&&ge[e]&&ge[e][t]){const s=ge[e][t];this.materials[e].uniforms.uColor1.value.setHex(s[0]),this.materials[e].uniforms.uColor2.value.setHex(s[1]);try{window.dispatchEvent(new CustomEvent("cymaticColorSync",{detail:{classId:e,color1:"#"+s[0].toString(16).padStart(6,"0"),color2:"#"+s[1].toString(16).padStart(6,"0")}}))}catch{}}if(e===22){const s=["binaural-assets/images/cymatics/cymatics_fractal_heart_1779756441610.png","binaural-assets/images/cymatics/cymatics_fluid_sdf_1779756501734.png","binaural-assets/images/cymatics/cymatics_particle_swarm_1779756471939.png","binaural-assets/images/cymatics/cymatics_quantum_topology_1779756531135.png","binaural-assets/images/cymatics/ai_cymatic_15_1779566362935.png","binaural-assets/images/cymatics/ai_cymatic_16_1779566377245.png","binaural-assets/images/cymatics/cymatic_sacred_gold_obsidian.png","binaural-assets/images/cymatics/cymatic_biolum_abyssal.png","binaural-assets/images/cymatics/ai_cymatic_0.png","binaural-assets/images/cymatics/ai_cymatic_1.png","binaural-assets/images/cymatics/ai_cymatic_2.png","binaural-assets/images/cymatics/ai_cymatic_3.png","binaural-assets/images/cymatics/ai_cymatic_4.png","binaural-assets/images/cymatics/ai_cymatic_5.png","binaural-assets/images/cymatics/ai_cymatic_6.png","binaural-assets/images/cymatics/ai_cymatic_7.png","binaural-assets/images/cymatics/ai_cymatic_8.png","binaural-assets/images/cymatics/ai_cymatic_9.png","binaural-assets/images/cymatics/ai_cymatic_10.png","binaural-assets/images/cymatics/ai_cymatic_11.png","binaural-assets/images/cymatics/ai_cymatic_12.png","binaural-assets/images/cymatics/ai_cymatic_13.png","binaural-assets/images/cymatics/ai_cymatic_14.png","binaural-assets/images/cymatics/ai_cymatic_15.png","binaural-assets/images/cymatics/ai_cymatic_16.png","binaural-assets/images/cymatics/ai_cymatic_0.png","binaural-assets/images/cymatics/ai_cymatic_1.png","binaural-assets/images/cymatics/ai_cymatic_2.png","binaural-assets/images/cymatics/ai_cymatic_3.png","binaural-assets/images/cymatics/ai_cymatic_4.png"];s[t]&&(this.textureCache||(this.textureCache={}),this.textureCache[t]?this.materials[e].uniforms.uTexture.value=this.textureCache[t]:new oe().load(s[t],n=>{n.generateMipmaps=!1,n.minFilter=se,this.textureCache[t]=n,this.activeClassId===e&&this.activeVariationId===t&&(this.materials[e].uniforms.uTexture.value=n)}))}else if(e===23){const s=["binaural-assets/images/cymatics/ai_cymatic_5.png","binaural-assets/images/cymatics/ai_cymatic_6.png","binaural-assets/images/cymatics/ai_cymatic_7.png","binaural-assets/images/cymatics/ai_cymatic_8.png"];if(s[t]){this.textureCache||(this.textureCache={});const o="c23_"+t;this.textureCache[o]?this.materials[e].uniforms.uTexture.value=this.textureCache[o]:new oe().load(s[t],l=>{l.generateMipmaps=!1,l.minFilter=se,l.wrapS=ce,l.wrapT=ce,this.textureCache[o]=l,this.activeClassId===e&&this.activeVariationId===t&&(this.materials[e].uniforms.uTexture.value=l)})}}else if(e===24){const s=["binaural-assets/images/cymatics/ai_cymatic_9.png","binaural-assets/images/cymatics/ai_cymatic_10.png","binaural-assets/images/cymatics/ai_cymatic_11.png","binaural-assets/images/cymatics/ai_cymatic_12.png","binaural-assets/images/cymatics/ai_cymatic_13.png","binaural-assets/images/cymatics/ai_cymatic_14.png","binaural-assets/images/cymatics/ai_cymatic_15.png","binaural-assets/images/cymatics/ai_cymatic_16.png","binaural-assets/images/cymatics/ai_cymatic_0.png","binaural-assets/images/cymatics/ai_cymatic_1.png","binaural-assets/images/cymatics/constellations/aura_shark_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_2.png","binaural-assets/images/cymatics/ai_cymatic_3.png","binaural-assets/images/cymatics/ai_cymatic_4.png","binaural-assets/images/cymatics/constellations/aura_salmon_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_5.png","binaural-assets/images/cymatics/ai_cymatic_6.png","binaural-assets/images/cymatics/constellations/aura_leopard_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_7.png","binaural-assets/images/cymatics/ai_cymatic_8.png","binaural-assets/images/cymatics/ai_cymatic_9.png","binaural-assets/images/cymatics/constellations/aura_koala_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_10.png","binaural-assets/images/cymatics/ai_cymatic_11.png","binaural-assets/images/cymatics/ai_cymatic_12.png","binaural-assets/images/cymatics/constellations/aura_lizard_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_13.png","binaural-assets/images/cymatics/ai_cymatic_14.png","binaural-assets/images/cymatics/ai_cymatic_15.png","binaural-assets/images/cymatics/ai_cymatic_16.png","binaural-assets/images/cymatics/ai_cymatic_0.png","binaural-assets/images/cymatics/ai_cymatic_1.png","binaural-assets/images/cymatics/ai_cymatic_2.png"],o=["binaural-assets/images/cymatics/ai_cymatic_3.png","binaural-assets/images/cymatics/ai_cymatic_4.png","binaural-assets/images/cymatics/ai_cymatic_5.png"],n=["binaural-assets/images/cymatics/ai_cymatic_6.png","binaural-assets/images/cymatics/ai_cymatic_7.png","binaural-assets/images/cymatics/ai_cymatic_8.png","binaural-assets/images/cymatics/ai_cymatic_9.png","binaural-assets/images/cymatics/ai_cymatic_10.png","binaural-assets/images/cymatics/ai_cymatic_11.png","binaural-assets/images/cymatics/constellations/horse_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_12.png","binaural-assets/images/cymatics/constellations/cat_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_13.png","binaural-assets/images/cymatics/constellations/shark_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_14.png","binaural-assets/images/cymatics/constellations/orca_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_15.png","binaural-assets/images/cymatics/constellations/salmon_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_16.png","binaural-assets/images/cymatics/constellations/alligator_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_0.png","binaural-assets/images/cymatics/constellations/panther_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_1.png","binaural-assets/images/cymatics/constellations/mongoose_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_2.png","binaural-assets/images/cymatics/constellations/panda_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_3.png","binaural-assets/images/cymatics/constellations/monkey_constellation_dummy.webp","binaural-assets/images/cymatics/ai_cymatic_4.png","binaural-assets/images/cymatics/constellations/dog_constellation_dummy.webp"];let l=this.activeAuraId!==void 0?this.activeAuraId:t;if(s[l]){const c="c24_aura_"+l;this.textureCache||(this.textureCache={}),this.textureCache[c]?this.materials[e].uniforms.uTexture.value=this.textureCache[c]:new oe().load(s[l],r=>{r.generateMipmaps=!1,r.minFilter=se,this.textureCache[c]=r;let u=this.activeAuraId!==void 0?this.activeAuraId:this.activeVariationId;this.activeClassId===e&&u===l&&(this.materials[e].uniforms.uTexture.value=r)})}let d=this.activeLinesId!==void 0?this.activeLinesId:l;if(n[d]){const c="c24_lines_"+d;this.textureCache||(this.textureCache={}),this.textureCache[c]?this.materials[e].uniforms.uTexture3.value=this.textureCache[c]:new oe().load(n[d],r=>{r.generateMipmaps=!1,r.minFilter=se,this.textureCache[c]=r;let u=this.activeLinesId!==void 0?this.activeLinesId:this.activeAuraId!==void 0?this.activeAuraId:this.activeVariationId;this.activeClassId===e&&u===d&&(this.materials[e].uniforms.uTexture3.value=r)})}else this.materials[e].uniforms.uTexture3.value=this.dummyTexture;let p=this.activeBackgroundId||0;if(o[p]){const c="c24_bg_"+p;this.textureCache||(this.textureCache={}),this.textureCache[c]?this.materials[e].uniforms.uTexture2.value=this.textureCache[c]:new oe().load(o[p],r=>{r.generateMipmaps=!1,r.minFilter=se,r.wrapS=ce,r.wrapT=ce,this.textureCache[c]=r;let u=this.activeBackgroundId||0;this.activeClassId===e&&u===p&&(this.materials[e].uniforms.uTexture2.value=r)})}}this.materials[e]&&this.materials[e].uniforms.uMouseSync&&(this.materials[e].uniforms.uMouseSync.value=window.cymaticsMouseSync||0)}}setConstellationBackground(e){this.activeBackgroundId=e,this.activeClassId===24&&this.setPattern(24,this.activeVariationId,!0)}setConstellationLines(e){this.activeLinesId=e,this.activeClassId===24&&this.setPattern(24,this.activeVariationId,!0)}setConstellationAura(e){this.activeAuraId=e,this.activeClassId===24&&this.setPattern(24,this.activeVariationId,!0)}setConstellationLayer2Type(e){this.setConstellationLines(parseInt(e))}setColor(e,t,i){if(this.materials[e]){const a=t===1?"uColor1":"uColor2";this.materials[e].uniforms[a].value.set(i)}}setParam(e,t,i){this.materials[e]&&(t==="intensity"?this.materials[e].uniforms.uIntensity.value=i:t==="speed"&&this.materials[e].uniforms.uSpeed?this.materials[e].uniforms.uSpeed.value=i:t==="harmonics"&&this.materials[e].uniforms.uHarmonics?this.materials[e].uniforms.uHarmonics.value=i:this.materials[e].uniforms[`u${t.charAt(0).toUpperCase()+t.slice(1)}`]&&(this.materials[e].uniforms[`u${t.charAt(0).toUpperCase()+t.slice(1)}`].value=i))}update(e,t,i){if(this.materials[this.activeClassId]){if(this.materials[this.activeClassId].uniforms.uTime.value=e,this.materials[this.activeClassId].uniforms.uAspect.value=window.innerWidth/(window.innerHeight||1),t){let a=window.cymaticsAudioSync!==void 0?window.cymaticsAudioSync:1;this.materials[this.activeClassId].uniforms.uAudioLow.value=(t.bass||0)*a,this.materials[this.activeClassId].uniforms.uAudioMid.value=(t.mids||0)*a,this.materials[this.activeClassId].uniforms.uAudioHigh.value=(t.highs||0)*a}if(i&&this.materials[this.activeClassId].uniforms.uMouse.value.set(i.x||0,i.y||0),this.rainbowMode){const a=e*.1%1,s=(a+.5)%1;this.materials[this.activeClassId].uniforms.uColor1.value.setHSL(a,1,.6),this.materials[this.activeClassId].uniforms.uColor2.value.setHSL(s,1,.6)}}if(this.crossfadeData&&this.crossfadeData.active){let a=e-this.crossfadeData.startTime,s=Math.min(1,a/this.crossfadeData.duration);this.materials[this.crossfadeData.nextId]&&(this.materials[this.crossfadeData.nextId].uniforms.uAlpha.value=s),this.materials[this.crossfadeData.prevId]&&(this.materials[this.crossfadeData.prevId].uniforms.uAlpha.value=1-s),s>=1&&(this.crossfadeData.active=!1,this.activeClassId=this.crossfadeData.nextId)}}dispose(){if(this._boundCymaticsToggleMouseSync&&window.removeEventListener("cymaticsToggleMouseSync",this._boundCymaticsToggleMouseSync),this.dummyTexture&&(this.dummyTexture.dispose(),this.dummyTexture=null),this.meshes.forEach(e=>{e.geometry&&e.geometry.dispose(),this.group.remove(e)}),this.materials){for(const e in this.materials)this.materials[e]&&this.materials[e].dispose();this.materials={}}if(this.textureCache){for(const e in this.textureCache)this.textureCache[e]&&this.textureCache[e].dispose();this.textureCache={}}this.meshes=[],this.materials={}}setConstellationLinesToggle(e){this.materials[24]&&(this.materials[24].uniforms.uShowLines.value=e?1:0)}setRainbow(e){this.rainbowMode=e,e||this.setPattern(this.activeClassId,this.activeVariationId,!1)}}let v=null;class Ge{constructor(e,t={}){this.canvas=e,this.activeModes=t.activeModes||new Set(["cymatics"]),this.mode=t.mode||"none",this.mindWaveMode=t.mindWaveMode!==void 0?t.mindWaveMode:!0,this.galaxySunStyle=t.galaxySunStyle||"sun",this.cymaticClass=t.cymaticClass!==void 0?t.cymaticClass:22,this.cymaticVariation=t.cymaticVariation!==void 0?t.cymaticVariation:0,this.cymaticColors=t.cymaticColors||["#EEA0EB","#FFB1A3"],this.snowSizeOverride=t.snowSizeOverride!==void 0?t.snowSizeOverride:.5,this.currentCymaticData={name:"Fractal Heart",n:1,m:1,energy:.2},this.cymaticsHistory=[],this.cymaticsHistoryIndex=-1,this._cymaticDriftOffset=Math.random()*1e3,this.cyberConfig={logicMode:t.cyberLogicMode||"matrix",customText:t.cyberCustomText||"WELCOME",angle:t.cyberAngle||0,speed:t.cyberSpeedMultiplier||1,length:1,color:"#00FF41",rainbow:!0},this.matrixConfig={logicMode:t.matrixLogicMode||"interstellar",customText:t.matrixCustomText||"MINDWAVE",angle:0,speed:1,length:1,color:"#00FF41",rainbow:!1},this.initialized=!1,this._rainbowEnabled=t.rainbowEnabled||!1,this.isVisualizer3D=!0,this.overlayCanvas=document.getElementById("cyberCanvas"),this.overlayCtx=this.overlayCanvas?this.overlayCanvas.getContext("2d",{alpha:!0}):null,this.overlayCanvas&&(this.resizeOverlayCanvas(),window.addEventListener("resize",()=>this.resizeOverlayCanvas())),this.matrixCyberStreams=[],this.currentCyberAngle=t.cyberAngle!==void 0?t.cyberAngle:0,this.cyberColorCustomized=!1;try{const a=localStorage.getItem("cyberThemeHistory");this.themeHistory=a?JSON.parse(a):[],this.lastCyberFamily=localStorage.getItem("cyberLastFamily")||""}catch{this.themeHistory=[],this.lastCyberFamily=""}this.currentLogoOpacity=.8,this.targetLogoOpacity=.8,v=this,this.themeType=document.body.dataset.themeType||"dark";const i=/Mobile|Android|iPhone|iPad/i.test(navigator.userAgent);this.batterySaver=t.batterySaver!==void 0?t.batterySaver:i,this.isLowPower=this.batterySaver||localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode"),this.isLowPower=t.isLowPower||!1,this.targetFPS=this.isLowPower?30:60,this.audioSensitivity=1,this.geoComplexity=1,this.cameraPitch=0,this.cameraYaw=0,this.cameraRoll=0,this.vibrationEnabled=typeof g<"u"&&g.visualVibration!==void 0?g.visualVibration:t.visualVibration!==void 0?t.visualVibration:!1,this._fpsRingBuffer=new Float64Array(60),this._fpsRingIndex=0,this._fpsRingCount=0,this.lastLodDegradation=0,this.currentLodLevel="high",this._tempColor=new T,this._logoRenderCanvas=null,this.sphereGroup=new F,this.particleGroup=new F,this.lightspeedGroup=new F,this.lavaGroup=new F,this.fireplaceGroup=new F,this.rainforestGroup=new F,this.zenGardenGroup=new F,this.oceanGroup=new F,this.wavesGroup=new F,this.cyberGroup=new F,this.boxGroup=new F,this.dragonGroup=new F,this.galaxyGroup=new F,this.mandalaGroup=new F,this.cymaticsGroup=new F,this.snowflakeGroup=new F,this.tsunamiGroup=new F,this._snowData=null;try{this.scene=new Ue,this.cymaticsCore=new rt(this.cymaticsGroup),this.cymaticsCore.setPattern(this.cymaticClass,this.cymaticVariation),this.cymaticsCore.setColor(this.cymaticClass,1,this.cymaticColors[0]),this.cymaticsCore.setColor(this.cymaticClass,2,this.cymaticColors[1]),[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup,this.tsunamiGroup].forEach(o=>this.scene.add(o)),this.camera=new Be(75,e.width/e.height,.1,1e3),this.renderer=new We({canvas:e,alpha:!0,antialias:!0,preserveDrawingBuffer:!0}),this.renderer.autoClear=!1,this.renderer.setClearColor(0,0),this.renderer.setSize(e.clientWidth,e.clientHeight);const s=this.isLowPower?1:2;this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,s)),this.textures={},this.customColors={},this.customColor=null,this._isRendering=!1,this._freqDataArray=null,this.initEnvironment(),this.camera.position.z=5,this.handleLayoutChange=this.handleLayoutChange.bind(this),window.addEventListener("resize",()=>{this.resize(),this.handleLayoutChange()}),window.addEventListener("mindwave:layout-change",this.handleLayoutChange),this._boundSafeMode=()=>{this.currentLodLevel!=="low"&&(this.degradeLOD(),this.degradeLOD())},window.addEventListener("mindwave:safe-mode-start",this._boundSafeMode),this._boundVisibilityChange=()=>{document.hidden||(this.lastTime=performance.now()*.001,this.active!==!1&&this.initialized&&this.render(g.masterAnalyser||g.analyserLeft,g.analyserRight))},document.addEventListener("visibilitychange",this._boundVisibilityChange),this._boundContextLost=o=>{o.preventDefault(),this.active=!1,g.animationId&&(cancelAnimationFrame(g.animationId),g.animationId=null)},e.addEventListener("webglcontextlost",this._boundContextLost),this._boundContextRestored=()=>{try{this.initialized=!1,this._freqDataArray=null,this.initEnvironment(),this.cameraPitch=0,this.cameraYaw=0,this.cameraRoll=0,this.updateCameraRotation(),typeof window.resetCameraControls=="function"&&window.resetCameraControls(),this.updateVisibility(),this.initialized=!0,this.active=!0,this.lastTime=performance.now()*.001,g.animationId&&cancelAnimationFrame(g.animationId),this._isRendering=!1,this.render(g.masterAnalyser||g.analyserLeft,g.analyserRight)}catch{}},e.addEventListener("webglcontextrestored",this._boundContextRestored),this._boundCymaticPointer=o=>{const n=o.touches?o.touches[0].clientX:o.clientX,l=o.touches?o.touches[0].clientY:o.clientY;this.mouseX=n/window.innerWidth*2-1,this.mouseY=-(l/window.innerHeight)*2+1},window.addEventListener("mousemove",this._boundCymaticPointer),window.addEventListener("touchmove",this._boundCymaticPointer,{passive:!0}),this.resize(),setTimeout(this.handleLayoutChange,100),this._boundThemeChange=o=>{if(o.detail&&o.detail.type){const n=o.detail.type;this.themeType!==n&&(this.themeType=n,this.updateLogoTexture())}},window.addEventListener("themeChanged",this._boundThemeChange),this.speedMultiplier=1,this.brightnessMultiplier=1,this.lastTime=performance.now()*.001,this.simTime=0,this.targetFPS=60,this.lastFrameRenderTime=0,this.active=!0,this.updateVisibility(),this.initialized=!0,this.initOverlayLogo(),window.viz3D=this}catch{this.initialized=!1}}setCameraRotation(e,t,i){this.cameraPitch=e,this.cameraYaw=t,this.cameraRoll=i,this.updateCameraRotation()}updateCameraRotation(){this.scene.rotation.set(this.cameraPitch,this.cameraYaw,this.cameraRoll)}setAudioSensitivity(e){this.audioSensitivity=parseFloat(e)}setGeoComplexity(e){this.geoComplexity=parseFloat(e)}resize(){if(!this.renderer||!this.canvas||!this.camera)return;const e=window.innerWidth,t=window.innerHeight;this.renderer.setSize(e,t),this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.postProcessor&&this.postProcessor.resize(e,t),this.handleLayoutChange()}handleLayoutChange(){!this.renderer||!this.camera||this.camera.clearViewOffset()}resizeOverlayCanvas(){this.overlayCanvas&&(this.overlayCanvas.width=window.innerWidth,this.overlayCanvas.height=window.innerHeight)}captureSnapshot(){if(!this.canvas)return;typeof g<"u"&&this.active!==!1&&this.initialized?this.render(g.masterAnalyser||g.analyserLeft,g.analyserRight):this.renderer.render(this.scene,this.camera);const e=this.canvas.toDataURL("image/png",1),t=document.createElement("a");return t.download=`Mindwave-Snapshot-${new Date().toISOString().replace(/[:.]/g,"-")}.png`,t.href=e,document.body.appendChild(t),t.click(),document.body.removeChild(t),e}startRecording(){if(!this.canvas||this.mediaRecorder&&this.mediaRecorder.state==="recording")return!1;try{const e=this.canvas.captureStream(60),t={mimeType:"video/webm; codecs=vp9"};return MediaRecorder.isTypeSupported(t.mimeType)||(t.mimeType="video/webm; codecs=vp8",MediaRecorder.isTypeSupported(t.mimeType)||(t.mimeType="video/webm")),this.recordedChunks=[],this.mediaRecorder=new MediaRecorder(e,t),this.mediaRecorder.ondataavailable=i=>{i.data.size>0&&this.recordedChunks.push(i.data)},this.mediaRecorder.onstop=()=>{const i=new Blob(this.recordedChunks,{type:t.mimeType}),a=URL.createObjectURL(i),s=document.createElement("a");s.download=`Mindwave-Visuals-${new Date().toISOString().replace(/[:.]/g,"-")}.webm`,s.href=a,document.body.appendChild(s),s.click(),document.body.removeChild(s),setTimeout(()=>URL.revokeObjectURL(a),100)},this.mediaRecorder.start(1e3),!0}catch{return!1}}stopRecording(){return this.mediaRecorder&&this.mediaRecorder.state==="recording"?(this.mediaRecorder.stop(),!0):!1}generateCyberStyle(){const e=this.overlayCanvas,t=this.overlayCtx;if(!e||!t)return;this.matrixCyberStreams=[];const i=Math.max(11,Math.min(21,Math.floor(e.width/50)));this.isLowPower=localStorage.getItem("mindwave_battery_saver")==="true"||document.body.classList.contains("system-stability-mode");let a=Math.ceil(e.width/i);this.isLowPower||(a*=1.5);let s=window.getCurrentTheme?window.getCurrentTheme():{color:"#2dd4bf"};this.resizeOverlayCanvas(),this.cyberColorCustomized=!1;const o=[{name:"System Yellow",color:"#FFFF00",family:"yellow"},{name:"Neon Pink",color:"#FF1493",family:"pink"},{name:"Chrome Static",color:"#C0C0C0",family:"mono"},{name:"Royal Data",color:"#4169E1",family:"blue"},{name:"White Noise",color:"#FFFFFF",family:"mono"},{name:"Cyan Future",color:"#00FFFF",family:"blue"},{name:"Lime Access",color:"#32CD32",family:"green"},{name:"Purple Haze",color:"#800080",family:"purple"},{name:"Emerald Link",color:"#50C878",family:"green"},{name:"Ice Blue",color:"#A5F2F3",family:"blue"},{name:"sentAIent Blue",color:"#60A9FF",family:"blue"},{name:"Rainbow Surge",color:"rainbow",family:"rainbow"}],n=this.lastCyberFamily||"";let l=o.filter(r=>!this.themeHistory.includes(r.name));const d=l.filter(r=>r.family!==n);d.length>0&&(l=d);let p=l;if(p.length===0){const r=this.themeHistory[this.themeHistory.length-1];p=o.filter(u=>u.name!==r)}const c=p[Math.floor(Math.random()*p.length)];this.themeHistory.push(c.name),this.themeHistory.length>5&&this.themeHistory.shift(),this.lastCyberFamily=c.family;try{localStorage.setItem("cyberThemeHistory",JSON.stringify(this.themeHistory)),localStorage.setItem("cyberLastFamily",this.lastCyberFamily)}catch{}this.cyberSpeedMultiplier===void 0&&(this.cyberSpeedMultiplier=.2),this.cyberLengthMultiplier===void 0&&(this.cyberLengthMultiplier=.7);const m=document.getElementById("cyberRainbowToggle");if(m&&this.cyberRainbowMode===void 0&&(this.cyberRainbowMode=!0,this.cyberConfig.rainbow=!0,m.checked=!0),!this.cyberRainbowMode&&s.color!=="rainbow"){this.cyberColor=s.color;const r=document.getElementById("cyberColorPicker");r&&(r.value=this.cyberColor)}for(let r=0;r<a;r++){const u=Math.random(),x=Math.floor(8+u*11),I=(2+u*8+Math.random()*2)*this.cyberSpeedMultiplier;this.matrixCyberStreams.push({x:r*i,y:Math.random()*this.overlayCanvas.height*1.5-this.overlayCanvas.height*.5,baseSpeed:I,opacity:.2+u*.8,size:x,chars:[],color:s.color!=="rainbow"?s.color:"#FFFFFF"})}this.updateCyberStrings(),this.matrixCyberStreams.sort((r,u)=>r.size-u.size)}renderCyberCyber(){const e=this.activeModes.has("cyber");if(!this.overlayCtx||!this.matrixCyberStreams||!e)return;const t=this.overlayCtx,i=this.overlayCanvas;t.clearRect(0,0,i.width,i.height);const a=this.activeModes.size>1;t.fillStyle=a?"rgba(0, 0, 0, 0.4)":"rgba(0, 0, 0, 0.85)",t.fillRect(0,0,i.width,i.height),t.save(),t.textAlign="center";const s=this.cyberConfig,o=s.speed||1,n=s.length||1;s.angle!==0&&(t.translate(i.width/2,i.height/2),t.rotate(s.angle*Math.PI/180),t.translate(-i.width/2,-i.height/2));const l=20,d=Date.now()*.1;t.textBaseline="middle";let p=-1;this.matrixCyberStreams.forEach((c,m)=>{c.y+=c.baseSpeed*o;let r=Math.max(3,Math.floor(l*n));(this.isLowPower||this.currentLodLevel==="low")&&(r=Math.floor(r*.4)),c.y-r*c.size>i.height*1.5&&(c.y=0);const u="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";c.size!==p&&(t.font=`${c.size}px monospace`,p=c.size);const x=this.isLowPower&&this.currentLodLevel==="low"?2:1;for(let I=0;I<r&&I<c.chars.length;I+=x){!c.isTextMode&&Math.random()<.02&&(c.chars[I]=u.charAt(Math.floor(Math.random()*u.length)));const D=c.chars[I],P=c.y-I*c.size;if(P<-c.size*2||P>i.height*1.5)continue;const S=1-I/r,L=Math.pow(S,.4)*(c.opacity*1.2);if(t.globalAlpha=Math.min(1,L),this.cyberRainbowMode){const A=(d+m*15+I*5)%360;t.fillStyle=`hsl(${A}, 100%, 60%)`,m===0&&I===0&&Math.random()<.01}else t.fillStyle=c.color||this.cyberColor,m===0&&I===0&&Math.random()<.01;t.fillText(D,c.x,P)}}),t.shadowBlur=0,t.globalAlpha=1,t.restore()}initSphere(){var o;const e=new fe(2,2),t=new O({color:6334975,wireframe:!0,transparent:!0,opacity:.5});this.sphere=new G(e,t);const i=new fe(1.8,1),a=new O({color:6334975,transparent:!0,opacity:.1,blending:_});this.core=new G(i,a),this.sphereGroup.add(this.sphere),this.sphereGroup.add(this.core),this.sphereGroup.visible=!1;const s=((o=this.customColors)==null?void 0:o.sphere)||this.customColor;s&&(this.sphere.material.color.copy(s),this.core.material.color.copy(s))}initLightspeed(){const t=new N,i=new Float32Array(2e3*3);for(let a=0;a<2e3*3;a++)i[a]=(Math.random()-.5)*80;t.setAttribute("position",new W(i,3)),this.lightspeedMaterial=new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uColor:{value:new T(3003583)},uTexture:{value:this.createCircleTexture()}},vertexShader:`
            ...
            `,transparent:!0,blending:_,depthWrite:!1}),this.lightspeed=new Q(t,this.lightspeedMaterial),this.lightspeedGroup.add(this.lightspeed)}initParticles(){const e=this.batterySaver?400:1e3,t=new N,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*60,i[o+2]=(Math.random()-.5)*80;const n=Math.random();n<.3?(a[o]=.4,a[o+1]=.7,a[o+2]=1):n<.6?(a[o]=.3,a[o+1]=.9,a[o+2]=.95):n<.85?(a[o]=.6,a[o+1]=.4,a[o+2]=1):(a[o]=.9,a[o+1]=.9,a[o+2]=1)}t.setAttribute("position",new W(i,3)),t.setAttribute("color",new W(a,3)),this.particleMaterial=new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uSize:{value:.4},uTexture:{value:this.createCircleTexture()},uIntensity:{value:1}},vertexShader:`
                varying vec3 vColor;
                uniform float uTime, uSpeed;
            ...
            `,transparent:!0,blending:_,depthWrite:!1}),this.particles=new Q(t,this.particleMaterial),this.particleGroup.add(this.particles),this.particleGroup.visible=!1}initBox(){var p;this.boxOuter=new F;const e=new he(new de(3,3,3)),t=new re({color:16777215,transparent:!0,opacity:.9,blending:_}),i=new re({color:3900150,transparent:!0,opacity:.5,blending:_});this.boxOuter.add(new ne(e,t));for(let c=1;c<=3;c++){const m=new ne(e,i);m.scale.setScalar(1+c*.012),this.boxOuter.add(m)}const a=new he(new de(2,2,2)),s=new re({color:14742270,transparent:!0,opacity:.8,blending:_}),o=new re({color:6333946,transparent:!0,opacity:.4,blending:_});this.boxInner=new F,this.boxInner.add(new ne(a,s));for(let c=1;c<=2;c++){const m=new ne(a,o);m.scale.setScalar(1+c*.015),this.boxInner.add(m)}const n=new he(new de(3.05,3.05,3.05)),l=new re({color:9684477,transparent:!0,opacity:.8,blending:_});this.boxEdges=new ne(n,l),this.boxGroup.add(this.boxOuter),this.boxGroup.add(this.boxInner),this.boxGroup.add(this.boxEdges),this.boxGroup.visible=!1;const d=((p=this.customColors)==null?void 0:p.box)||this.customColor;d&&(this.boxOuter.children.forEach(c=>c.material.color.copy(d)),this.boxInner.children.forEach(c=>c.material.color.copy(d)),this.boxEdges&&this.boxEdges.material&&this.boxEdges.material.color.copy(d))}initDragon(){var m;this.dragonDummy=new He,this.dragonLength=80;const e=new fe(.8,1),t=new O({color:15680580,wireframe:!0,transparent:!0,opacity:.8,blending:_}),i=new fe(.5,1),a=new O({color:16096779,wireframe:!1,transparent:!0,opacity:.6,blending:_});this.dragonBodyInstanced=new Se(e,t,this.dragonLength),this.dragonGlowInstanced=new Se(i,a,this.dragonLength);const s=new pe(1.5,3.5,5);s.rotateX(Math.PI/2);const o=new O({color:16638023,wireframe:!0,transparent:!0,opacity:.9,blending:_});this.dragonHead=new G(s,o),this.dragonPearlGroup=new F;const n=new ue(1,16,16),l=new O({color:3718648,wireframe:!1,transparent:!0,opacity:.9,blending:_}),d=new ue(1.3,16,16),p=new O({color:8246268,wireframe:!0,transparent:!0,opacity:.5,blending:_});this.dragonPearl=new G(n,l),this.dragonPearlHalo=new G(d,p),this.dragonPearlGroup.add(this.dragonPearl),this.dragonPearlGroup.add(this.dragonPearlHalo),this.dragonGroup.add(this.dragonBodyInstanced),this.dragonGroup.add(this.dragonGlowInstanced),this.dragonGroup.add(this.dragonHead),this.dragonGroup.add(this.dragonPearlGroup),this.dragonGroup.visible=!1;const c=((m=this.customColors)==null?void 0:m.dragon)||this.customColor;c&&this.updateDragonColor(c)}updateGalaxyColor(e){if(this.galaxySunMesh&&this.galaxySunMesh.traverse(t=>{t.isMesh&&t.material&&t.material.color.copy(e)}),this.galaxyStars&&this.galaxyStars.geometry){const t={};e.getHSL(t);const i=(t.h+.5)%1,a=this.galaxyStars.geometry.getAttribute("color");if(a){const s=a.count,o=this._tempColor;for(let n=0;n<s;n++){const l=n/s,d=l<.2?.8:l<.5?.6:.4+Math.random()*.15,p=.6+Math.random()*.3;o.setHSL(i,p,d),a.setXYZ(n,o.r,o.g,o.b)}a.needsUpdate=!0}}}updateDragonColor(e){if(!this.dragonBodyInstanced)return;this.dragonBodyInstanced.material.color.copy(e),this.dragonHead.material.color.copy(e);const t={};e.getHSL(t);const i=(t.h+.5)%1,a=new T().setHSL(i,t.s,t.l);this.dragonGlowInstanced.material.color.copy(a)}initGalaxy(){const e=this.batterySaver?500:1500,t=new N,i=[],a=[],s=[];for(let l=0;l<e;l++){const d=l/e*Math.PI*10,p=2.5+l/e*20+Math.random()*2,c=l%4*(Math.PI*2/4),m=Math.max(.5,l/e*4),r=Math.cos(d+c)*p+(Math.random()-.5)*m,u=(Math.random()-.5)*1.5,x=Math.sin(d+c)*p+(Math.random()-.5)*m;i.push(r,u,x);const I=l/e;I<.2?a.push(1,.95,.7):I<.5?a.push(.7+Math.random()*.3,.8,1):a.push(.4+Math.random()*.2,.3+Math.random()*.3,.8+Math.random()*.2),s.push(Math.random()<.05?.4+Math.random()*.3:.08+Math.random()*.15)}t.setAttribute("position",new $(i,3)),t.setAttribute("color",new $(a,3)),t.setAttribute("size",new $(s,1));const o=this.createStarTexture(),n=new ve({size:.25,vertexColors:!0,map:o,transparent:!0,opacity:.9,blending:_,depthWrite:!1,sizeAttenuation:!0});this.galaxyStars=new Q(t,n),this.galaxyGroup.add(this.galaxyStars),this.galaxySunStyle=this.galaxySunStyle||"sun",this.createGalaxySun(this.galaxySunStyle),this.galaxyGroup.visible=!1}createGalaxySun(e){this.galaxySunMesh&&(this.galaxyGroup.remove(this.galaxySunMesh),this.galaxySunMesh=null),this.galaxySunMesh=new F;const t=new O({color:4892415,transparent:!0,opacity:.85,blending:_,depthWrite:!1,side:J}),i=new F;if(e==="sun2"){const a=t.clone();a.side=Ne;const s=new Te(1.5,.25,16,64);i.add(new G(s,a));const o=8,n=new pe(.4,2.7,4);n.translate(0,2.7/2,0);const l=new pe(.2,1.7,4);l.translate(0,1.7/2,0);for(let d=0;d<o;d++){const p=d/o*Math.PI*2,c=new G(n,a);c.rotation.z=-p,c.position.set(Math.sin(p)*1.5,Math.cos(p)*1.5,0),i.add(c);const m=p+Math.PI/o,r=new G(l,a);r.rotation.z=-m,r.position.set(Math.sin(m)*1.5,Math.cos(m)*1.5,0),i.add(r)}}else if(e==="sun3"){const a={uTime:{value:0},uLoopTime:{value:0},uColor:{value:t.color},uBassIntt:{value:0}};this.galaxySunUniforms=a;const s=`
                varying vec2 vUv;
            ...
            `,n=new E({vertexShader:s,fragmentShader:o,uniforms:a,transparent:!0,blending:_,depthWrite:!1,side:J}),l=new ue(2,64,64),d=new G(l,n);i.add(d);const p=new O({color:t.color,transparent:!0,opacity:.15,blending:_,depthWrite:!1,side:Xe}),c=new ue(3,32,32);i.add(new G(c,p))}else{const a=new Te(1.5,.12,8,64);i.add(new G(a,t));const s=8;for(let o=0;o<s;o++){const n=o/s*Math.PI*2,l=new Ae;l.moveTo(-.4,0),l.lineTo(.4,0),l.lineTo(0,2.7),l.lineTo(-.4,0);const d=new Ie(l),p=new G(d,t);p.rotation.z=-n,p.position.set(Math.sin(n)*1.5,Math.cos(n)*1.5,0),i.add(p);const c=n+Math.PI/s,m=new Ae;m.moveTo(-.2,0),m.lineTo(.2,0),m.lineTo(0,1.7),m.lineTo(-.2,0);const r=new Ie(m),u=new G(r,t);u.rotation.z=-c,u.position.set(Math.sin(c)*1.5,Math.cos(c)*1.5,0),i.add(u)}}this.galaxySunMesh.add(i),this.galaxySunMesh.position.set(0,0,.1),this.galaxyGroup.add(this.galaxySunMesh)}setGalaxySunStyle(e){e!=="sun"&&e!=="sun2"&&e!=="sun3"||(this.galaxySunStyle=e,this.galaxyGroup&&this.galaxyGroup.children.length>0&&this.createGalaxySun(e))}setGalaxySunRotation(e,t){e==="x"&&(this.sunRotationSpeedX=parseFloat(t)),e==="y"&&(this.sunRotationSpeedY=parseFloat(t)),e==="z"&&(this.sunRotationSpeedZ=parseFloat(t))}createStarTexture(){if(this.textures.star)return this.textures.star;const e=64,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e);const o=i.createRadialGradient(a,s,0,a,s,e/2);return o.addColorStop(0,"rgba(255, 255, 255, 1.0)"),o.addColorStop(.1,"rgba(255, 255, 240, 0.8)"),o.addColorStop(.25,"rgba(255, 255, 200, 0.3)"),o.addColorStop(.5,"rgba(200, 200, 255, 0.1)"),o.addColorStop(1,"rgba(100, 100, 255, 0)"),i.fillStyle=o,i.fillRect(0,0,e,e),i.fillStyle="rgba(255, 255, 255, 0.6)",i.beginPath(),i.moveTo(0,s-1),i.lineTo(a,s-.5),i.lineTo(e,s-1),i.lineTo(e,s+1),i.lineTo(a,s+.5),i.lineTo(0,s+1),i.closePath(),i.fill(),i.beginPath(),i.moveTo(a-1,0),i.lineTo(a-.5,s),i.lineTo(a-1,e),i.lineTo(a+1,e),i.lineTo(a+.5,s),i.lineTo(a+1,0),i.closePath(),i.fill(),i.beginPath(),i.arc(a,s,2,0,Math.PI*2),i.fillStyle="rgba(255, 255, 255, 1.0)",i.fill(),this.textures.star=new le(t),this.textures.star}initMandala(){var s;this.mandalaRings=[];const e=[2450411,15357964,3900150,16347926,12573694];for(let o=0;o<5;o++){const n=1.2+o*.8,l=6+o*6,d=new Ye(n-.05,n+.05,l),p=new O({color:e[o],side:J,transparent:!0,opacity:.4-o*.05,blending:_}),c=new G(d,p);c.userData={speed:(.01+o*.005)*(o%2===0?1:-1),segments:l},this.mandalaRings.push(c),this.mandalaGroup.add(c)}const t=new je(.3,32),i=new O({color:16347926,transparent:!0,opacity:.6,blending:_});this.mandalaCenter=new G(t,i),this.mandalaGroup.add(this.mandalaCenter),this.mandalaGroup.visible=!1;const a=(s=this.customColors)==null?void 0:s.mandala;a&&(this.mandalaRings.forEach(o=>o.material.color.copy(a)),this.mandalaCenter.material.color.copy(a))}createSnowflakeTexture(){if(this.textures.snowflake)return this.textures.snowflake;const e=128,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d"),a=e/2,s=e/2;i.clearRect(0,0,e,e),i.strokeStyle="rgba(220,240,255,1.0)",i.lineCap="round";for(let o=0;o<6;o++){const n=o/6*Math.PI*2;i.save(),i.translate(a,s),i.rotate(n),i.lineWidth=2.5,i.beginPath(),i.moveTo(0,0),i.lineTo(0,-52),i.stroke();const l=[{d:18,len:14,angle:Math.PI/4},{d:32,len:20,angle:Math.PI/4},{d:46,len:10,angle:Math.PI/5}];i.lineWidth=1.5,l.forEach(({d,len:p,angle:c})=>{[1,-1].forEach(m=>{i.beginPath(),i.moveTo(0,-d),i.lineTo(m*p*Math.cos(Math.PI/2-c),-d-p*Math.sin(Math.PI/2-c)),i.stroke()})}),i.restore()}i.beginPath();for(let o=0;o<6;o++){const n=o/6*Math.PI*2-Math.PI/6,l=a+Math.cos(n)*4,d=s+Math.sin(n)*4;o===0?i.moveTo(l,d):i.lineTo(l,d)}return i.closePath(),i.fillStyle="rgba(255, 255, 255, 0.8)",i.fill(),this.textures.snowflake=new le(t),this.textures.snowflake}setTsunamiKanagawa(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uKanagawa.value=e)}setTsunamiAmplitude(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uAmplitude.value=parseFloat(e)),this.tsunamiAnimState&&this.tsunamiAnimState.active&&(this.tsunamiAnimState.startAmp=parseFloat(e),this.tsunamiAnimState.phase=0)}setTsunamiCurl(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uCurl.value=parseFloat(e)),this.tsunamiAnimState&&this.tsunamiAnimState.active&&(this.tsunamiAnimState.startCurl=parseFloat(e),this.tsunamiAnimState.phase=0)}setTsunamiMist(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uMist.value=parseFloat(e));let t=parseFloat(e),i=Math.max(Math.min(t,1),0),a=Math.max(Math.min(1-t*2,1),0);this.tsunamiSun&&this.tsunamiSun.material&&(this.tsunamiSun.material.opacity=i,this.tsunamiSun.material.uniforms&&this.tsunamiSun.material.uniforms.uMist&&(this.tsunamiSun.material.uniforms.uMist.value=t)),this.tsunamiMoon&&this.tsunamiMoon.material&&this.tsunamiMoon.material.uniforms&&(this.tsunamiMoon.material.uniforms.uOpacity.value=a)}setTsunamiMoonPhase(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&this.tsunamiMaterial.uniforms.uMoonPhase&&(this.tsunamiMaterial.uniforms.uMoonPhase.value=parseFloat(e)),this.tsunamiMoon&&this.tsunamiMoon.material&&this.tsunamiMoon.material.uniforms&&(this.tsunamiMoon.material.uniforms.uMoonPhase.value=parseFloat(e))}setTsunamiStyle(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uStyle.value=parseFloat(e))}setTsunamiReactivity(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uReactivity.value=parseFloat(e))}setTsunamiLoop(e){this.tsunamiMaterial&&this.tsunamiMaterial.uniforms&&(this.tsunamiMaterial.uniforms.uLoopActive.value=e?1:0),this.tsunamiAnimState||(this.tsunamiAnimState={active:!1,phase:0,startAmp:1,startCurl:1}),this.tsunamiAnimState.active=e,e&&(this.tsunamiAnimState.phase=0,this.tsunamiAnimState.startAmp=this.tsunamiMaterial?this.tsunamiMaterial.uniforms.uAmplitude.value:1,this.tsunamiAnimState.startCurl=this.tsunamiMaterial?this.tsunamiMaterial.uniforms.uCurl.value:1)}initTsunami(){if(!this.tsunamiGroup)return;this.tsunamiGroup.clear();const e=new te(4e3,250,1500,300);e.translate(1500,0,0);const t={uTime:{value:0},uLoopTime:{value:0},uNormBass:{value:0},uColor:{value:new T(775123)},uHasCustomColor:{value:0},uSecondaryColor:{value:new T(27028)},uDeepColor:{value:new T(23477)},uFoamColor:{value:new T(16777215)},uSunColor:{value:new T(16770457)},uAmplitude:{value:2.2},uCurl:{value:2.4},uMist:{value:1},uMoonPhase:{value:0},uStyle:{value:1},uReactivity:{value:2},uLoopActive:{value:0},uKanagawa:{value:0},uWaveOffset:{value:0}},i=`
            varying vec2 vUv;
        ...
        `,s=new E({vertexShader:i,fragmentShader:a,uniforms:t,transparent:!0,side:J,wireframe:!1});this.tsunamiMaterial=s;const o=new G(e,s);o.rotation.x=-Math.PI/2,o.position.y=-40,o.position.z=-50,o.position.x=0,o.frustumCulled=!1,this.tsunamiGroup.add(o);const l="data:image/svg+xml;charset=utf-8,"+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
            <g>
        ...
        </svg>`),d=new oe().load(l),p=new Ke({map:d,color:16777215,transparent:!0,depthWrite:!1,fog:!1});this.tsunamiSun=new Ze(p),this.tsunamiSun.scale.set(60,60,1),this.tsunamiSun.position.set(70,50,-120),this.tsunamiSun.material.uniforms={uMist:{value:1}},this.tsunamiGroup.add(this.tsunamiSun);const c=`
            varying vec2 vUv;
            void main() {
                vUv = uv;
        ...
        `,r=new E({vertexShader:c,fragmentShader:m,uniforms:{uMoonPhase:{value:1},uOpacity:{value:0}},transparent:!0,depthWrite:!1}),u=new te(100,100);this.tsunamiMoon=new G(u,r),this.tsunamiMoon.position.set(70,50,-120),this.tsunamiGroup.add(this.tsunamiMoon)}initSnowflake(){for(;this.snowflakeGroup.children.length>0;){const r=this.snowflakeGroup.children[0];this.snowflakeGroup.remove(r),r.geometry&&r.geometry.dispose(),r.material&&r.material.dispose()}this._snowData=null;const e=this.snowCount||200,t=new Float32Array(e*3),i=new Float32Array(e),a=new Float32Array(e),s=new Float32Array(e),o=new Float32Array(e),n=new Float32Array(e),l=new Float32Array(e);for(let r=0;r<e;r++){const u=r*3;t[u]=(Math.random()-.5)*80,t[u+1]=(Math.random()-.5)*60,t[u+2]=-40+Math.random()*35;const x=(t[u+2]+40)/35;i[r]=1.5+x*8,a[r]=.2+x*.6,s[r]=Math.random()*Math.PI*2,o[r]=.015+Math.random()*.04+x*.03,n[r]=.01+Math.random()*.02,l[r]=.4+Math.random()*.8}const d=new N;d.setAttribute("position",new W(t,3)),d.setAttribute("aSize",new W(i,1)),d.setAttribute("aOpacity",new W(a,1));const p=this.createSnowflakeTexture(),c=new E({uniforms:{uTexture:{value:p},uColor:{value:this.customColor?this.customColor.clone():new T(10875883)},uIntensity:{value:0},uSizeMultiplier:{value:this.snowSizeOverride},uGlowAmount:{value:.5}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:_}),m=new Q(d,c);this.snowflakeGroup.add(m),this._snowData={count:e,positions:t,phases:s,speeds:o,drifts:n,driftFreqs:l,points:m,material:c,spinMeshes:[],spinSpeeds:[]}}setSnowSize(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uSizeMultiplier.value=Math.max(.2,Math.min(4,e)))}setSnowCount(e){this.snowCount=parseInt(e)||200,this.snowflakeGroup&&this.snowflakeGroup.visible&&this.initSnowflake()}setSnowDrift(e){this.snowDriftMultiplier=parseFloat(e)||1}setSnowGlow(e){var t;(t=this._snowData)!=null&&t.material&&(this._snowData.material.uniforms.uGlowAmount.value=Math.max(0,Math.min(1,e)))}initLava(){var o;this.lavaBlobs=[];const e=16;this.lavaUniforms={uBlobs:{value:[]},uColor:{value:new T(((o=g.visualColors)==null?void 0:o.lava)||16737792)},uSecondaryColor:{value:new T(16755200)},uTime:{value:0},uLoopTime:{value:0},uIntensity:{value:0},uResolution:{value:new ye(window.innerWidth,window.innerHeight)}};for(let n=0;n<e;n++)this.lavaUniforms.uBlobs.value.push(new Qe(0,-100,0,0));const t=new E({uniforms:this.lavaUniforms,vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,blending:_,depthWrite:!1,side:J}),i=new te(100,100),a=new G(i,t);a.position.z=-5,[{count:5,minSize:1,maxSize:1.5},{count:7,minSize:1.5,maxSize:2.2},{count:4,minSize:2.2,maxSize:3.5}].forEach(n=>{for(let l=0;l<n.count;l++){const d=n.minSize+Math.random()*(n.maxSize-n.minSize),p=["heating","rising","cooling","falling"],c=p[Math.floor(Math.random()*p.length)],m=-18+Math.random()*4,r=18+Math.random()*4;let u=0,x=.5;c==="heating"?(u=m,x=Math.random()*.5):c==="rising"?(u=m+Math.random()*(r-m),x=.8+Math.random()*.2):c==="cooling"?(u=r,x=1-Math.random()*.3):c==="falling"&&(u=r-Math.random()*(r-m),x=.2+Math.random()*.3),this.lavaBlobs.push({position:new $e((Math.random()-.5)*12,u,(Math.random()-.5)*6),material:{uniforms:{uTemp:{value:0},uIntensity:{value:0},uTime:{value:0}}},userData:{baseSize:d,state:c,temperature:x,floatMin:m,floatMax:r,heatRate:.15+Math.random()*.3,coolRate:.15+Math.random()*.3,riseSpeed:(.04+Math.random()*.05)/(d*.5),fallSpeed:(.05+Math.random()*.05)/(d*.5),driftPhase:Math.random()*Math.PI*2,driftSpeed:.01+Math.random()*.02}})}}),this.lavaGroup.add(a),this.lavaGroup.visible=!1}initFireplace(){const i=new te(100,80);this.fireMaterial=this.createFireShader(),this.fireMesh=new G(i,this.fireMaterial),this.fireMesh.position.set(0,0,-15),this.fireMesh.renderOrder=10,this.fireplaceGroup.add(this.fireMesh),this.fireLight=new Je(16737792,5,200),this.fireLight.position.set(0,0,30),this.fireplaceGroup.add(this.fireLight);const a=650,s=new N,o=[];for(let n=0;n<a;n++)o.push((Math.random()-.5)*100,-20+Math.random()*40,-15+(Math.random()-.5)*20);s.setAttribute("position",new $(o,3)),this.emberMat=new ve({color:16763904,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.8,blending:_,depthWrite:!1}),this.embers=new Q(s,this.emberMat),this.fireplaceGroup.add(this.embers),this.emberVelocities=new Float32Array(a);for(let n=0;n<a;n++)this.emberVelocities[n]=.02+Math.random()*.05;this.fireplaceGroup.position.set(0,0,0),this.fireplaceGroup.visible=!1}createFireShader(){return new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uColor:{value:new T(16729088)},uSpeed:{value:1},uIntensity:{value:1}},vertexShader:`
                varying vec2 vUv;
                void main() {
                    vUv = uv;
                    gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
            ...
            `,transparent:!0,side:J,blending:_,depthWrite:!1})}initRainforest(){const e=this.batterySaver?400:1e3,t=new N,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let s=0;s<e;s++){const o=s*3;i[o]=(Math.random()-.5)*60,i[o+1]=(Math.random()-.5)*40,i[o+2]=(Math.random()-.5)*40,a[o]=Math.random(),a[o+1]=Math.random(),a[o+2]=.08+Math.random()*.12}t.setAttribute("position",new W(i,3)),t.setAttribute("aRandom",new W(a,3)),this.rainMaterial=new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uColor:{value:new T(8965375)},uIntensity:{value:.6}},vertexShader:`
            ...
            `,transparent:!0,depthWrite:!1,blending:_}),this.raindrops=new Q(t,this.rainMaterial),this.rainforestGroup.add(this.raindrops),this.rainforestGroup.visible=!1}initZenGarden(){const e=this.batterySaver?200:500,t=new N,i=new Float32Array(e*3),a=new Float32Array(e*3);for(let o=0;o<e;o++){const n=o*3;i[n]=(Math.random()-.5)*40,i[n+1]=(Math.random()-.5)*20,i[n+2]=(Math.random()-.5)*40,a[n]=Math.random(),a[n+1]=Math.random(),a[n+2]=Math.random()*Math.PI*2}t.setAttribute("position",new W(i,3)),t.setAttribute("aRandom",new W(a,3)),this.petalMaterial=new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:1},uColor:{value:new T(16758725)},uIntensity:{value:.8}},vertexShader:`
                attribute vec3 aRandom;
                uniform float uTime, uSpeed;
                varying float vAlpha;
                void main() {
            ...
            `,transparent:!0,depthWrite:!1}),this.petals=new Q(t,this.petalMaterial),this.zenGardenGroup.add(this.petals);const s=new te(40,40,32,32);this.zenWaterMaterial=new O({color:2245734,transparent:!0,opacity:.3,side:J}),this.zenWater=new G(s,this.zenWaterMaterial),this.zenWater.rotation.x=-Math.PI/2,this.zenWater.position.y=-5,this.zenGardenGroup.add(this.zenWater),this.zenGardenGroup.visible=!1}initOcean(){var n;const e=new te(300,100,128,64);this.oceanWave=new G(e,new E({uniforms:{uTime:{value:0},uLoopTime:{value:0},uColor:{value:this.customColor?this.customColor.clone():new T(43775)},uNormBass:{value:0},uBeatPulse:{value:0}},vertexShader:`
                varying float vDist;
            ...
            `,wireframe:!0,transparent:!0,side:J})),this.oceanWave.rotation.x=-Math.PI/3,this.oceanWave.position.y=-2,this.oceanGroup.add(this.oceanWave);const t=300,i=new N,a=[];for(let l=0;l<t;l++)a.push((Math.random()-.5)*50),a.push(-2.5+Math.random()*.5),a.push((Math.random()-.5)*40);i.setAttribute("position",new $(a,3));const s=new ve({color:16777215,size:.15,map:this.createCircleTexture(),transparent:!0,opacity:.5,blending:_,depthWrite:!1});this.oceanFoam=new Q(i,s),this.oceanGroup.add(this.oceanFoam),this.oceanGroup.visible=!1;const o=((n=this.customColors)==null?void 0:n.ocean)||this.customColor;o&&(this.oceanWave&&this.oceanWave.material.color.copy(o),this.oceanFoam&&this.oceanFoam.material.color.copy(o))}createCyberTexture(e=this.matrixConfig){const i=document.createElement("canvas");i.width=1024,i.height=1024;const a=i.getContext("2d");a.fillStyle="rgba(0,0,0,0)",a.fillRect(0,0,1024,1024),a.shadowBlur=12,a.shadowColor="rgba(255, 255, 255, 0.4)",a.font='bold 80px "Courier New", "MS Gothic", "Hiragino Kaku Gothic ProN", monospace',a.fillStyle="#ffffff",a.textAlign="center",a.textBaseline="middle";const s=8,o=8,n=1024/s,l=1024/o;let d="🪷MINDWAVE";const p=e.logicMode,c=e.customText;p==="custom"||p==="txt"?d="🪷"+(c&&c.length>0?c:"WELCOME TO MINDWAVE"):(p==="random"||p==="rnd"||p==="matrix"||p==="int"||p==="interstellar")&&(d="");const m=p==="matrix"||p==="int"||p==="interstellar"?[]:["LOGO",...d],r=m.length;for(let x=0;x<64;x++){const I=x%8,D=Math.floor(x/8);a.fillStyle="rgba(0,0,0,0)",a.fillRect(I*n,D*l,n,l),a.save(),a.translate(I*n+n/2,D*l+l/2);let P="",S=!1;if(x<r){const L=m[x];L==="LOGO"?S=!0:P=L}else{const A="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ"+"0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";P=A.charAt(Math.floor(Math.random()*A.length)),Math.random()>.5&&(a.save(),a.scale(-1,1),a.fillStyle="#ffffff",a.font="bold 80px monospace",a.fillText(P,0,0),a.restore(),P="")}if(P||S)if(a.fillStyle="#ffffff",a.font="bold 80px monospace",a.textAlign="center",a.textBaseline="middle",a.shadowBlur=16,a.shadowColor="rgba(255, 255, 255, 0.6)",S)if(this.logoImage){const w=document.createElement("canvas");w.width=100,w.height=100;const U=w.getContext("2d");U.imageSmoothingEnabled=!0,U.imageSmoothingQuality="high",U.drawImage(this.logoImage,0,0,100,100);const ee=U.getImageData(0,0,100,100),R=ee.data;for(let q=0;q<R.length;q+=4){const ae=180+(R[q]+R[q+1]+R[q+2])/3/255*75;R[q]=ae,R[q+1]=ae,R[q+2]=ae}U.putImageData(ee,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(w,-50,-50,100,100)}else!this.logoLoading&&!this.logoFailed&&(this.logoLoading=!0,new et().load("./mindwave-logo-icon.png",A=>{if(this.logoImage=A,this.logoLoading=!1,this.cyberMaterial){const w=this.createCyberTexture();this.cyberMaterial.uniforms.uTexture.value=w}},void 0,A=>{this.logoFailed=!0,this.logoLoading=!1})),a.font="bold 80px monospace",a.fillStyle="#2dd4bf",a.fillText("🪷",0,0);else a.fillText(P,0,0);a.restore()}const u=new le(i);return u.magFilter=ze,u.minFilter=ze,u}createCyberShader(e,t=this.matrixConfig){return new E({uniforms:{uTexture:{value:e},uColor:{value:new T(t.color||65345)},uHeadColor:{value:new T(15794160)},uTime:{value:0},uLoopTime:{value:0},uSpeed:{value:t.speed||1},uTailLength:{value:t.length||1},uRainbow:{value:t.rainbow?1:0},uBrightness:{value:this.brightnessMultiplier||1}},vertexShader:`
            ...
            `,transparent:!0,wireframe:!1,side:J,extensions:{derivatives:!0}}),this.wavesMesh=new G(e,this.wavesMaterial),this.wavesMesh.rotation.x=-Math.PI/2.2,this.wavesMesh.position.y=-5,this.wavesMesh.position.z=-10,this.wavesGroup.add(this.wavesMesh)}setSpeed(e){this.speedMultiplier=e}setIntent(e){this.currentIntent=e,e==="delta"||e==="theta"?this.particles&&this.particles.material&&(this.particles.material.size=.3,this.particles.material.opacity=.5):e==="gamma"||e==="hyper-gamma"?(this.particles&&this.particles.material&&(this.particles.material.size=.08,this.particles.material.opacity=.9),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uHeadColor.value.setHex(16777215),this.cyberMaterial.uniforms.uTailLength.value=.4)):(this.particles&&this.particles.material&&(this.particles.material.size=.15,this.particles.material.opacity=.8),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uHeadColor.value.setHex(15794160),this.cyberMaterial.uniforms.uTailLength.value=1)),this.renderSingleFrame()}setColor(e,t=null){var i,a,s,o;this.customColors||(this.customColors={}),!t||t==="all"?(this.customColors={},this.customColor=new T(e)):this.customColors[t]=new T(e);try{const n=new T(e),l={};n.getHSL(l);const d=new T().setHSL(l.h,l.s,Math.max(.1,l.l*.5)),p=new T().setHSL(l.h,l.s,Math.max(.02,l.l*.15)),c=new T().setHSL(l.h,Math.min(1,l.s*.8),.9),m=r=>{r&&(r.color&&typeof r.color.set=="function"?r.color.set(e):r.uniforms&&r.uniforms.uColor&&r.uniforms.uColor.value.set(e),r.uniforms&&r.uniforms.uSecondaryColor&&r.uniforms.uSecondaryColor.value.copy(d),r.uniforms&&r.uniforms.uDeepColor&&r.uniforms.uDeepColor.value.copy(p),r.uniforms&&r.uniforms.uSunColor&&r.uniforms.uSunColor.value.copy(c))};this.particles&&this.particles.material&&m(this.particles.material),this.lightspeed&&this.lightspeed.material&&m(this.lightspeed.material),this.sphere&&this.sphere.material&&(m(this.sphere.material),this.core&&this.core.material&&m(this.core.material)),(t==="box"||!t||t==="all")&&(this.boxOuter&&this.boxOuter.children.forEach(r=>m(r.material)),this.boxInner&&this.boxInner.children.forEach(r=>m(r.material)),this.boxEdges&&this.boxEdges.material&&m(this.boxEdges.material)),t==="mandala"&&(this.mandalaRings&&this.mandalaRings.forEach(r=>m(r.material)),this.mandalaCenter&&this.mandalaCenter.material&&m(this.mandalaCenter.material)),this.wavesMesh&&this.wavesMesh.material&&m(this.wavesMesh.material),this.lavaBlobs&&this.lavaBlobs.forEach(r=>m(r.material)),this.lavaGlow&&this.lavaGlow.material&&m(this.lavaGlow.material),this.flames&&this.flames.material&&m(this.flames.material),this.raindrops&&this.raindrops.material&&m(this.raindrops.material),this.petals&&this.petals.material&&m(this.petals.material),this.zenWater&&this.zenWater.material&&m(this.zenWater.material),this.oceanWave&&this.oceanWave.material&&m(this.oceanWave.material),this.oceanFoam&&this.oceanFoam.material&&m(this.oceanFoam.material),this.cyberRain&&this.cyberRain.material&&this.cyberRain.material.uniforms&&this.cyberRain.material.uniforms.uColor&&this.cyberRain.material.uniforms.uColor.value.set(e),this.logoMesh&&this.originalLogoImg&&this.updateLogoTexture(),this.dragonGroup&&this.updateDragonColor&&this.updateDragonColor(new T(e)),(this.galaxyStars||this.galaxySunMesh)&&this.updateGalaxyColor(new T(e)),this.cymaticMaterial&&((i=this.cymaticMaterial.uniforms)!=null&&i.uColor)&&this.cymaticMaterial.uniforms.uColor.value.set(e),(t==="snowflake"||!t||t==="all")&&typeof this.setSnowColor=="function"&&this.setSnowColor(e),(o=(s=(a=this._snowData)==null?void 0:a.material)==null?void 0:s.uniforms)!=null&&o.uColor&&this._snowData.material.uniforms.uColor.value.set(e)}catch{}this.renderSingleFrame()}renderSingleFrame(){!this.renderer||!this.scene||!this.camera||(this.renderer.clear(),this.renderer.render(this.scene,this.camera))}createCircleTexture(){if(this.textures.circle)return this.textures.circle;const e=32,t=document.createElement("canvas");t.width=e,t.height=e;const i=t.getContext("2d");return i.beginPath(),i.arc(e/2,e/2,e/2,0,Math.PI*2),i.fillStyle="#ffffff",i.fill(),this.textures.circle=new le(t),this.textures.circle}render(e,t){var i,a,s,o,n,l,d,p;if(!this.initialized||!this.renderer||document.hidden||!this.active){this._isRendering=!1;return}if(!(this._isRendering&&typeof e=="number")){this._isRendering=!0;try{(typeof e=="number"||!e&&(g.masterAnalyser||g.analyserLeft))&&(e=g.masterAnalyser||g.analyserLeft,t=g.analyserRight);let c=0,m=0,r=0;if(e){const h=e.frequencyBinCount;(!this._freqDataArray||this._freqDataArray.length!==h)&&(this._freqDataArray=new Uint8Array(h)),e.getByteFrequencyData(this._freqDataArray);const y=typeof this.audioSensitivity=="number"?this.audioSensitivity:1;let C=0;for(let z=0;z<15;z++)C+=this._freqDataArray[z];c=Math.pow(C/15/255,.8)*y;let b=0;for(let z=10;z<100;z++)b+=this._freqDataArray[z];m=b/90/255*y;let M=0;for(let z=100;z<300;z++)M+=this._freqDataArray[z];r=M/200/255*y}const u=Math.max(.001,this.speedMultiplier||1),x=performance.now()*.001;if(this.activeModes.has("cymatics")&&this.cymaticsCore){const h=window.visualsBeatSync!==!1&&window.cymaticsAudioSync!==!1?{bass:c||0,mids:m||0,highs:r||0}:{bass:0,mids:0,highs:0},y=window.cymaticsMouseSync!==!1?{x:this.mouseX||0,y:this.mouseY||0}:null;this.cymaticsCore.update(x*u,h,y)}this.lastTime||(this.lastTime=x);const I=Math.min(.1,x-this.lastTime);this.lastTime=x;const D=g.visualSpeedAuto?g.beatFrequency||10:u*10,P=Math.sin(x*Math.PI*2*D)*.5+.5,S=window.visualsBeatSync!==!1,L=this.vibrationEnabled&&S?1:0,A=(P||0)*L,w=(c||0)*L,U=(m||0)*L,ee=(r||0)*L,R=L*(.02+w*.15+A*.08),q=Math.sin(x*47.3)*Math.cos(x*31.7)*R,ie=Math.cos(x*53.1)*Math.sin(x*29.3)*R,ae=Math.sin(x*37.9)*Math.cos(x*43.1)*R,Fe=[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup,this.tsunamiGroup];for(const h of Fe)h&&h.position.set(q,ie,ae);if(this.activeModes.has("galaxy")&&this.galaxyGroup){const h=this.sunRotationSpeedY||.002,y=this.sunRotationSpeedZ||5e-4;if(this.galaxyStars&&(this.galaxyStars.rotation.y+=h*u*.5,this.galaxyStars.rotation.z+=y*u*.5),this.galaxySunMesh){this.galaxySunMesh.rotation.z-=y*u*1.5,this.galaxySunMesh.rotation.y+=h*u*2;const C=1+w*.15*(this.galaxySunStyle==="sun3"?2.5:1);this.galaxySunMesh.scale.setScalar(C)}this.galaxySunUniforms&&(this.galaxySunUniforms.uTime.value=x*u,this.galaxySunUniforms.uBassIntt.value=w)}if(this.activeModes.has("sphere")&&this.sphere&&(this.sphere.scale.setScalar(1+w*.15),this.sphere.rotation.y+=.005*u),this.activeModes.has("particles")&&this.particleMaterial){const h=((a=(i=window.MindWaveState)==null?void 0:i.envIntensities)==null?void 0:a.flow)??1,y=(.015*u+w*.08+A*.05)*h;this.particleMaterial.uniforms.uTime.value=x,this.particleMaterial.uniforms.uSpeed.value=y*10,this.particleGroup.rotation.z+=(.001*u+w*.005)*h}if(this.activeModes.has("lightspeed")&&this.lightspeedMaterial&&(this.lightspeedMaterial.uniforms.uTime.value=x,this.lightspeedMaterial.uniforms.uSpeed.value=u),this.activeModes.has("matrix")&&this.cyberMaterial&&(this.cyberMaterial.uniforms.uTime.value=x*u),this.activeModes.has("waves")&&this.wavesMaterial){const h=((o=(s=window.MindWaveState)==null?void 0:s.envIntensities)==null?void 0:o.ocean)??1;this.wavesMaterial.uniforms.uTime.value=x*u*.5,this.wavesMaterial.uniforms.uNormBass.value=w*h,this.wavesMaterial.uniforms.uIntensity&&(this.wavesMaterial.uniforms.uIntensity.value=h)}if(this.activeModes.has("ocean")&&this.oceanWave&&this.oceanWave.material.uniforms){const h=((l=(n=window.MindWaveState)==null?void 0:n.envIntensities)==null?void 0:l.ocean)??1;this.oceanWave.material.uniforms.uTime.value=x*u,this.oceanWave.material.uniforms.uNormBass.value=w*h,this.oceanWave.material.uniforms.uBeatPulse.value=A*h,this.oceanFoam&&(this.oceanFoam.material.opacity=(.4+w*.3+A*.2)*(this.brightnessMultiplier||1)*h)}if(this.activeModes.has("box")&&this.boxOuter&&(this.boxOuter.rotation.x+=.008*u+w*.02,this.boxOuter.rotation.y+=.012*u,this.boxInner&&(this.boxInner.rotation.x-=.015*u,this.boxInner.rotation.y-=.01*u,this.boxInner.scale.setScalar(.95+w*.2)),this.boxOuter.scale.setScalar(1+w*.2),this.boxEdges&&this.boxEdges.rotation.copy(this.boxOuter.rotation)),this.activeModes.has("dragon")&&this.dragonBodyInstanced&&this.dragonDummy){this.dragonGroup.rotation.y+=.005*u;const h=x*u*2,y=1+w*.2;for(let C=0;C<this.dragonLength;C++){const b=h-C*.12,M=Math.sin(b)*8,z=Math.cos(b*1.5)*4+Math.sin(b*.5)*3,Z=Math.cos(b*.8)*8;this.dragonDummy.position.set(M,z,Z);const B=b+.1,k=Math.sin(B)*8,H=Math.cos(B*1.5)*4+Math.sin(B*.5)*3,me=Math.cos(B*.8)*8;this.dragonDummy.lookAt(k,H,me);const Re=1-C/this.dragonLength*.8,qe=1+Math.sin(b*4)*.15*(.5+w);this.dragonDummy.scale.setScalar(Re*qe*y),this.dragonDummy.updateMatrix(),this.dragonBodyInstanced.setMatrixAt(C,this.dragonDummy.matrix),this.dragonGlowInstanced&&this.dragonGlowInstanced.setMatrixAt(C,this.dragonDummy.matrix),C===0&&this.dragonHead&&(this.dragonHead.position.copy(this.dragonDummy.position),this.dragonHead.quaternion.copy(this.dragonDummy.quaternion),this.dragonHead.scale.copy(this.dragonDummy.scale).multiplyScalar(1.4))}if(this.dragonBodyInstanced.instanceMatrix.needsUpdate=!0,this.dragonGlowInstanced&&(this.dragonGlowInstanced.instanceMatrix.needsUpdate=!0),this.dragonPearlGroup){const C=h+.5;this.dragonPearlGroup.position.set(Math.sin(C)*9,Math.cos(C*1.5)*5+Math.sin(C*.5)*4,Math.cos(C*.8)*9),this.dragonPearlGroup.rotation.x+=.08*u,this.dragonPearlGroup.rotation.y+=.12*u}}if(this.activeModes.has("mandala")&&this.mandalaRings&&(this.mandalaRings.forEach((h,y)=>{h.userData&&h.userData.speed&&(h.rotation.z+=h.userData.speed*u+w*.005);const C=1+A*.1*(y+1)*.3;h.scale.setScalar(C)}),this.mandalaCenter&&(this.mandalaCenter.rotation.z-=.01*u,this.mandalaCenter.scale.setScalar(1+w*.3))),this.activeModes.has("tsunami")&&this.tsunamiMaterial){const h=u*.5*(1+A*.2),y=this.tsunamiMaterial.uniforms.uLoopActive.value,C=this.tsunamiMaterial.uniforms.uAmplitude.value;if(this.tsunamiMaterial.uniforms.uTime.value+=I*h,this.tsunamiAnimState&&this.tsunamiAnimState.active){this.tsunamiAnimState.phase+=I,this.tsunamiAnimState.phase>10&&(this.tsunamiAnimState.phase=0);let M=this.tsunamiAnimState.phase,z=this.tsunamiAnimState.startAmp,Z=this.tsunamiAnimState.startCurl,B=0;if(M<2){let k=M/2;B=-300+300*(1-Math.pow(1-k,3))}else if(M<4){B=0;let k=(M-2)/2,H=1-Math.pow(1-k,3);Z=this.tsunamiAnimState.startCurl+(4-this.tsunamiAnimState.startCurl)*H}else if(M<9)B=0,Z=4;else{B=0,Z=4;let k=(M-9)/1,H=k*k;z=this.tsunamiAnimState.startAmp*(1-H)}if(this.tsunamiMaterial.uniforms.uAmplitude.value=z,this.tsunamiMaterial.uniforms.uCurl.value=Z,this.tsunamiMaterial.uniforms.uWaveOffset&&(this.tsunamiMaterial.uniforms.uWaveOffset.value=B),typeof window<"u"&&window.document){const k=document.getElementById("tsunamiCurlSlider"),H=document.getElementById("tsunamiCurlVal");k&&H&&(k.value=Z,H.textContent=Z.toFixed(1))}}else this.tsunamiMaterial.uniforms.uWaveOffset&&(this.tsunamiMaterial.uniforms.uWaveOffset.value=0);const b=this.tsunamiMaterial.uniforms.uTime.value;if(this.customColor?(this.tsunamiMaterial.uniforms.uColor.value.copy(this.customColor),this.tsunamiMaterial.uniforms.uHasCustomColor.value=1,this.tsunamiSun&&this.tsunamiSun.material&&this.tsunamiSun.material.color.copy(this.customColor)):this.rainbowMode&&this.currentColorHsl?(this.tsunamiMaterial.uniforms.uColor.value.setHSL(this.currentColorHsl.h,this.currentColorHsl.s,this.currentColorHsl.l),this.tsunamiMaterial.uniforms.uHasCustomColor.value=1,this.tsunamiSun&&this.tsunamiSun.material&&this.tsunamiSun.material.color.setHSL(this.currentColorHsl.h,this.currentColorHsl.s,this.currentColorHsl.l)):(this.tsunamiMaterial.uniforms.uHasCustomColor.value=0,this.tsunamiSun&&this.tsunamiSun.material&&this.tsunamiSun.material.color.setHex(16763904)),this.tsunamiGroup&&this.tsunamiGroup.children.length>0){const M=this.tsunamiGroup.children[0],z=this.tsunamiMaterial.uniforms.uTime.value,B=-30-(this.tsunamiMaterial.uniforms.uAmplitude.value-1)*15,k=-20;if(y>.5){const H=Math.min(z/12,1),me=1-Math.pow(1-H,3);M.position.x=-110+(110+B)*me,M.position.y=k+Math.sin(z*3)*1.5}else M.position.x=B,M.position.y=k+Math.sin(z*3)*1.5}}if(this.dimmerPlane){const h=g&&g.screenDimmer!==void 0?g.screenDimmer:0;this.dimmerPlane.material.opacity=h}if(this.logoMesh){const h=g.lotusState||"auto";let y=P;if(h==="heartbeat")if(g.lotusHeartbeatSync)y=Math.min(1,P*.7+w*.8);else{const b=(g.lotusHeartbeatBpm||11)/60;y=Math.sin(x*Math.PI*2*b)*.5+.5}let C=.8;h==="faded"?C=.15:h==="full"?C=1:h==="heartbeat"?C=.2+.8*y:h==="manual"?C=g.lotusOpacity!==void 0?g.lotusOpacity:.8:C=.4+w*.6,this._lotusCurrentOpacity===void 0&&(this._lotusCurrentOpacity=.8),this._lotusCurrentOpacity+=(C-this._lotusCurrentOpacity)*.1,this.logoMesh.material.opacity=this._lotusCurrentOpacity,h==="heartbeat"?this.logoMesh.scale.setScalar(1+y*.15):this.logoMesh.scale.setScalar(1+w*.05+A*.02)}if(this.activeModes.has("lava")&&this.lavaBlobs&&this.lavaUniforms){const h=((p=(d=window.MindWaveState)==null?void 0:d.envIntensities)==null?void 0:p.lava)??1;this.lavaUniforms.uTime.value=x*u,this.lavaUniforms.uIntensity.value=w*h,this.lavaBlobs.forEach((y,C)=>{const b=y.userData,M=u*(1+w*.8);if(b.state==="heating"?(b.temperature+=b.heatRate*I*M,b.temperature>=1&&(b.temperature=1,b.state="rising")):b.state==="rising"?(y.position.y+=b.riseSpeed*M,y.position.y>=b.floatMax&&(b.state="cooling")):b.state==="cooling"?(b.temperature-=b.coolRate*I*M,b.temperature<=0&&(b.temperature=0,b.state="falling")):b.state==="falling"&&(y.position.y-=b.fallSpeed*M,y.position.y<=b.floatMin&&(b.state="heating")),y.position.x+=Math.sin(x*b.driftSpeed+b.driftPhase)*.02*M,this.lavaUniforms.uBlobs.value[C]){const z=b.baseSize*(.8+.5*b.temperature);this.lavaUniforms.uBlobs.value[C].set(y.position.x,y.position.y,y.position.z,z)}})}if(this.snowflakeGroup&&this.snowflakeGroup.visible&&this._snowData){const h=this._snowData,y=h.points.geometry.attributes.position.array,C=u*2;for(let b=0;b<h.count;b++){const M=b*3;y[M+1]-=h.speeds[b]*C;let z=Math.sin(x*h.driftFreqs[b]+h.phases[b])*h.drifts[b]*C*(this.snowDriftMultiplier!==void 0?this.snowDriftMultiplier:1);y[M]+=z,y[M+1]<-22&&(y[M+1]=22),y[M]>35&&(y[M]=-35),y[M]<-35&&(y[M]=35)}if(h.points.geometry.attributes.position.needsUpdate=!0,h.spinMeshes){const b=1+(w||0)*.15;h.spinMeshes.forEach((M,z)=>{M.rotation.z+=h.spinSpeeds[z]*C,M.position.y-=h.spinSpeeds[z]*.1*C,M.scale.setScalar(b),M.position.y<-25&&(M.position.y=25)})}h.material&&h.material.uniforms&&h.material.uniforms.uIntensity&&(h.material.uniforms.uIntensity.value=.2+w*.8)}if(this.activeModes.has("rainforest")&&this.rainMaterial){const h=u*.8*(1+A*.3);this.rainMaterial.uniforms.uTime.value=x,this.rainMaterial.uniforms.uSpeed.value=h,this.rainMaterial.uniforms.uIntensity.value=(.5+w*.2+A*.2)*(this.brightnessMultiplier||1)}if(this.activeModes.has("zengarden")&&this.petalMaterial){const h=u*.3*(1+A*.5);this.petalMaterial.uniforms.uTime.value=x,this.petalMaterial.uniforms.uSpeed.value=h,this.zenWater&&(this.zenWater.material.opacity=(.3+A*.2)*(this.brightnessMultiplier||1))}if(this.activeModes.has("fireplace")&&this.fireMesh&&this.fireMesh.material&&this.fireMesh.material.uniforms){const h=.8+.2*Math.sin(x*15)*Math.sin(x*7),y=this.fireMesh.material.uniforms;y.uTime&&(y.uTime.value=x*1.5*u),y.uIntensity&&(y.uIntensity.value=h+w*.5),this.fireLight&&(this.fireLight.intensity=(2+w*5)*h)}const K=performance.now(),Le=K-(this._lastFrameStartTime||K);if(this._lastFrameStartTime=K,this._fpsRingBuffer&&(this._fpsRingBuffer[this._fpsRingIndex]=Le,this._fpsRingIndex=(this._fpsRingIndex+1)%60,this._fpsRingCount=Math.min(60,this._fpsRingCount+1),this._fpsRingCount===60)){let h=0;for(let C=0;C<60;C++)h+=this._fpsRingBuffer[C];h/=60;const y=1e3/h;this._appStartTime||(this._appStartTime=performance.now()),y<35&&K-(this._lastLodDegradation||0)>3e3&&K-this._appStartTime>8e3&&(this.degradeLOD(),this._lastLodDegradation=K,this._fpsRingCount=0)}const De=1e3/(this.targetFPS||60);if(K-this.lastFrameRenderTime>=De){this.renderer.autoClear=!this.activeModes.has("lightspeed"),this.renderer.autoClear&&this.renderer.clear();const h=(w+(m||0)*L+ee)/3,y=K-this.lastFrameRenderTime;this.particleSwarm&&this.activeModes.has("cymatics")&&this.particleSwarm.update(Math.min(y*.001,.1),h),this.postProcessor&&this.currentLodLevel!=="low"?this.postProcessor.render(this.scene,this.camera,Math.min(y*.001,.1),h):this.renderer.render(this.scene,this.camera),this.activeModes.has("cyber")&&this.renderCyberCyber(),this.lastFrameRenderTime=K}}catch(c){c.name==="TypeError"&&c.message.includes("uniforms")}finally{this._isRendering=!1}this.active&&!document.hidden?g.animationId=requestAnimationFrame(()=>this.render(g.masterAnalyser||g.analyserLeft,g.analyserRight)):g.animationId=null}}setCyberColor(e){this.cyberConfig.color=e,this.cyberConfig.rainbow=!1,this.cyberColorCustomized=!0,this.matrixCyberStreams&&this.matrixCyberStreams.forEach(t=>{t.color=e})}setMatrixColor(e){this.matrixConfig.color=e,this.matrixConfig.rainbow=!1,this.cyberMaterial&&this.cyberMaterial.uniforms.uColor&&(this.cyberMaterial.uniforms.uColor.value.set(e),this._tempColor.set(e),this._tempColor.r+=(1-this._tempColor.r)*.8,this._tempColor.g+=(1-this._tempColor.g)*.8,this._tempColor.b+=(1-this._tempColor.b)*.8,this.cyberMaterial.uniforms.uHeadColor&&this.cyberMaterial.uniforms.uHeadColor.value.copy(this._tempColor),this.cyberMaterial.uniforms.uRainbow&&(this.cyberMaterial.uniforms.uRainbow.value=0)),this.cyberColor=e,this.cyberRainbowMode=!1,this.matrixCyberStreams&&this.matrixCyberStreams.forEach(t=>{t.color=e})}getAverageFrequency(e,t){let i=g.masterAnalyser||g.analyserLeft||g.analyserRight;if(!i)return 0;const a=i.frequencyBinCount;(!this._freqDataArray||this._freqDataArray.length!==a)&&(this._freqDataArray=new Uint8Array(a));const s=this._freqDataArray;i.getByteFrequencyData(s),e===void 0&&(e=0),t===void 0&&(t=s.length);let o=0,n=0;for(let l=e;l<t&&l<s.length;l++)o+=s[l],n++;return n>0?o/n:0}setMouseInfluence(e){this.mouseInfluence=e}setGlobalSpeed(e){this.speedMultiplier=e,this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uSpeed&&(this.cyberMaterial.uniforms.uSpeed.value=1+(e-1)*.5)}setGlobalBrightness(e){this.brightnessMultiplier=e,this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uBrightness&&(this.cyberMaterial.uniforms.uBrightness.value=e),this.particleMaterial&&this.particleMaterial.uniforms&&this.particleMaterial.uniforms.uIntensity&&(this.particleMaterial.uniforms.uIntensity.value=e),this.petalMaterial&&this.petalMaterial.uniforms&&this.petalMaterial.uniforms.uIntensity&&(this.petalMaterial.uniforms.uIntensity.value=e*.8)}setCyberBrightness(e){this.cyberConfig.brightness=e}setMatrixBrightness(e){this.matrixConfig.brightness=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uBrightness&&(this.cyberMaterial.uniforms.uBrightness.value=e)}setCyberSpeed(e){this.cyberConfig.speed=e}setCyberLength(e){this.cyberConfig.length=e}setMatrixSpeed(e){this.matrixConfig.speed=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uSpeed&&(this.cyberMaterial.uniforms.uSpeed.value=e)}setMatrixLength(e){this.matrixConfig.length=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uTailLength&&(this.cyberMaterial.uniforms.uTailLength.value=e)}setCyberRainbow(e){if(this.cyberConfig.rainbow=e,this.cyberRainbowMode=e,!e){const t=this.cyberConfig.color||this.cyberColor||"#00FF41";this.matrixCyberStreams&&this.matrixCyberStreams.forEach(i=>{i.color=t})}}setMatrixRainbow(e){if(this.matrixConfig.rainbow=e,this.cyberMaterial&&this.cyberMaterial.uniforms.uRainbow&&(this.cyberMaterial.uniforms.uRainbow.value=e?1:0),this.cyberRainbowMode=e,!e){const t=this.matrixConfig.color||this.cyberColor||"#00FF41";this.matrixCyberStreams&&this.matrixCyberStreams.forEach(i=>{i.color=t})}}setCymaticsRainbow(e){this.cymaticsCore&&this.cymaticsCore.setRainbow(e)}setCameraRotation(e,t,i){this.cameraPitch=e*Math.PI/180,this.cameraYaw=t*Math.PI/180,this.cameraRoll=i*Math.PI/180,this.updateCameraRotation()}updateCameraRotation(){this.scene&&this.scene.rotation.set(this.cameraPitch,this.cameraYaw,this.cameraRoll)}setAudioSensitivity(e){this.audioSensitivity=e}setGeoComplexity(e){this.geoComplexity=e}setBatterySaver(e){this.batterySaver=e,this.targetFPS=e?30:60;const t=e?1:2;this.renderer&&(this.renderer.setPixelRatio(Math.min(window.devicePixelRatio,t)),this.resize())}degradeLOD(){this.renderer&&(this.currentLodLevel==="high"?(this.renderer.setPixelRatio(1),this.currentLodLevel="medium",this.resize()):this.currentLodLevel==="medium"&&(this.renderer.setPixelRatio(.75),this.currentLodLevel="low",this.resize()))}updateCyberStrings(){if(!this.matrixCyberStreams)return;let e=!1,t="MINDWAVE🪷";const i=this.cyberConfig;i.logicMode==="custom"||i.logicMode==="txt"?(e=!0,t="🪷"+(i.customText||"WELCOME TO MINDWAVE")):(i.logicMode==="mindwave"||i.logicMode==="mw")&&(e=!0,t="MINDWAVE🪷");const a="ｱｲｳｴｵｶｷｸｹｺｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜﾝ",s="0123456789·:.-+x[]<>/\\∆ΣΩ∞",o=100;this.matrixCyberStreams.forEach(n=>{if(n.chars=[],n.isTextMode=e,e&&t.length>0){const l=[...t].reverse();for(let d=0;d<o;d++)n.chars.push(l[d%l.length])}else if(i.logicMode==="matrix"||i.logicMode==="interstellar"||i.logicMode==="int")for(let l=0;l<o;l++)n.chars.push(s.charAt(Math.floor(Math.random()*s.length)));else for(let l=0;l<o;l++)n.chars.push(a.charAt(Math.floor(Math.random()*a.length)))})}setCyberLogicMode(e,t){this.cyberConfig.logicMode=e,t!==void 0&&(this.cyberConfig.customText=t),this.updateCyberStrings()}setMatrixLogicMode(e,t){if(this.matrixConfig.logicMode=e,t!==void 0&&(this.matrixConfig.customText=t),this.cyberMaterial&&this.cyberMaterial.uniforms&&this.cyberMaterial.uniforms.uTexture){const i=this.cyberMaterial.uniforms.uTexture.value,a=this.createCyberTexture(this.matrixConfig);this.cyberMaterial.uniforms.uTexture.value=a,this.cyberMaterial.needsUpdate=!0,i&&i.dispose()}this.initCyber()}setCyberColor(e){this.cyberConfig.color=e,this.matrixCyberStreams&&this.matrixCyberStreams.forEach(t=>{t.color=e})}setCyberAngle(e){this.cyberConfig.angle=e}setMatrixAngle(e){this.matrixConfig.angle=e,this.currentCyberAngle=e,this.cyberRotationGroup&&(this.cyberRotationGroup.rotation.z=_e.degToRad(-e))}setVibrationEnabled(e){this.vibrationEnabled=e}updateLogoTexture(){if(!this.originalLogoImg)return;const e=512;this._logoRenderCanvas||(this._logoRenderCanvas=document.createElement("canvas"),this._logoRenderCanvas.width=e,this._logoRenderCanvas.height=e);const t=this._logoRenderCanvas,i=t.getContext("2d",{willReadFrequently:!0});i.clearRect(0,0,e,e),i.drawImage(this.originalLogoImg,0,0,e,e);const a=i.getImageData(0,0,t.width,t.height),s=a.data,o=document.body.dataset.theme||"default",n=Me[o]||Me.default,l=n.secondary||n.accent||"#ffffff",d=this.customColors&&this.customColors.mandala?this.customColors.mandala:this.customColor,p=d?d.getHex():parseInt(n.accent.replace("#",""),16),c=parseInt(l.replace("#",""),16),m=p>>16&255,r=p>>8&255,u=p&255,x=c>>16&255,I=c>>8&255,D=c&255;this.themeType=document.body.dataset.themeType||"dark",this.themeType;for(let S=0;S<s.length;S+=4){const L=s[S],A=s[S+1],w=s[S+2],U=s[S+3];if(U<60){s[S+3]=0;continue}else s[S+3]=(U-60)*1.307;L>200&&A>200&&w>200?(s[S]=m,s[S+1]=r,s[S+2]=u):(s[S]=x,s[S+1]=I,s[S+2]=D)}i.putImageData(a,0,0);const P=new le(t);if(P.minFilter=it,P.magFilter=se,P.generateMipmaps=!0,P.wrapS=Pe,P.wrapT=Pe,this.renderer&&(P.anisotropy=this.renderer.capabilities.getMaxAnisotropy()),this.logoMesh){const S=this.logoMesh.material.map;this.logoMesh.material.map=P,this.logoMesh.material.needsUpdate=!0,S&&S.dispose()}else{const S=new N,L=5.625,A=4.78,w=new Float32Array([-L/2,-A/2,0,L*1.5,-A/2,0,-L/2,A*1.5,0]),U=new Float32Array([0,0,2,0,0,2]);S.setAttribute("position",new W(w,3)),S.setAttribute("uv",new W(U,2));const ee=new O({map:P,transparent:!0,opacity:.8,color:16777215,depthTest:!1,depthWrite:!1});if(this.logoMesh=new G(S,ee),this.logoMesh.position.set(0,0,-10),this.logoMesh.renderOrder=999,this.scene.add(this.logoMesh),this.camera&&!this.dimmerPlane){const R=new N,q=2e3,ie=2e3,ae=new Float32Array([-q/2,-ie/2,0,q*1.5,-ie/2,0,-q/2,ie*1.5,0]);R.setAttribute("position",new W(ae,3)),this.dimmerPlane=new G(R,new O({color:0,transparent:!0,opacity:0,depthTest:!1})),this.dimmerPlane.renderOrder=998,this.dimmerPlane.position.z=-5,this.camera.add(this.dimmerPlane),this.scene.add(this.camera)}}}initOverlayLogo(){if(this.logoMesh)return;const e=new Image;e.crossOrigin="anonymous",e.src="./mindwave-logo-icon.png",e.onload=()=>{this.originalLogoImg=e,this.updateLogoTexture(),this.targetLogoOpacity!==void 0?this.setLogoOpacity(this.targetLogoOpacity):this.setLogoOpacity(.8)},e.onerror=t=>{}}setLogoOpacity(e){this.targetLogoOpacity=e,this.logoMesh&&this.logoMesh.material?this.logoMesh.material.opacity=e*this.brightnessMultiplier:!this.logoMesh&&e>0&&this.initOverlayLogo()}applyCymaticClassAndVariation(e,t){this.cymaticsCore&&(this.cymaticsCore.setPattern(e,t),this.activeModes.has("cymatics")||this.toggleMode("cymatics"))}setCymaticColor(e,t,i){if(this.cymaticsCore){if(i!==void 0)this.cymaticsCore.setColor(e,t,i);else if(e!==void 0){const a=e,s=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(s,1,a)}}}setCymaticColor2(e){if(!this.cymaticsCore)return;const t=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(t,2,new T(e))}setCymaticColor3(e){if(!this.cymaticsCore)return;const t=this.cymaticsCore.activeClassId||22;this.cymaticsCore.setColor(t,3,new T(e))}setCymaticParam(e,t,i){this.cymaticsCore&&this.cymaticsCore.setParam(e,t,i)}dispose(){this.active=!1,g.animationId&&(cancelAnimationFrame(g.animationId),g.animationId=null),window.removeEventListener("resize",this.resize),window.removeEventListener("resize",this.resizeOverlayCanvas),window.removeEventListener("mindwave:layout-change",this.handleLayoutChange),this._boundSafeMode&&window.removeEventListener("mindwave:safe-mode-start",this._boundSafeMode),this._boundVisibilityChange&&document.removeEventListener("visibilitychange",this._boundVisibilityChange),this._boundThemeChange&&window.removeEventListener("themeChanged",this._boundThemeChange),this.canvas&&(this._boundContextLost&&this.canvas.removeEventListener("webglcontextlost",this._boundContextLost),this._boundContextRestored&&this.canvas.removeEventListener("webglcontextrestored",this._boundContextRestored)),this._boundCymaticPointer&&(window.removeEventListener("mousemove",this._boundCymaticPointer),window.removeEventListener("touchmove",this._boundCymaticPointer),this._boundCymaticPointer=null);const e=i=>{if(i)for(;i.children.length>0;){const a=i.children[0];if(i.remove(a),a.geometry&&a.geometry.dispose(),a.material){if(a.material.map&&a.material.map.dispose(),a.material.uniforms)for(const s in a.material.uniforms){const o=a.material.uniforms[s];o&&o.value&&o.value.dispose&&o.value.dispose()}a.material.dispose()}a.children&&a.children.length&&a.traverse(s=>{s.geometry&&s.geometry.dispose(),s.material&&(s.material.map&&s.material.map.dispose(),s.material.dispose())})}},t=[this.sphereGroup,this.particleGroup,this.lightspeedGroup,this.lavaGroup,this.fireplaceGroup,this.rainforestGroup,this.zenGardenGroup,this.oceanGroup,this.wavesGroup,this.cyberGroup,this.boxGroup,this.dragonGroup,this.galaxyGroup,this.mandalaGroup,this.cymaticsGroup,this.snowflakeGroup];this._fpsRingBuffer=null,this._tempColor=null,this._logoRenderCanvas=null,t.forEach(e),this.cyberMaterial&&(this.cyberMaterial.dispose(),this.cyberMaterial=null),this.fireMaterial&&(this.fireMaterial.dispose(),this.fireMaterial=null),this.particleMaterial&&(this.particleMaterial.dispose(),this.particleMaterial=null),this.lightspeedMaterial&&(this.lightspeedMaterial.dispose(),this.lightspeedMaterial=null),this.rainMaterial&&(this.rainMaterial.dispose(),this.rainMaterial=null),this.petalMaterial&&(this.petalMaterial.dispose(),this.petalMaterial=null),this.logoMesh&&(this.logoMesh.material&&(this.logoMesh.material.map&&this.logoMesh.material.map.dispose(),this.logoMesh.material.dispose()),this.logoMesh.geometry&&this.logoMesh.geometry.dispose(),this.scene&&this.scene.remove(this.logoMesh),this.logoMesh=null);for(const i in this.textures)this.textures[i]&&this.textures[i].dispose&&this.textures[i].dispose();if(this.textures={},this._freqDataArray=null,this.renderer){try{this.renderer.forceContextLoss()}catch{}this.renderer.dispose(),this.renderer=null}this.scene=null,this.camera=null}setWarpSpeed(e){this.lightspeedMaterial&&(this.lightspeedMaterial.uniforms.uSpeed.value=e)}setWarpFov(e){this.camera&&(this.camera.fov=e,this.camera.updateProjectionMatrix())}setWarpChromatic(e){this.lightspeedMaterial}}Ce(Ge,"CYMATIC_PATTERNS",[{classId:22,variationId:0,name:"Fundamental Zenith",style:"fractal"},{classId:22,variationId:1,name:"Quantum Flower",style:"sacred"},{classId:22,variationId:2,name:"Sacred Sun Resonance",style:"complex"},{classId:22,variationId:3,name:"Ethereal Nexus",style:"geometry"},{classId:22,variationId:4,name:"Golden Ratio Spiral",style:"fractal"},{classId:22,variationId:5,name:"Obsidian Bloom",style:"sacred"},{classId:22,variationId:6,name:"Prismatic Core",style:"complex"},{classId:22,variationId:7,name:"Void Resonance",style:"geometry"},{classId:22,variationId:8,name:"Nebula Plasma",style:"fractal"},{classId:22,variationId:9,name:"Sacred Gold Obsidian",style:"sacred"},{classId:22,variationId:10,name:"Biolum Abyssal",style:"complex"},{classId:22,variationId:11,name:"Emerald Cyber Matrix",style:"geometry"},{classId:22,variationId:12,name:"Liquid Mercury Crimson",style:"fractal"},{classId:22,variationId:13,name:"Quantum Crystal Lattice",style:"sacred"},{classId:22,variationId:14,name:"Solar Flare Harmonics",style:"complex"},{classId:22,variationId:15,name:"Amethyst Hyperdimensional",style:"geometry"},{classId:22,variationId:16,name:"Neon Labyrinth",style:"fractal"},{classId:22,variationId:17,name:"Celestial Mandala",style:"sacred"},{classId:22,variationId:18,name:"Astral Lotus",style:"complex"},{classId:22,variationId:19,name:"Lunar Tides",style:"geometry"},{classId:22,variationId:20,name:"Cybernetic Lotus",style:"fractal"},{classId:22,variationId:21,name:"Bioluminescent Shroom",style:"sacred"},{classId:22,variationId:22,name:"Vortex of Time",style:"complex"},{classId:22,variationId:23,name:"Diamond Lattice",style:"geometry"},{classId:22,variationId:24,name:"Seraphim Wings",style:"fractal"},{classId:22,variationId:25,name:"Fractal Heart",style:"sacred"},{classId:22,variationId:26,name:"Particle Swarm",style:"complex"},{classId:22,variationId:27,name:"Fluid SDF",style:"geometry"},{classId:22,variationId:28,name:"Quantum Topology",style:"fractal"},{classId:22,variationId:29,name:"Ai Cymatic 15",style:"sacred"}]);function pt(){return v?Promise.resolve(v):new Promise(f=>{nt(),setTimeout(()=>f(v),10)})}function nt(){if(!v&&Y.canvas&&Y.canvas.activeVisualizer&&Y.canvas.activeVisualizer.isVisualizer3D&&(v=Y.canvas.activeVisualizer),Y.canvas&&Y.canvas.activeVisualizer){if(v&&Y.canvas.activeVisualizer===v)return v;Y.canvas.activeVisualizer.dispose(),Y.canvas.activeVisualizer=null,v=null}g.animationId&&(cancelAnimationFrame(g.animationId),g.animationId=null);const f=Y.canvas||document.getElementById("visualizer");if(!v&&f){const e=f&&f.activeVisualizer&&f.activeVisualizer.isVisualizer3D?{activeModes:f.activeVisualizer.activeModes,mode:f.activeVisualizer.mode,mindWaveMode:f.activeVisualizer.mindWaveMode,cyberLogicMode:f.activeVisualizer.cyberLogicMode,cyberCustomText:f.activeVisualizer.cyberCustomText,currentCyberAngle:f.activeVisualizer.currentCyberAngle,cyberSpeedMultiplier:f.activeVisualizer.cyberSpeedMultiplier,rainbowEnabled:f.activeVisualizer._rainbowEnabled}:{};v=new Ge(f,e),f.activeVisualizer=v,setTimeout(()=>{v&&(v.updateVisibility(),lt())},0)}return v}function vt(){return v}let we=!1;function gt(){we=!0,v&&g.animationId&&(cancelAnimationFrame(g.animationId),g.animationId=null,v.renderer&&v.scene&&v.camera&&v.renderer.render(v.scene,v.camera))}function lt(){v&&!g.animationId&&(v.active=!0,v.render(g.masterAnalyser||g.analyserLeft,g.analyserRight),we=!1)}function xt(){return we}function yt(f){v&&v.toggleMode(f)}function bt(f){v&&(v.setGlobalSpeed(f),v.setCyberSpeed&&v.setCyberSpeed(f))}function wt(f,e=null){v&&(v.setVisualColor(f,e),v.setCyberColor&&(!e||e=="cyber")&&v.setCyberColor(f))}function Ct(f){v&&v.setGlobalBrightness&&v.setGlobalBrightness(f)}function Mt(f){v&&v.setLogoOpacity(f)}function St(f){v&&v.setMouseInfluence(f)}window.toggleGalaxySun=function(){return v?v.toggleGalaxySunStyle():null};window.setCymaticPattern=function(f,e){f===0&&(f=22,e=8),v&&v.cymaticsCore?(v.cymaticsCore.setPattern(f,e),v.activeModes.has("cymatics")||(window.switchRightTab&&window.switchRightTab("cymatics",document.querySelector('.tab-pill[title="Cymatics"]')),v.activeModes.add("cymatics"),v.cymaticsGroup.visible=!0)):(window.setVisualMode&&window.setVisualMode("cymatics"),setTimeout(()=>{v&&v.cymaticsCore&&v.cymaticsCore.setPattern(f,e)},500))};window.setCymaticColor=function(f,e,t){v&&v.cymaticsCore&&v.cymaticsCore.setColor(f,e,t)};window.setCymaticParam=function(f,e,t){v&&v.cymaticsCore&&v.cymaticsCore.setParam(f,e,t)};window.setConstellationLayer2Type=function(f){v&&v.cymaticsCore&&v.cymaticsCore.setConstellationLayer2Type(f)};let xe=null,j=null,X=null,V=null,be=!0;window.toggleQuantumHum=function(f){if(be=f,V&&j){const e=j.currentTime;if(V.gain.cancelScheduledValues(e),V.gain.setValueAtTime(V.gain.value,e),!f)V.gain.linearRampToValueAtTime(0,e+.5);else{const i=(document.getElementById("observerToggle")?document.getElementById("observerToggle").checked:!1)?.3:.15;V.gain.linearRampToValueAtTime(i,e+.5)}}};window.toggleObserverEffect=function(f){if(!v||!v.cymaticsCore)return;v.cymaticsCore.activeClassId!==25&&window.setCymaticPattern(25,0);const e=f?1:0,t=v.cymaticsCore.materials[25];if(!t)return;try{if(!j){const s=window.AudioContext||window.webkitAudioContext;j=new s}j.state==="suspended"&&j.resume(),X||(X=j.createOscillator(),V=j.createGain(),X.type="triangle",X.frequency.value=108,V.gain.value=0,X.connect(V),V.connect(j.destination),X.start());const a=j.currentTime;V.gain.cancelScheduledValues(a),X.frequency.cancelScheduledValues(a),V.gain.setValueAtTime(V.gain.value,a),X.frequency.setValueAtTime(X.frequency.value,a),f?(be&&V.gain.linearRampToValueAtTime(.3,a+1),X.frequency.exponentialRampToValueAtTime(216,a+1)):(be&&V.gain.linearRampToValueAtTime(.15,a+1),X.frequency.exponentialRampToValueAtTime(108,a+1))}catch{}xe&&cancelAnimationFrame(xe);const i=()=>{let a=t.uniforms.uObserver.value;const s=e-a;if(Math.abs(s)<.01){t.uniforms.uObserver.value=e;return}t.uniforms.uObserver.value=a+s*.05,xe=requestAnimationFrame(i)};i()};export{Ge as Visualizer3D,vt as getVisualizer,nt as initVisualizer,xt as isVisualsPaused,gt as pauseVisuals,pt as preloadVisualizer,lt as resumeVisuals,St as setMouseInfluence,Ct as setVisualBrightness,wt as setVisualColor,Mt as setVisualLogoOpacity,bt as setVisualSpeed,yt as toggleVisual};
//# sourceMappingURL=visualizer_v4-DuIoSiFA.js.map
