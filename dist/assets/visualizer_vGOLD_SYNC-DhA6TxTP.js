...
`,je=f=>f===1?`
        ...
        uniform float uAudioLow;
        uniform float uAudioMid;
        uniform float uAudioHigh;`),o=o.replace("float intMod = max(0.1, uIntensity);","float intMod = max(0.1, uIntensity * (1.0 + uAudioLow * 3.0 + uAudioMid * 1.5));")),!o.includes("uniform float uMouseSync;")){let h="";o.includes("uniform vec2 uMouse;")||(h+=`uniform vec2 uMouse;
...
//# sourceMappingURL=visualizer_vGOLD_SYNC-DhA6TxTP.js.map
