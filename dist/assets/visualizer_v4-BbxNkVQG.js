...
`,ot=f=>f===1?`
        ...
        `,s=new k({vertexShader:i,fragmentShader:a,uniforms:t,transparent:!0,side:Z,wireframe:!1});this.tsunamiMaterial=s;const o=new G(e,s);o.rotation.x=-Math.PI/2,o.position.y=-20,o.position.z=-20,o.position.x=25,o.frustumCulled=!1,this.tsunamiGroup.add(o);const n="data:image/svg+xml;charset=utf-8,"+encodeURIComponent(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" width="512" height="512">
            <g>
