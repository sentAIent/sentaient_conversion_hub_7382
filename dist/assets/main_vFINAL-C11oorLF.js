const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pwa-install-DKLp-N6C.js","assets/controls_v3-EaCZ2XfK.js","assets/cursor-CdWAU_g8.js","assets/email-capture-Bp0saUkY.js","assets/journey-B8_EtJsP.js"])))=>i.map(i=>d[i]);
import{e as E,u as h,g as Q,t as ee,_ as u,i as te,d as P,a as oe,b as M,c as ne,f as ie,h as ae,j as se,k as re,l as le,m as ce,n as de,o as ue,q as pe,r as me,v as ge,w as fe,x as we,y as be,z as he,A as ye,B as xe,C as ve,D as Se,E as _e,F as Ie,G as ke,s as L,H as Ee,I as Pe,J as Me,K as Le,L as Te,M as Ce}from"./controls_v3-EaCZ2XfK.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";let x=0,O=0,q=0,j=0;const Ae=50,T=30;function Fe(){const e=document.getElementById("appOverlay");e&&(e.addEventListener("touchstart",Be,{passive:!0}),e.addEventListener("touchend",ze,{passive:!0}))}function Be(e){const t=e.touches[0];x=t.clientX,O=t.clientY}function ze(e){const t=e.changedTouches[0];q=t.clientX,j=t.clientY,Ue()}function Ue(){const e=q-x,t=j-O,o=window.innerWidth;if(Math.abs(e)<Math.abs(t)||Math.abs(e)<Ae)return;const i=E.leftPanel||document.getElementById("leftPanel"),n=E.rightPanel||document.getElementById("rightPanel");e>0?x<T?i&&(i.classList.remove("-translate-x-full"),h()):n&&!n.classList.contains("translate-x-full")&&(n.classList.add("translate-x-full"),document.body.classList.remove("right-panel-open"),h()):e<0&&(x>o-T?n&&(n.classList.remove("translate-x-full"),document.body.classList.add("right-panel-open"),h()):i&&!i.classList.contains("-translate-x-full")&&(i.classList.add("-translate-x-full"),h()))}class $e{constructor(){this.queue=[],this.isProcessing=!1,this.currentFlow=null}enqueue(t,o,i=10){this.queue.some(n=>n.id===t)||(this.queue.push({id:t,fn:o,priority:i}),this.queue.sort((n,a)=>a.priority-n.priority),this.process())}async process(){if(this.isProcessing||this.queue.length===0)return;this.isProcessing=!0;const t=this.queue.shift();this.currentFlow=t.id;try{await t.fn()}catch{}this.isProcessing=!1,this.currentFlow=null,setTimeout(()=>this.process(),500)}}const _=new $e;window.modalFlowManager=_;const V="mindwave_exit_intent_shown",I="mindwave_session_id";let C=!1;function Re(){if("ontouchstart"in window)return;const e=sessionStorage.getItem(I)||Date.now().toString();sessionStorage.setItem(I,e),!sessionStorage.getItem(`${V}_${e}`)&&setTimeout(()=>{document.addEventListener("mouseout",H)},1e4)}function H(e){if(e.clientY>50||C||localStorage.getItem("mindwave_premium")==="true")return;Ne(),C=!0;const t=sessionStorage.getItem(I);sessionStorage.setItem(`${V}_${t}`,"true"),document.removeEventListener("mouseout",H)}function Ne(){if(document.getElementById("exitIntentModal"))return;const e=Q("exit_intent_offer"),t={"50_percent":{emoji:"🎁",title:"Wait! Don't Leave Empty-Handed",subtitle:'Get <span style="color: #10b981; font-weight: 700;">50% off</span> your first month of MindWave Premium',badge:'<div style="font-size: 32px; font-weight: 800; color: white;">$4.99</div><div style="font-size: 12px; color: rgba(255,255,255,0.8);"><s>$9.99</s> First Month</div>',cta:"Claim 50% Off Now",dismiss:"No thanks, I'll pay full price later"},"7_day_trial":{emoji:"🚀",title:"Try MindWave PRO Free",subtitle:'Get <span style="color: #8b5cf6; font-weight: 700;">7 days free</span> to unlock all brainwave frequencies',badge:'<div style="font-size: 32px; font-weight: 800; color: white;">7 Days</div><div style="font-size: 12px; color: rgba(255,255,255,0.8);">Completely Free</div>',cta:"Start Free Trial",dismiss:"Maybe later"},countdown:{emoji:"⏰",title:"Special Offer Expiring Soon",subtitle:"This deal disappears when the timer hits zero",badge:'<div id="exitCountdown" style="font-size: 32px; font-weight: 800; color: white; font-family: monospace;">14:59</div><div style="font-size: 12px; color: rgba(255,255,255,0.8);">Time Remaining</div>',cta:"Claim Before It Expires",dismiss:"I don't mind paying more"}},o=t[e]||t["50_percent"],i=e==="7_day_trial"?"#8b5cf6":"#10b981",n=e==="7_day_trial"?"linear-gradient(145deg, rgba(139, 92, 246, 0.1), rgba(15, 23, 42, 0.98))":"linear-gradient(145deg, rgba(16, 185, 129, 0.1), rgba(15, 23, 42, 0.98))",a=e==="7_day_trial"?"#8b5cf6":"#10b981",s=document.createElement("div");if(s.id="exitIntentModal",s.className="fixed inset-0 z-[9999] flex items-center justify-center p-4",s.style.cssText=`
    ...
    `,document.body.appendChild(n)),n.dataset.currentReason=e;const a=n.querySelector("#upgradeIcon"),s=n.querySelector("#upgradeTitle"),r=n.querySelector("#upgradeDescription"),l=n.querySelector("#upgradeBtn");a.textContent=((p=i.title.match(/[\u{1F300}-\u{1F9FF}]/u))==null?void 0:p[0])||"✨",s.textContent=i.title.replace(/[\u{1F300}-\u{1F9FF}]/gu,"").trim(),r.textContent=i.description,l.textContent=i.cta;const d=n.querySelector("#upgradeBtn"),m=n.querySelector("#closeUpgradeBtn");d.onclick=c=>{c.stopPropagation();try{n.classList.remove("flex"),n.classList.add("hidden"),n.dataset.currentReason==="not_logged_in"?window.openAuthModal?window.openAuthModal():alert("Please sign in to continue"):window.showPricingModal?window.showPricingModal():alert("Premium feature - please upgrade")}catch{}},m.onclick=c=>{c.stopPropagation();try{n.classList.remove("flex"),n.classList.add("hidden")}catch{}},n.onclick=c=>{if(c.target===n){c.stopPropagation();try{n.classList.remove("flex"),n.classList.add("hidden")}catch{}}},n.classList.remove("hidden"),n.classList.add("flex")}function We(){window.canAccessFeature=Ve,window.showUpgradePrompt=He}const b={AFTER_FIRST_SESSION:"after_first_session",AFTER_THIRD_SESSION:"after_third_session",AFTER_WEEK:"after_week",MANUAL:"manual"};function v(e=b.MANUAL){const t=localStorage.getItem("mindwave_last_survey"),o=t?(Date.now()-parseInt(t))/(1e3*60*60*24):999;if(e!==b.MANUAL&&o<7)return;const i=Ye(e);document.body.appendChild(i),window.trackFeatureUse&&window.trackFeatureUse("survey_shown",e)}function Ye(e){const t=document.createElement("div");return t.id="feedbackSurveyModal",t.className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md opacity-0 transition-opacity duration-300 survey-contrast-fix",setTimeout(()=>t.classList.remove("opacity-0"),10),t.innerHTML=`
    ...
    `,r.textContent=`🎵 Shared preset loaded: ${e.presetName}`,document.body.appendChild(r),setTimeout(()=>r.remove(),3e3),window.history.replaceState({},"",window.location.pathname)}async function K(){const e=X();try{return await navigator.clipboard.writeText(e),{success:!0,url:e}}catch{const o=document.createElement("textarea");return o.value=e,o.style.position="fixed",o.style.opacity="0",document.body.appendChild(o),o.select(),document.execCommand("copy"),document.body.removeChild(o),{success:!0,url:e}}}function Ke(e){return null}function Qe(){try{const e=G();e&&setTimeout(()=>Z(e),500)}catch{}}const et=Object.freeze(Object.defineProperty({__proto__:null,applySharedPreset:Z,copyShareLink:K,generateQRCode:Ke,generateShareableURL:X,initShareFeature:Qe,parseSharedPreset:G},Symbol.toStringTag,{value:"Module"}));window.NUCLEAR_MAIN_LOADED=!0;const w={onboarding:()=>u(()=>import("./onboarding-MVPlV251.js"),[]),pwa:()=>u(()=>import("./pwa-install-DKLp-N6C.js"),__vite__mapDeps([0,1])),presence:()=>u(()=>import("./controls_v3-EaCZ2XfK.js").then(e=>e.$),[]),cursor:()=>u(()=>import("./cursor-CdWAU_g8.js"),__vite__mapDeps([2,1])),share:()=>u(()=>Promise.resolve().then(()=>et),void 0),email:()=>u(()=>import("./email-capture-Bp0saUkY.js"),__vite__mapDeps([3,1])),haptics:()=>u(()=>import("./controls_v3-EaCZ2XfK.js").then(e=>e.U),[])};window.showFeedbackSurvey=v;window.trackSignup=se;window.trackLogin=re;window.trackBeginCheckout=le;window.trackPurchase=ce;window.trackFeatureUse=de;window.startOnboarding=async(e=!1)=>{const{initializeOnboarding:t}=await w.onboarding();t(e)};window.startTutorial=()=>window.startOnboarding(!0);window.trackSessionStart=ue;window.trackSessionEnd=pe;window.trackPaywallShown=me;window.trackUpgradeClick=ge;window.setUserProperties=fe;window.setMasterVolume=we;window.setBeatsVolume=be;window.setAtmosVolume=he;window.onerror=(e,t,o,i,n)=>{Y(n||new Error(e),"Uncaught"),J(n||new Error(e),`${t}:${o}:${i}`)};window.onunhandledrejection=e=>{Y(e.reason||new Error("Unhandled rejection"),"Promise"),J(e.reason||new Error("Unhandled rejection"),"UnhandledPromise")};const N=()=>{if(window.APP_INITIALIZED)return;window.APP_INITIALIZED=!0,ye(),Re(),localStorage.getItem("mindwave_onboarding_complete_v5")||_.enqueue("intent_survey",()=>new Promise(o=>{const i=()=>{localStorage.getItem("mindwave_disclaimer_accepted")==="true"?setTimeout(()=>{De(n=>{n&&n!=="explore"&&Ce(n),startOnboarding(!0,n),o()})},1e3):(Me(),setTimeout(i,1e3))};i()}),20),ot();try{xe(),ve(),nt(),tt(),We(),Se(),_e(),Ie(),localStorage.getItem("mindwave_premium")!=="true"&&qe(),ke().then(o=>{})}catch{}typeof L=="function"?L():typeof window.setupUI=="function"&&window.setupUI(),w.haptics().then(o=>o.initHaptics()),Fe(),Ee(),w.cursor().then(o=>o.initCursor()),_.enqueue("email_capture",()=>new Promise(o=>{setTimeout(()=>{w.email().then(i=>i.initEmailCapture()),o()},6e4)}),10),w.pwa().then(o=>o.initPWAInstall());const t=document.getElementById("loadingScreen");t&&(t.style.opacity="0",t.style.pointerEvents="none",setTimeout(()=>{t.parentNode&&t.parentNode.removeChild(t)},500)),requestIdleCallback?requestIdleCallback(D):setTimeout(D,100),Pe(),setTimeout(()=>Ze(),15e3),window.shareCurrentPreset=async()=>{if((await K()).success){const i=document.createElement("div");i.style.cssText="position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:var(--accent);color:#0f172a;padding:12px 24px;border-radius:12px;font-size:12px;font-weight:bold;z-index:9999;box-shadow:0 0 20px rgba(96,169,255,0.4);",i.textContent="🔗 Share link copied!",document.body.appendChild(i),setTimeout(()=>{i.style.opacity="0",i.style.transition="opacity 0.3s ease",setTimeout(()=>i.remove(),300)},3e3)}}};function tt(){const e=()=>{const t=!navigator.onLine;document.body.classList.toggle("is-offline",t);const o=document.getElementById("offlineIndicator");o&&(o.classList.toggle("hidden",!t),o.classList.toggle("flex",t))};window.addEventListener("online",e),window.addEventListener("offline",e),e()}const ot=()=>{let e=parseInt(localStorage.getItem("mindwave_session_count")||"0");e++,localStorage.setItem("mindwave_session_count",e),localStorage.setItem("mindwave_last_session",Date.now()),setTimeout(()=>{if(e>=3&&localStorage.getItem("mindwave_premium")!=="true"){const t=parseInt(localStorage.getItem("mindwave_last_nag")||"0"),o=24*60*60*1e3;Date.now()-t>o&&localStorage.setItem("mindwave_last_nag",Date.now())}},3e4)};document.readyState==="loading"?document.addEventListener("DOMContentLoaded",N):N();async function D(){try{const[e,t,o,i]=await Promise.all([u(()=>import("./controls_v3-EaCZ2XfK.js").then(c=>c.X),[]),u(()=>import("./controls_v3-EaCZ2XfK.js").then(c=>c.Y),[]),u(()=>import("./journey-B8_EtJsP.js"),__vite__mapDeps([4,1])),u(()=>import("./controls_v3-EaCZ2XfK.js").then(c=>c.Z),[])]);e.initStoryPlayer();const n=document.getElementById("storyContainer");n&&e.renderStoryCards(n);const a=document.getElementById("storyVolumeSlider"),s=document.getElementById("storyVolumeValue");a&&a.addEventListener("input",c=>{const g=parseFloat(c.target.value);e.setStoryVolume(g),s&&(s.textContent=Math.round(g*100)+"%")});const r=document.getElementById("stopStoryBtn");r&&r.addEventListener("click",e.stopStory),i.initClassical(),await t.initAudioLibrary(),t.setupUploadHandler(),o.initJourney();const l=document.getElementById("journeyBtn"),d=document.getElementById("journeyModal"),m=document.getElementById("closeJourneyBtn"),p=document.getElementById("journeyContainer");l&&d&&l.addEventListener("click",()=>{d.classList.remove("hidden"),p&&o.renderJourneyUI(p)}),m&&d&&(m.addEventListener("click",()=>{d.classList.add("hidden")}),d.addEventListener("click",c=>{c.target===d&&d.classList.add("hidden")}))}catch{}}function nt(){const e=document.getElementById("presenceText");e&&(Le(),Te(t=>{const o=t.total||0,i=o===1?"1 Mind Active":`${o} Minds Active`;e.textContent=i,e.classList.add("text-white/80"),e.classList.remove("text-white/50");const n=document.getElementById("presenceCounter");if(n){const a=Object.entries(t.byPreset).map(([s,r])=>`${s}: ${r}`).join(" | ");a&&(n.title=`Pulse: ${a}`)}}))}
//# sourceMappingURL=main_vFINAL-C11oorLF.js.map
