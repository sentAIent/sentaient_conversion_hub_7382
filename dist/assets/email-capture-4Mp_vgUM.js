import{_ as s}from"./share-b00RgVdr.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";import"https://www.gstatic.com/firebasejs/10.13.0/firebase-app.js";const i="mindwave_email_captured",f=12e4;let l=!1;function k(){localStorage.getItem(i)||setTimeout(async()=>{try{const{getAuth:e}=await s(async()=>{const{getAuth:t}=await import("https://www.gstatic.com/firebasejs/10.13.0/firebase-auth.js");return{getAuth:t}},[]);if(e().currentUser||l)return;y()}catch{}},f)}function y(){if(document.getElementById("emailCaptureModal"))return;l=!0;const e=document.createElement("div");e.id="emailCaptureModal",e.className="fixed inset-0 z-[9999] flex items-center justify-center p-4",e.style.cssText=`
...
//# sourceMappingURL=email-capture-4Mp_vgUM.js.map
